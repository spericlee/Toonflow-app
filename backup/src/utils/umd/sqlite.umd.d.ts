declare module "@/utils/umd/sqlite.umd.js" {
  ...
  export type CreateConstraintDefinition = CreateConstraintPrimary | CreateConstraintUnique | CreateConstraintForeign | CreateConstraintCheck;

  export type CreateDefinition = CreateColumnDefinition | CreateIndexDefinition | CreateFulltextSpatialIndexDefinition | CreateConstraintDefinition;
