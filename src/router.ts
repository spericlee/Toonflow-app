// @routes-hash e4d04fa2491592e1f791faa77dccc6ca
...
import route107 from "./routes/project/queryDirectorManual";
import route108 from "./routes/project/visualManual";
import route109 from "./routes/script/addScript";
import route110 from "./routes/script/batchAddScript";
import route111 from "./routes/script/delScript";
import route112 from "./routes/script/exportScript";
import route113 from "./routes/script/extractAssets";
import route114 from "./routes/script/getAiRegex";
import route115 from "./routes/script/getScrptApi";
import route116 from "./routes/script/pollScriptAssets";
import route117 from "./routes/script/updateScript";
import route118 from "./routes/scriptAgent/getPlanData";
import route119 from "./routes/scriptAgent/setPlanData";
import route120 from "./routes/scriptAgent/updateData";
...
export default async (app: Express) => {
  ...
  app.use("/api/project/queryDirectorManual", route107);
  app.use("/api/project/visualManual", route108);
  app.use("/api/script/addScript", route109);
  app.use("/api/script/batchAddScript", route110);
  app.use("/api/script/delScript", route111);
  app.use("/api/script/exportScript", route112);
  app.use("/api/script/extractAssets", route113);
  app.use("/api/script/getAiRegex", route114);
  app.use("/api/script/getScrptApi", route115);
  app.use("/api/script/pollScriptAssets", route116);
  app.use("/api/script/updateScript", route117);
  app.use("/api/scriptAgent/getPlanData", route118);
  app.use("/api/scriptAgent/setPlanData", route119);
  app.use("/api/scriptAgent/updateData", route120);
