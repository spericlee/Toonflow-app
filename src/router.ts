// @routes-hash 5469e7a3820c1e905a7f351f88fcfe18
...
import route72 from "./routes/production/storyboard/insertStoryboard";
...
import route80 from "./routes/production/workbench/batchRetryFailedVideo";
...
import route91 from "./routes/production/workbench/retryFailedVideo";
...
import route106 from "./routes/project/getVisualManual";
import route107 from "./routes/project/imageToImageModelConfig";
import route108 from "./routes/project/queryDirectorManual";
import route109 from "./routes/project/updateImageToImageModel";
import route110 from "./routes/project/visualManual";
import route111 from "./routes/script/addScript";
import route112 from "./routes/script/batchAddScript";
import route113 from "./routes/script/delScript";
import route114 from "./routes/script/exportScript";
import route115 from "./routes/script/extractAssets";
import route116 from "./routes/script/getAiRegex";
import route117 from "./routes/script/getScrptApi";
import route118 from "./routes/script/pollScriptAssets";
import route119 from "./routes/script/updateScript";
import route120 from "./routes/scriptAgent/getPlanData";
import route121 from "./routes/scriptAgent/setPlanData";
import route122 from "./routes/scriptAgent/updateData";
import route123 from "./routes/setting/about/checkUpdate";
import route124 from "./routes/setting/about/downloadApp";
import route125 from "./routes/setting/agentDeploy/agentSetKey";
import route126 from "./routes/setting/agentDeploy/deployAgentModel";
import route127 from "./routes/setting/agentDeploy/getAgentDeploy";
import route128 from "./routes/setting/agentDeploy/getAgentUseMode";
import route129 from "./routes/setting/agentDeploy/updateAgentModel";
import route130 from "./routes/setting/agentDeploy/updateUseMode";
import route131 from "./routes/setting/dbConfig/clearData";
import route132 from "./routes/setting/dbConfig/clearTable";
import route133 from "./routes/setting/dbConfig/dbInfo";
import route134 from "./routes/setting/dbConfig/exportData";
import route135 from "./routes/setting/dbConfig/importData";
import route136 from "./routes/setting/dev/getSwitchAiDevTool";
import route137 from "./routes/setting/dev/updateSwitchAiDevTool";
import route138 from "./routes/setting/fileManagement/openFolder";
import route139 from "./routes/setting/getTextModel";
import route140 from "./routes/setting/loginConfig/getUser";
import route141 from "./routes/setting/loginConfig/updateUserPwd";
import route142 from "./routes/setting/memoryConfig/delAllMemory";
import route143 from "./routes/setting/memoryConfig/getMemory";
import route144 from "./routes/setting/memoryConfig/sureMemory";
import route145 from "./routes/setting/modelMap/bindingPrompt";
import route146 from "./routes/setting/modelMap/deletePrompt";
import route147 from "./routes/setting/modelMap/getImageAndVideoModel";
import route148 from "./routes/setting/modelMap/getPromptList";
import route149 from "./routes/setting/modelMap/savePrompt";
import route150 from "./routes/setting/modelMap/updatePrompt";
import route151 from "./routes/setting/promptManage/getPrompt";
import route152 from "./routes/setting/promptManage/updatePrompt";
import route153 from "./routes/setting/skillManagement/getSkillContent";
import route154 from "./routes/setting/skillManagement/getSkillList";
import route155 from "./routes/setting/skillManagement/saveSkillContent";
import route156 from "./routes/setting/vendorConfig/addVendor";
import route157 from "./routes/setting/vendorConfig/addVendorModel";
import route158 from "./routes/setting/vendorConfig/deleteVendor";
import route159 from "./routes/setting/vendorConfig/delVendorModel";
import route160 from "./routes/setting/vendorConfig/enableVendor";
import route161 from "./routes/setting/vendorConfig/getCodeByLink";
import route162 from "./routes/setting/vendorConfig/getVendorList";
import route163 from "./routes/setting/vendorConfig/modelTest";
import route164 from "./routes/setting/vendorConfig/modelTest/imageTest";
import route165 from "./routes/setting/vendorConfig/modelTest/textTest";
import route166 from "./routes/setting/vendorConfig/modelTest/videoTest";
import route167 from "./routes/setting/vendorConfig/updateCode";
import route168 from "./routes/setting/vendorConfig/updateVendorInputs";
import route169 from "./routes/setting/vendorConfig/upVendorModel";
import route170 from "./routes/task/getProject";
import route171 from "./routes/task/getTaskApi";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/storyboard/insertStoryboard", route72);
  ...
  app.use("/api/production/workbench/batchRetryFailedVideo", route80);
  ...
  app.use("/api/production/workbench/retryFailedVideo", route91);
  ...
  app.use("/api/project/getVisualManual", route106);
  app.use("/api/project/imageToImageModelConfig", route107);
  app.use("/api/project/queryDirectorManual", route108);
  app.use("/api/project/updateImageToImageModel", route109);
  app.use("/api/project/visualManual", route110);
  app.use("/api/script/addScript", route111);
  app.use("/api/script/batchAddScript", route112);
  app.use("/api/script/delScript", route113);
  app.use("/api/script/exportScript", route114);
  app.use("/api/script/extractAssets", route115);
  app.use("/api/script/getAiRegex", route116);
  app.use("/api/script/getScrptApi", route117);
  app.use("/api/script/pollScriptAssets", route118);
  app.use("/api/script/updateScript", route119);
  app.use("/api/scriptAgent/getPlanData", route120);
  app.use("/api/scriptAgent/setPlanData", route121);
  app.use("/api/scriptAgent/updateData", route122);
  app.use("/api/setting/about/checkUpdate", route123);
  app.use("/api/setting/about/downloadApp", route124);
  app.use("/api/setting/agentDeploy/agentSetKey", route125);
  app.use("/api/setting/agentDeploy/deployAgentModel", route126);
  app.use("/api/setting/agentDeploy/getAgentDeploy", route127);
  app.use("/api/setting/agentDeploy/getAgentUseMode", route128);
  app.use("/api/setting/agentDeploy/updateAgentModel", route129);
  app.use("/api/setting/agentDeploy/updateUseMode", route130);
  app.use("/api/setting/dbConfig/clearData", route131);
  app.use("/api/setting/dbConfig/clearTable", route132);
  app.use("/api/setting/dbConfig/dbInfo", route133);
  app.use("/api/setting/dbConfig/exportData", route134);
  app.use("/api/setting/dbConfig/importData", route135);
  app.use("/api/setting/dev/getSwitchAiDevTool", route136);
  app.use("/api/setting/dev/updateSwitchAiDevTool", route137);
  app.use("/api/setting/fileManagement/openFolder", route138);
  app.use("/api/setting/getTextModel", route139);
  app.use("/api/setting/loginConfig/getUser", route140);
  app.use("/api/setting/loginConfig/updateUserPwd", route141);
  app.use("/api/setting/memoryConfig/delAllMemory", route142);
  app.use("/api/setting/memoryConfig/getMemory", route143);
  app.use("/api/setting/memoryConfig/sureMemory", route144);
  app.use("/api/setting/modelMap/bindingPrompt", route145);
  app.use("/api/setting/modelMap/deletePrompt", route146);
  app.use("/api/setting/modelMap/getImageAndVideoModel", route147);
  app.use("/api/setting/modelMap/getPromptList", route148);
  app.use("/api/setting/modelMap/savePrompt", route149);
  app.use("/api/setting/modelMap/updatePrompt", route150);
  app.use("/api/setting/promptManage/getPrompt", route151);
  app.use("/api/setting/promptManage/updatePrompt", route152);
  app.use("/api/setting/skillManagement/getSkillContent", route153);
  app.use("/api/setting/skillManagement/getSkillList", route154);
  app.use("/api/setting/skillManagement/saveSkillContent", route155);
  app.use("/api/setting/vendorConfig/addVendor", route156);
  app.use("/api/setting/vendorConfig/addVendorModel", route157);
  app.use("/api/setting/vendorConfig/deleteVendor", route158);
  app.use("/api/setting/vendorConfig/delVendorModel", route159);
  app.use("/api/setting/vendorConfig/enableVendor", route160);
  app.use("/api/setting/vendorConfig/getCodeByLink", route161);
  app.use("/api/setting/vendorConfig/getVendorList", route162);
  app.use("/api/setting/vendorConfig/modelTest", route163);
  app.use("/api/setting/vendorConfig/modelTest/imageTest", route164);
  app.use("/api/setting/vendorConfig/modelTest/textTest", route165);
  app.use("/api/setting/vendorConfig/modelTest/videoTest", route166);
  app.use("/api/setting/vendorConfig/updateCode", route167);
  app.use("/api/setting/vendorConfig/updateVendorInputs", route168);
  app.use("/api/setting/vendorConfig/upVendorModel", route169);
  app.use("/api/task/getProject", route170);
  app.use("/api/task/getTaskApi", route171);
