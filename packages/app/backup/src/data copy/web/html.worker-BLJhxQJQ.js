...
var dh = (Ye, ze, He) => (ze in Ye ? hh(Ye, ze, { enumerable: !0, configurable: !0, writable: !0, value: He }) : (Ye[ze] = He));
var Qe = (Ye, ze, He) => dh(Ye, typeof ze != "symbol" ? ze + "" : ze, He);
(function () {
  "use strict";
  var Oe, ao, oo, lo, uo, he, Q;
  class Ye {
    constructor() {
      ((this.listeners = []),
...
` +
  ...
  const ze = new Ye();
  function He(e) {
    co(e) || ze.onUnexpectedError(e);
  }
  function Cn(e) {
    if (e instanceof Error) {
      const { name: t, message: n, cause: i } = e,
        r = e.stacktrace || e.stack;
      return { $isError: !0, name: t, message: n, stack: r, noTelemetry: at.isErrorNoTelemetry(e), cause: i ? Cn(i) : void 0, code: e.code };
    }
    return e;
  }
  const En = "Canceled";
  function co(e) {
    return e instanceof Ui ? !0 : e instanceof Error && e.name === En && e.message === En;
  }
  ...
  function ho(e, t = "Unreachable") {
    throw new Error(t);
  }
  function mo(e, t = "unexpected state") {
    if (!e) throw typeof t == "string" ? new ue(`Assertion Failed: ${t}`) : t;
  }
  function $t(e) {
    if (!e()) {
      debugger;
      (e(), He(new ue("Assertion Failed")));
    }
  }
  function Pi(e, t) {
    let n = 0;
  ...
  (function (e) {
    ...
    e.from = a;
    function* l(b) {
      for (let g = b.length - 1; g >= 0; g--) yield b[g];
    }
    e.reverse = l;
    function o(b) {
    ...
    function c(b, g) {
      let _ = 0;
      for (const N of b) if (g(N, _++)) return !0;
      return !1;
    }
    e.some = c;
    function d(b, g) {
      let _ = 0;
      for (const N of b) if (!g(N, _++)) return !1;
      return !0;
    }
    e.every = d;
    function m(b, g) {
      for (const _ of b) if (g(_)) return _;
    }
    e.find = m;
    function* f(b, g) {
      for (const _ of b) g(_) && (yield _);
    }
    e.filter = f;
    function* w(b, g) {
      let _ = 0;
      for (const N of b) yield g(N, _++);
    }
    e.map = w;
    function* p(b, g) {
      let _ = 0;
    ...
    e.flatMap = p;
    function* x(...b) {
      for (const g of b) po(g) ? yield* g : yield g;
    }
    e.concat = x;
    function T(b, g, _) {
      let N = _;
      for (const S of b) N = g(N, S);
      return N;
    }
    e.reduce = T;
    function y(b) {
    ...
    e.length = y;
    function* L(b, g, _ = b.length) {
      for (g < -b.length && (g = 0), g < 0 && (g += b.length), _ < 0 ? (_ += b.length) : _ > b.length && (_ = b.length); g < _; g++) yield b[g];
    }
    e.slice = L;
    function I(b, g = Number.POSITIVE_INFINITY) {
      const _ = [];
      if (g === 0) return [_, b];
      const N = b[Symbol.iterator]();
      for (let S = 0; S < g; S++) {
        const v = N.next();
        if (v.done) return [_, e.empty()];
        _.push(v.value);
      }
      return [
        _,
    ...
    async function H(b) {
      const g = [];
      for await (const _ of b) g.push(_);
      return g;
    }
    e.asyncToArray = H;
    async function P(b) {
      let g = [];
      for await (const _ of b) g = g.concat(_);
      return g;
    }
    e.asyncToArrayFlat = P;
  })(Gt || (Gt = {}));
  function mh(e, t) {}
  function Wi(e) {
    if (Gt.is(e)) {
  ...
  const Tn = class Tn {
    ...
    add(t) {
      if (!t || t === Ze.None) return t;
      if (t === this) throw new Error("Cannot register a disposable on itself!");
      return (
        this._isDisposed
          ? Tn.DISABLE_DISPOSED_WARNING ||
            console.warn(
  ...
  Tn.DISABLE_DISPOSED_WARNING = !1;
  let Lt = Tn;
  const zi = class zi {
    constructor() {
      ((this._store = new Lt()), this._store);
    }
    dispose() {
      this._store.dispose();
    }
  ...
  class wo {
    ...
    _insert(t, n) {
      const i = new te(t);
      if (this._first === te.Undefined) ((this._first = i), (this._last = i));
      else if (n) {
        const s = this._last;
    ...
    _remove(t) {
      if (t.prev !== te.Undefined && t.next !== te.Undefined) {
        ...
        t.prev === te.Undefined && t.next === te.Undefined
          ? ((this._first = te.Undefined), (this._last = te.Undefined))
          : t.next === te.Undefined
            ? ((this._last = this._last.prev), (this._last.next = te.Undefined))
            : t.prev === te.Undefined && ((this._first = this._first.next), (this._first.prev = te.Undefined));
      this._size -= 1;
    }
    *[Symbol.iterator]() {
      let t = this._first;
      for (; t !== te.Undefined; ) (yield t.element, (t = t.next));
    }
  }
  const _o = globalThis.performance.now.bind(globalThis.performance);
  class Jt {
    static create(t) {
      return new Jt(t);
    }
    constructor(t) {
      ((this._now = t === !1 ? Date.now : _o), (this._startTime = this._now()), (this._stopTime = -1));
    }
    stop() {
  ...
  (function (e) {
    e.None = () => Ze.None;
    function t(v, A) {
      return m(v, () => {}, 0, void 0, !0, void 0, A);
    }
    e.defer = t;
    function n(v) {
      return (A, D = null, k) => {
        ...
        return (
          (M = v(
            (W) => {
              if (!E) return (M ? M.dispose() : (E = !0), A.call(D, W));
            },
            null,
            k,
          )),
    ...
    e.once = n;
    function i(v, A) {
      return e.once(e.filter(v, A));
    }
    e.onceIf = i;
    function r(v, A, D) {
      return c((k, E = null, M) => v((W) => k.call(E, A(W)), null, M), D);
    }
    e.map = r;
    function s(v, A, D) {
      return c(
    ...
    e.forEach = s;
    function a(v, A, D) {
      return c((k, E = null, M) => v((W) => A(W) && k.call(E, W), null, M), D);
    }
    e.filter = a;
    function l(v) {
      return v;
    ...
    function o(...v) {
      return (A, D = null, k) => {
        const E = go(...v.map((M) => M((W) => A.call(D, W))));
        return d(E, k);
      };
    }
    e.any = o;
    ...
    function c(v, A) {
      ...
      const k = {
        ...
        E = new Re(k);
      return (A == null || A.add(E), E.event);
    }
    function d(v, A) {
      return (A instanceof Array ? A.push(v) : A && A.add(v), v);
    }
    function m(v, A, D = 100, k = !1, E = !1, M, W) {
      let F,
        U,
        O,
        Z = 0,
      ...
      const xe = {
          ...
          onWillAddFirstListener() {
            F = v((uh) => {
              (Z++,
                (U = A(U, uh)),
                k && !O && (Ee.fire(U), (U = void 0)),
                (Y = () => {
                  const ch = U;
                  ((U = void 0), (O = void 0), (!k || Z > 1) && Ee.fire(ch), (Z = 0));
                }),
                typeof D == "number" ? (O && clearTimeout(O), (O = setTimeout(Y, D))) : O === void 0 && ((O = null), queueMicrotask(Y)));
            });
          },
        ...
        Ee = new Re(xe);
      return (W == null || W.add(Ee), Ee.event);
    }
    e.debounce = m;
    function f(v, A = 0, D) {
      return e.debounce(v, (k, E) => (k ? (k.push(E), k) : [E]), A, void 0, !0, void 0, D);
    }
    e.accumulate = f;
    function w(v, A = (k, E) => k === E, D) {
      let k = !0,
        E;
      return a(
        v,
    ...
    e.latch = w;
    function p(v, A, D) {
      return [e.filter(v, A, D), e.filter(v, (k) => !A(k), D)];
    }
    e.split = p;
    function x(v, A = !1, D = [], k) {
      let E = D.slice(),
        M = v((U) => {
          E ? E.push(U) : F.fire(U);
        });
      k && k.add(M);
      const W = () => {
          (E == null || E.forEach((U) => F.fire(U)), (E = null));
        },
        F = new Re({
          onWillAddFirstListener() {
            M || ((M = v((U) => F.fire(U))), k && k.add(M));
          },
    ...
    class L {
      ...
      forEach(A) {
        return (this.steps.push((D) => (A(D), D)), this);
      }
      filter(A) {
        return (this.steps.push((D) => (A(D) ? D : y)), this);
      }
      reduce(A, D) {
        let k = D;
        return (this.steps.push((E) => ((k = A(k, E)), k)), this);
      }
      latch(A = (D, k) => D === k) {
        let D = !0,
          k;
        return (
          this.steps.push((E) => {
            const M = D || !A(E, k);
            return ((D = !1), (k = E), M ? E : y);
          }),
          this
        );
      }
      evaluate(A) {
        for (const D of this.steps) if (((A = D(A)), A === y)) break;
        return A;
      }
    }
    function I(v, A, D = (k) => k) {
      const k = (...F) => W.fire(D(...F)),
        E = () => v.on(A, k),
        M = () => v.removeListener(A, k),
        W = new Re({ onWillAddFirstListener: E, onDidRemoveLastListener: M });
      return W.event;
    }
    e.fromNodeEventEmitter = I;
    function H(v, A, D = (k) => k) {
      const k = (...F) => W.fire(D(...F)),
        E = () => v.addEventListener(A, k),
        M = () => v.removeEventListener(A, k),
        W = new Re({ onWillAddFirstListener: E, onDidRemoveLastListener: M });
      return W.event;
    }
    ...
    function P(v, A) {
      let D;
      const k = new Promise((E, M) => {
        const W = n(v)(E, null, A);
        D = () => W.dispose();
      });
      return ((k.cancel = D), k);
    }
    ...
    class _ {
      constructor(A, D) {
        ...
        ((this.emitter = new Re(k)), D && D.add(this.emitter));
      }
      beginUpdate(A) {
        this._counter++;
      }
      ...
      endUpdate(A) {
        (this._counter--,
          this._counter === 0 &&
            (this._observable.reportChanges(), this._hasChanged && ((this._hasChanged = !1), this.emitter.fire(this._observable.get()))));
      }
    }
    function N(v, A) {
      return new _(v, A).emitter.event;
    }
    e.fromObservable = N;
    function S(v) {
      return (A, D, k) => {
        ...
        const W = {
          ...
          endUpdate() {
            (E--, E === 0 && (v.reportChanges(), M && ((M = !1), A.call(D))));
          },
        ...
        (v.addObserver(W), v.reportChanges());
        const F = {
          dispose() {
            v.removeObserver(W);
          },
        };
        return (k instanceof Lt ? k.add(F) : Array.isArray(k) && k.push(F), F);
      };
    }
    e.fromObservableLight = S;
  })(Rn || (Rn = {}));
  const xt = class xt {
    constructor(t) {
      ((this.listenerCount = 0),
        ...
        (this.durations = []),
        (this.name = `${t}_${xt._idPool++}`),
        xt.all.add(this));
    }
    start(t) {
      ((this._stopWatch = new Jt()), (this.listenerCount = t));
    }
    stop() {
      if (this._stopWatch) {
  ...
  ((xt.all = new Set()), (xt._idPool = 0));
  let Dn = xt,
    vo = -1;
  const xn = class xn {
    constructor(t, n, i = (xn._idPool++).toString(16).padStart(3, "0")) {
    ...
    check(t, n) {
      ...
      if ((this._stacks.set(t.value, r + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)) {
        ...
        const [s, a] = this.getMostFrequentStack(),
          l = `[${this.name}] potential listener LEAK detected, having ${n} listeners already. MOST frequent listener (${a}):`;
    ...
    getMostFrequentStack() {
      ...
      let t,
        n = 0;
      for (const [i, r] of this._stacks) (!t || n < r) && ((t = [i, r]), (n = r));
      return t;
    }
  };
  xn._idPool = 1;
...
`),
  ...
  class Re {
    constructor(t) {
      ...
      ((this._size = 0),
        (this._options = t),
        (this._leakageMon =
          (n = this._options) != null && n.leakWarningThreshold
            ? new Mn((t == null ? void 0 : t.onListenerError) ?? He, ((i = this._options) == null ? void 0 : i.leakWarningThreshold) ?? vo)
            : void 0),
        (this._perfMon = (r = this._options) != null && r._profName ? new Dn(this._options._profName) : void 0),
        (this._deliveryQueue = (s = this._options) == null ? void 0 : s.deliveryQueue));
    }
    dispose() {
      var t, n, i, r;
      this._disposed ||
        ((this._disposed = !0),
        ((t = this._deliveryQueue) == null ? void 0 : t.current) === this && this._deliveryQueue.reset(),
        this._listeners && ((this._listeners = void 0), (this._size = 0)),
        (i = (n = this._options) == null ? void 0 : n.onDidRemoveLastListener) == null || i.call(n),
        (r = this._leakageMon) == null || r.dispose());
    }
    get event() {
      return (
        this._event ??
          (this._event = (t, n, i) => {
            ...
            if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
              const w = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`;
              console.warn(w);
              const p = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
                x = new To(`${w}. HINT: Stack shows most frequent listener (${p[1]}-times)`, p[0]);
              return ((((l = this._options) == null ? void 0 : l.onListenerError) || He)(x), Ze.None);
            }
            if (this._disposed) return Ze.None;
            n && (t = t.bind(n));
            const r = new In(t);
            let s;
            (this._leakageMon &&
              this._size >= Math.ceil(this._leakageMon.threshold * 0.2) &&
              ((r.stack = Nn.create()), (s = this._leakageMon.check(r.stack, this._size + 1))),
              this._listeners
                ? this._listeners instanceof In
                  ? (this._deliveryQueue ?? (this._deliveryQueue = new ko()), (this._listeners = [this._listeners, r]))
                  : this._listeners.push(r)
                : ((u = (o = this._options) == null ? void 0 : o.onWillAddFirstListener) == null || u.call(o, this),
                  (this._listeners = r),
                  (d = (c = this._options) == null ? void 0 : c.onDidAddFirstListener) == null || d.call(c, this)),
              (f = (m = this._options) == null ? void 0 : m.onDidAddListener) == null || f.call(m, this),
              this._size++);
            const a = Xt(() => {
              (s == null || s(), this._removeListener(r));
            });
            return (i instanceof Lt ? i.add(a) : Array.isArray(i) && i.push(a), a);
          }),
        this._event
      );
    }
    _removeListener(t) {
      var s, a, l, o;
      if (((a = (s = this._options) == null ? void 0 : s.onWillRemoveListener) == null || a.call(s, this), !this._listeners)) return;
      if (this._size === 1) {
        ((this._listeners = void 0),
          (o = (l = this._options) == null ? void 0 : l.onDidRemoveLastListener) == null || o.call(l, this),
          (this._size = 0));
        return;
      }
      ...
      if (this._size * xo <= n.length) {
        ...
        for (let c = 0; c < n.length; c++)
          n[c]
            ? (n[u++] = n[c])
            : r && u < this._deliveryQueue.end && (this._deliveryQueue.end--, u < this._deliveryQueue.i && this._deliveryQueue.i--);
        n.length = u;
      }
    }
    _deliver(t, n) {
      var r;
      if (!t) return;
      const i = ((r = this._options) == null ? void 0 : r.onListenerError) || He;
      if (!i) {
        t.value(n);
        return;
      }
    ...
    fire(t) {
      var n, i, r, s;
      if (
        ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (i = this._perfMon) == null || i.stop()),
        (r = this._perfMon) == null || r.start(this._size),
        this._listeners)
      )
        if (this._listeners instanceof In) this._deliver(this._listeners, t);
        else {
  ...
  const Ao =
    Fi() === "pseudo" ||
    (typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0);
  function Bi(e, t) {
    let n;
    return (
      t.length === 0
        ...
        : (n = e.replace(/\{(\d+)\}/g, (i, r) => {
            ...
            let l = i;
            return (
              typeof a == "string" ? (l = a) : (typeof a == "number" || typeof a == "boolean" || a === void 0 || a === null) && (l = String(a)),
              l
            );
          })),
      Ao && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"),
      n
    );
  }
  function q(e, t, ...n) {
    return Bi(typeof e == "number" ? Lo(e, t) : t, n);
  }
  function Lo(e, t) {
    var i;
    const n = (i = So()) == null ? void 0 : i[e];
    if (typeof n != "string") {
  ...
  const Ke = globalThis;
  let ae;
  typeof Ke.vscode < "u" && typeof Ke.vscode.process < "u"
    ? (ae = Ke.vscode.process)
    : typeof process < "u" && typeof ((ao = process == null ? void 0 : process.versions) == null ? void 0 : ao.node) == "string" && (ae = process);
  const Eo =
    typeof ((oo = ae == null ? void 0 : ae.versions) == null ? void 0 : oo.electron) == "string" && (ae == null ? void 0 : ae.type) === "renderer";
  if (typeof ae == "object") {
    ((zn = ae.platform === "win32"),
      (Hn = ae.platform === "darwin"),
      (Un = ae.platform === "linux"),
      Un && ae.env.SNAP && ae.env.SNAP_REVISION,
      ae.env.CI || ae.env.BUILD_ARTIFACTSTAGINGDIRECTORY || ae.env.GITHUB_WORKSPACE,
      (Qt = ot),
      (Pn = ot));
    ...
    if (e)
      try {
        ...
        ((Qt = t.userLocale),
          (qi = t.osLocale),
          (Pn = t.resolvedLanguage || ot),
          (Co = (lo = t.languagePack) == null ? void 0 : lo.translationsConfigFile));
      } catch {}
  } else
    typeof navigator == "object" && !Eo
      ? ((ke = navigator.userAgent),
        (zn = ke.indexOf("Windows") >= 0),
        (Hn = ke.indexOf("Macintosh") >= 0),
        (ke.indexOf("Macintosh") >= 0 || ke.indexOf("iPad") >= 0 || ke.indexOf("iPhone") >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (Un = ke.indexOf("Linux") >= 0),
        (ke == null ? void 0 : ke.indexOf("Mobi")) >= 0,
        (Pn = Fi() || ot),
        (Qt = navigator.language.toLowerCase()),
        (qi = Qt))
      : console.error("Unable to resolve platform.");
  const Ct = zn,
    Ro = Hn,
    De = ke,
    Do = typeof Ke.postMessage == "function" && !Ke.importScripts;
  (() => {
    if (Do) {
      const e = [];
      Ke.addEventListener("message", (n) => {
      ...
      return (n) => {
        const i = ++t;
        (e.push({ id: i, callback: n }), Ke.postMessage({ vscodeScheduleAsyncWork: i }, "*"));
      };
    }
    return (e) => setTimeout(e);
  })();
  const Mo = !!(De && De.indexOf("Chrome") >= 0);
  (De && De.indexOf("Firefox") >= 0, !Mo && De && De.indexOf("Safari") >= 0, De && De.indexOf("Edg/") >= 0, De && De.indexOf("Android") >= 0);
  function No(e) {
    return e;
  }
  class Io {
    constructor(t, n) {
      ((this.lastCache = void 0),
        ...
        typeof t == "function" ? ((this._fn = t), (this._computeKey = No)) : ((this._fn = n), (this._computeKey = t.getCacheKey)));
    }
    get(t) {
  ...
  class Wn {
    constructor(t) {
      ((this.executor = t), (this._state = et.Uninitialized));
    }
    get value() {
      if (this._state === et.Uninitialized) {
        this._state = et.Running;
        try {
          this._value = this.executor();
        } catch (t) {
          this._error = t;
        } finally {
          this._state = et.Completed;
        }
      } else if (this._state === et.Running) throw new Error("Cannot read the value of a lazy that is being initialized");
  ...
  function Bo(e, t) {
    ...
    const r = e.length - 1,
      s = t.length - 1;
    for (i = 0; i < n; i++) if (e.charCodeAt(r - i) !== t.charCodeAt(s - i)) return i;
    return n;
  }
  function Fn(e) {
  ...
  ((Ie.ambiguousCharacterData = new Wn(() =>
    JSON.parse(
    ...
    (Ie.cache = new Io({ getCacheKey: JSON.stringify }, (t) => {
      function n(c) {
        const d = new Map();
    ...
    (Ie._locales = new Wn(() => Object.keys(Ie.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")))));
  let Et = Ie;
  const kt = class kt {
    static getRawData() {
      return JSON.parse(
    ...
    static getData() {
      return (this._data || (this._data = new Set([...Object.values(kt.getRawData())].flat())), this._data);
    }
    static isInvisibleCharacter(t) {
      return kt.getData().has(t);
    }
  ...
  class Zo {
    ...
    async sendMessage(t, n, i) {
      const r = String(++this._lastSentReq);
      return new Promise((s, a) => {
        ((this._pendingReplies[r] = { resolve: s, reject: a }), this._send(new Xo(this._workerId, r, t, n, i)));
      });
    }
    listen(t, n, i) {
      let r = null;
      const s = new Re({
        onWillAddFirstListener: () => {
          ((r = String(++this._lastSentReq)), this._pendingEmitters.set(r, s), this._send(new Jo(this._workerId, r, t, n, i)));
        },
        onDidRemoveLastListener: () => {
      ...
      const i = {
        get: (r, s) => (
          typeof s == "string" &&
            !r[s] &&
            ($i(s)
              ? (r[s] = (a) => this.listen(t, s, a))
              : ji(s)
                ? (r[s] = this.listen(t, s, void 0))
                : s.charCodeAt(0) === 36 && (r[s] = async (...a) => (await (n == null ? void 0 : n()), this.sendMessage(t, s, a)))),
          r[s]
        ),
      };
      return new Proxy(Object.create(null), i);
    }
    _handleMessage(t) {
      switch (t.type) {
        case 1:
    ...
    _handleReplyMessage(t) {
      ...
      if ((delete this._pendingReplies[t.seq], t.err)) {
        ...
        if (t.err.$isError) {
          const r = new Error();
          ((r.name = t.err.name), (r.message = t.err.message), (r.stack = t.err.stack), (i = r));
        }
        n.reject(i);
        return;
      }
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.channel, t.method, t.args).then(
        ...
        (r) => {
          (r.detail instanceof Error && (r.detail = Cn(r.detail)), this._send(new Vi(this._workerId, n, void 0, Cn(r))));
        },
      );
    }
    _handleSubscribeEventMessage(t) {
      const n = t.req,
        i = this._handler.handleEvent(
          ...
          this._send(new Qo(this._workerId, n, r));
        });
    ...
    _send(t) {
      ...
      if (t.type === 0)
        for (let i = 0; i < t.args.length; i++) {
          const r = t.args[i];
          r instanceof ArrayBuffer && n.push(r);
        }
  ...
  function ji(e) {
    return e[0] === "o" && e[1] === "n" && Oi(e.charCodeAt(2));
  }
  function $i(e) {
    return /^onDynamic/.test(e) && Oi(e.charCodeAt(9));
  }
  class Ko {
    constructor(t, n) {
      ((this._localChannels = new Map()),
        (this._remoteChannels = new Map()),
        (this._protocol = new Zo({
          sendMessage: (i, r) => {
            t(i, r);
          },
    ...
    _handleMessage(t, n, i) {
      if (t === Bn && n === Go) return this.initialize(i[0]);
      const r = t === Bn ? this.requestHandler : this._localChannels.get(t);
      if (!r) return Promise.reject(new Error(`Missing channel ${t} on worker thread`));
      const s = r[n];
      if (typeof s != "function") return Promise.reject(new Error(`Missing method ${n} on worker thread channel ${t}`));
      try {
        return Promise.resolve(s.apply(r, i));
      } catch (a) {
    ...
    _handleEvent(t, n, i) {
      const r = t === Bn ? this.requestHandler : this._localChannels.get(t);
      if (!r) throw new Error(`Missing channel ${t} on worker thread`);
      if ($i(n)) {
        const s = r[n];
        if (typeof s != "function") throw new Error(`Missing dynamic event ${n} on request handler.`);
        const a = s.call(r, i);
        if (typeof a != "function") throw new Error(`Missing dynamic event ${n} on request handler.`);
        return a;
      }
      if (ji(n)) {
        const s = r[n];
  ...
  new Wn(() => new Uint8Array(256));
  function Xi(e, t) {
    return ((t << 5) - t + e) | 0;
  }
  function tl(e, t) {
    t = Xi(149417, t);
    for (let n = 0, i = e.length; n < i; n++) t = Xi(e.charCodeAt(n), t);
    return t;
  }
  class Ji {
    constructor(t) {
  ...
  function nl(e, t, n) {
    return new je(new Ji(e), new Ji(t)).ComputeDiff(n).changes;
  }
  class lt {
    static Assert(t, n) {
  ...
  class Qi {
    ...
    MarkNextChange() {
      ((this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
        this.m_changes.push(new Ve(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount)),
        (this.m_originalCount = 0),
        (this.m_modifiedCount = 0),
        (this.m_originalStart = 1073741824),
        (this.m_modifiedStart = 1073741824));
  ...
  class je {
    ...
    static _getElements(t) {
      ...
      if (je._isStringArray(n)) {
        ...
        for (let r = 0, s = n.length; r < s; r++) i[r] = tl(n[r], 0);
        return [n, i, !0];
      }
    ...
    ElementsAreStrictEqual(t, n) {
      ...
      const i = je._getStrictElement(this._originalSequence, t),
        r = je._getStrictElement(this._modifiedSequence, n);
      return i === r;
    }
    ...
    _ComputeDiff(t, n, i, r, s) {
      ...
      return (s && (l = this.PrettifyChanges(l)), { quitEarly: a[0], changes: l });
    }
    ComputeDiffRecursive(t, n, i, r, s) {
      for (s[0] = !1; t <= n && i <= r && this.ElementsAreEqual(t, i); ) (t++, i++);
      for (; n >= t && r >= i && this.ElementsAreEqual(n, r); ) (n--, r--);
      if (t > n || i > r) {
        let d;
        return (
          i <= r
            ? (lt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), (d = [new Ve(t, 0, i, r - i + 1)]))
            : t <= n
              ? (lt.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), (d = [new Ve(t, n - t + 1, i, 0)]))
              : (lt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"),
                lt.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                (d = [])),
          d
        );
      }
      const a = [0],
        l = [0],
        o = this.ComputeRecursionPoint(t, n, i, r, a, l, s),
        u = a[0],
        c = l[0];
      if (o !== null) return o;
      if (!s[0]) {
        ...
        let m = [];
        return (
          s[0] ? (m = [new Ve(u + 1, n - (u + 1) + 1, c + 1, r - (c + 1) + 1)]) : (m = this.ComputeDiffRecursive(u + 1, n, c + 1, r, s)),
          this.ConcatenateChanges(d, m)
        );
      }
      return [new Ve(t, n - t + 1, i, r - i + 1)];
    }
    WALKTRACE(t, n, i, r, s, a, l, o, u, c, d, m, f, w, p, x, T, y) {
      let L = null,
        I = null,
        H = new Qi(),
        P = n,
      ...
      do {
        const S = g + t;
        (S === P || (S < b && u[S - 1] < u[S + 1])
          ? ((d = u[S + 1]), (w = d - g - r), d < _ && H.MarkNextChange(), (_ = d), H.AddModifiedElement(d + 1, w), (g = S + 1 - t))
          : ((d = u[S - 1] + 1), (w = d - g - r), d < _ && H.MarkNextChange(), (_ = d - 1), H.AddOriginalElement(d, w + 1), (g = S - 1 - t)),
          N >= 0 && ((u = this.m_forwardHistory[N]), (t = u[0]), (P = 1), (b = u.length - 1)));
      } while (--N >= -1);
      if (((L = H.getReverseChanges()), y[0])) {
        let S = f[0] + 1,
          v = x[0] + 1;
        if (L !== null && L.length > 0) {
          const A = L[L.length - 1];
          ((S = Math.max(S, A.getOriginalEnd())), (v = Math.max(v, A.getModifiedEnd())));
        }
        I = [new Ve(S, m - S + 1, v, p - v + 1)];
      } else {
        ((H = new Qi()),
          (P = a),
          (b = l),
          (g = f[0] - x[0] - o),
          (_ = 1073741824),
          (N = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2));
        do {
          const S = g + s;
          (S === P || (S < b && c[S - 1] >= c[S + 1])
            ? ((d = c[S + 1] - 1), (w = d - g - o), d > _ && H.MarkNextChange(), (_ = d + 1), H.AddOriginalElement(d + 1, w + 1), (g = S + 1 - s))
            : ((d = c[S - 1]), (w = d - g - o), d > _ && H.MarkNextChange(), (_ = d), H.AddModifiedElement(d + 1, w + 1), (g = S - 1 - s)),
            N >= 0 && ((c = this.m_reverseHistory[N]), (s = c[0]), (P = 1), (b = c.length - 1)));
        } while (--N >= -1);
        I = H.getChanges();
      }
      return this.ConcatenateChanges(L, I);
    }
    ComputeRecursionPoint(t, n, i, r, s, a, l) {
      ...
      const w = n - t + (r - i),
        ...
        b = (L - y) % 2 === 0;
      ((x[y] = t), (T[L] = n), (l[0] = !1));
      for (let g = 1; g <= w / 2 + 1; g++) {
        let _ = 0,
          N = 0;
        ((c = this.ClipDiagonalBound(y - g, g, y, p)), (d = this.ClipDiagonalBound(y + g, g, y, p)));
        for (let v = c; v <= d; v += 2) {
          (v === c || (v < d && x[v - 1] < x[v + 1]) ? (o = x[v + 1]) : (o = x[v - 1] + 1), (u = o - (v - y) - I));
          const A = o;
          for (; o < n && u < r && this.ElementsAreEqual(o + 1, u + 1); ) (o++, u++);
          if (((x[v] = o), o + u > _ + N && ((_ = o), (N = u)), !b && Math.abs(v - L) <= g - 1 && o >= T[v]))
            return ((s[0] = o), (a[0] = u), A <= T[v] && g <= 1448 ? this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l) : null);
        }
        const S = (_ - t + (N - i) - g) / 2;
        if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(_, S))
          return (
            (l[0] = !0),
            (s[0] = _),
            (a[0] = N),
            S > 0 && g <= 1448
              ? this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l)
              : (t++, i++, [new Ve(t, n - t + 1, i, r - i + 1)])
          );
        ((m = this.ClipDiagonalBound(L - g, g, L, p)), (f = this.ClipDiagonalBound(L + g, g, L, p)));
        for (let v = m; v <= f; v += 2) {
          (v === m || (v < f && T[v - 1] >= T[v + 1]) ? (o = T[v + 1] - 1) : (o = T[v - 1]), (u = o - (v - L) - H));
          const A = o;
          for (; o > t && u > i && this.ElementsAreEqual(o, u); ) (o--, u--);
          if (((T[v] = o), b && Math.abs(v - y) <= g && o <= x[v]))
            return ((s[0] = o), (a[0] = u), A >= x[v] && g <= 1448 ? this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l) : null);
        }
        if (g <= 1447) {
          let v = new Int32Array(d - c + 2);
          ((v[0] = y - c + 1),
            ut.Copy2(x, c, v, 1, d - c + 1),
            this.m_forwardHistory.push(v),
            (v = new Int32Array(f - m + 2)),
            (v[0] = L - m + 1),
            ut.Copy2(T, m, v, 1, f - m + 1),
            this.m_reverseHistory.push(v));
        }
      }
      return this.WALKTRACE(y, c, d, I, L, m, f, H, x, T, o, n, s, u, r, a, b, l);
    }
    PrettifyChanges(t) {
      for (let n = 0; n < t.length; n++) {
        const i = t[n],
          ...
          a = i.originalLength > 0,
          l = i.modifiedLength > 0;
        for (
          ;
          i.originalStart + i.originalLength < r &&
          i.modifiedStart + i.modifiedLength < s &&
          (!a || this.OriginalElementsAreEqual(i.originalStart, i.originalStart + i.originalLength)) &&
          (!l || this.ModifiedElementsAreEqual(i.modifiedStart, i.modifiedStart + i.modifiedLength));
        ) {
      ...
      for (let n = t.length - 1; n >= 0; n--) {
        ...
        const a = i.originalLength > 0,
          l = i.modifiedLength > 0;
        let o = 0,
          u = this._boundaryScore(i.originalStart, i.originalLength, i.modifiedStart, i.modifiedLength);
        for (let d = 1; ; d++) {
          ...
          if (
            m < r ||
            f < s ||
            (a && !this.OriginalElementsAreEqual(m, m + i.originalLength)) ||
            (l && !this.ModifiedElementsAreEqual(f, f + i.modifiedLength))
          )
            break;
          const p = (m === r && f === s ? 5 : 0) + this._boundaryScore(m, i.originalLength, f, i.modifiedLength);
          p > u && ((u = p), (o = d));
        }
      ...
      if (this._hasStrings)
        for (let n = 1, i = t.length; n < i; n++) {
          const r = t[n - 1],
            ...
            l = r.originalStart,
            o = s.originalStart + s.originalLength,
            u = o - l,
            c = r.modifiedStart,
            d = s.modifiedStart + s.modifiedLength,
            m = d - c;
          if (a < 5 && u < 20 && m < 20) {
            const f = this._findBetterContiguousSequence(l, u, c, m, a);
            if (f) {
              const [w, p] = f;
              (w !== r.originalStart + r.originalLength || p !== r.modifiedStart + r.modifiedLength) &&
                ((r.originalLength = w - r.originalStart),
                (r.modifiedLength = p - r.modifiedStart),
                (s.originalStart = w + a),
                (s.modifiedStart = p + a),
                (s.originalLength = o - s.originalStart),
    ...
    _boundaryScore(t, n, i, r) {
      const s = this._OriginalRegionIsBoundary(t, n) ? 1 : 0,
        a = this._ModifiedRegionIsBoundary(i, r) ? 1 : 0;
      return s + a;
    }
    ConcatenateChanges(t, n) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
        ...
        return (ut.Copy(t, 0, r, 0, t.length - 1), (r[t.length - 1] = i[0]), ut.Copy(n, 1, r, t.length, n.length - 1), r);
      } else {
        const r = new Array(t.length + n.length);
        return (ut.Copy(t, 0, r, 0, t.length), ut.Copy(n, 0, r, t.length, n.length), r);
      }
    }
    ChangesOverlap(t, n, i) {
      if (
        (lt.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"),
        lt.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"),
        ...
        return (
          t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart),
          t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart),
          (i[0] = new Ve(r, s, a, l)),
          !0
        );
  ...
  let K = class st {
    ...
    j = class re {
      constructor(t, n, i, r) {
        t > i || (t === i && n > r)
          ? ((this.startLineNumber = i), (this.startColumn = r), (this.endLineNumber = t), (this.endColumn = n))
          : ((this.startLineNumber = t), (this.startColumn = n), (this.endLineNumber = i), (this.endColumn = r));
      }
      isEmpty() {
      ...
      static plusRange(t, n) {
        ...
        return (
          n.startLineNumber < t.startLineNumber
            ...
            : n.startLineNumber === t.startLineNumber
              ? ((i = n.startLineNumber), (r = Math.min(n.startColumn, t.startColumn)))
              : ((i = t.startLineNumber), (r = t.startColumn)),
          n.endLineNumber > t.endLineNumber
            ? ((s = n.endLineNumber), (a = n.endColumn))
            : n.endLineNumber === t.endLineNumber
              ? ((s = n.endLineNumber), (a = Math.max(n.endColumn, t.endColumn)))
      ...
      static intersectRanges(t, n) {
        ...
        const l = n.startLineNumber,
          ...
          c = n.endColumn;
        return (
          i < l ? ((i = l), (r = o)) : i === l && (r = Math.max(r, o)),
          s > u ? ((s = u), (a = c)) : s === u && (a = Math.min(a, c)),
          i > s || (i === s && r > a) ? null : new re(i, r, s, a)
        );
      }
      equalsRange(t) {
      ...
      static areOnlyIntersecting(t, n) {
        return !(
          t.endLineNumber < n.startLineNumber - 1 ||
          (t.endLineNumber === n.startLineNumber && t.endColumn < n.startColumn - 1) ||
          n.endLineNumber < t.startLineNumber - 1 ||
          (n.endLineNumber === t.startLineNumber && n.endColumn < t.startColumn - 1)
        );
      }
  ...
  class qn {
    constructor(t) {
      const n = Yi(t);
      ((this._defaultValue = n), (this._asciiMap = qn._createAsciiMap(n)), (this._map = new Map()));
    }
  ...
  class Yt {
    static _createLink(t, n, i, r, s) {
      ...
      return { range: { startLineNumber: i, startColumn: r + 1, endLineNumber: i, endColumn: a + 2 }, url: n.substring(r, a + 1) };
    }
        ...
        for (; u < o; ) {
          ...
          if (m === 13) {
            ...
            switch (y) {
              ...
              case 34:
              case 96:
                d === y ? (L = 1) : d === 39 || d === 34 || d === 96 ? (L = 0) : (L = 1);
                break;
              case 42:
                L = d === 42 ? 1 : 0;
                break;
            ...
            L === 1 && (r.push(Yt._createLink(i, l, s, c, u)), (T = !0));
          } else if (m === 12) {
            let L;
            (y === 91 ? ((w = !0), (L = 0)) : (L = i.get(y)), L === 1 ? (T = !0) : (m = 13));
          } else ((m = n.nextState(m, y)), m === 0 && (T = !0));
          (T && ((m = 1), (f = !1), (w = !1), (x = !1), (c = u + 1), (d = y)), u++);
        }
        m === 13 && r.push(Yt._createLink(i, l, s, c, o));
      }
      return r;
    }
  }
  ...
  const kn = class kn {
    ...
    valueSetsReplace(t, n, i) {
      let r = null;
      for (let s = 0, a = t.length; r === null && s < a; s++) r = this.valueSetReplace(t[s], n, i);
      return r;
    }
  ...
  (function (e) {
    function t(n) {
      return n === e.None || n === e.Cancelled || n instanceof Kt
        ? !0
        : !n || typeof n != "object"
          ? !1
    ...
    ((e.isCancellationToken = t),
      (e.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: Rn.None })),
      (e.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: Zi })));
  })(Zt || (Zt = {}));
  class Kt {
    constructor() {
    ...
    get onCancellationRequested() {
      return this._isCancelled ? Zi : (this._emitter || (this._emitter = new Re()), this._emitter.event);
    }
    dispose() {
  ...
  class ll {
    ...
    get token() {
      return (this._token || (this._token = new Kt()), this._token);
    }
    cancel() {
      this._token ? this._token instanceof Kt && this._token.cancel() : (this._token = Zt.Cancelled);
    }
    dispose(t = !1) {
      var n;
      (t && this.cancel(),
        (n = this._parentListener) == null || n.dispose(),
        this._token ? this._token instanceof Kt && this._token.dispose() : (this._token = Zt.None));
    }
  }
  class jn {
    constructor() {
  ...
  (function () {
    const e = "",
      ...
      i = [];
    for (const r of t) {
      const [s, a, l, o, u, c, d, m, f] = r;
      if ((i[a] || ((i[a] = !0), (cl[l] = a), (hl[l.toLowerCase()] = a)), !n[o])) {
        if (((n[o] = !0), !u)) throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
        (en.define(o, u), $n.define(o, m || u), Gn.define(o, f || m || u));
      }
      c && (ul[c] = o);
    }
  })();
  ...
  (function (e) {
    ...
    function s(l) {
      return $n.strToKeyCode(l) || Gn.strToKeyCode(l);
    }
  ...
  if (typeof Xn < "u" && typeof Xn.process < "u") {
    ...
    typeof process < "u" && typeof ((uo = process == null ? void 0 : process.versions) == null ? void 0 : uo.node) == "string"
      ? (ht = {
          get platform() {
          ...
          cwd() {
            return er.VSCODE_CWD || process.cwd();
          },
        })
      : (ht = {
          get platform() {
            return Ct ? "win32" : Ro ? "darwin" : "linux";
          },
          get arch() {},
          get env() {
            return {};
  ...
  function vl(e, t) {
    if (e === null || typeof e != "object") throw new tr(t, "Object", e);
  }
  function ie(e, t) {
    if (typeof e != "string") throw new tr(t, "string", e);
  }
  const $e = fl === "win32";
  function $(e) {
    return e === oe || e === de;
  ...
  function nn(e, t, n, i) {
    ...
    for (let u = 0; u <= e.length; ++u) {
      ...
      if (i(o)) {
        if (!(a === u - 1 || l === 1))
          if (l === 2) {
            if (r.length < 2 || s !== 2 || r.charCodeAt(r.length - 1) !== tt || r.charCodeAt(r.length - 2) !== tt) {
              if (r.length > 2) {
          ...
          } else (r.length > 0 ? (r += `${n}${e.slice(a + 1, u)}`) : (r = e.slice(a + 1, u)), (s = u - a - 1));
        ((a = u), (l = 0));
      } else o === tt && l !== -1 ? ++l : (l = -1);
    }
    return r;
  ...
  const ce = {
      resolve(...e) {
        ...
        for (let r = e.length - 1; r >= -1; r--) {
          let s;
          if (r >= 0) {
            if (((s = e[r]), ie(s, `paths[${r}]`), s.length === 0)) continue;
          } else
            t.length === 0
              ? (s = tn())
              : ((s = ml[`=${t}`] || tn()),
                (s === void 0 || (s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === de)) && (s = `${t}\\`));
          const a = s.length;
          let l = 0,
            o = "",
            u = !1;
          ...
          if (a === 1) $(c) && ((l = 1), (u = !0));
            ...
            if (((u = !0), $(s.charCodeAt(1)))) {
              let d = 2,
                m = d;
              for (; d < a && !$(s.charCodeAt(d)); ) d++;
              if (d < a && d !== m) {
                const f = s.slice(m, d);
                for (m = d; d < a && $(s.charCodeAt(d)); ) d++;
                if (d < a && d !== m) {
                  for (m = d; d < a && !$(s.charCodeAt(d)); ) d++;
                  (d === a || d !== m) && ((o = `\\\\${f}\\${s.slice(m, d)}`), (l = d));
                }
              }
            } else l = 1;
          else Pe(c) && s.charCodeAt(1) === Ue && ((o = s.slice(0, 2)), (l = 2), a > 2 && $(s.charCodeAt(2)) && ((u = !0), (l = 3)));
          if (o.length > 0)
            if (t.length > 0) {
          ...
          if (i) {
            if (t.length > 0) break;
          } else if (((n = `${s.slice(l)}\\${n}`), (i = u), u && t.length > 0)) break;
        }
        return ((n = nn(n, !i, "\\", $)), i ? `${t}\\${n}` : `${t}${n}` || ".");
      },
      normalize(e) {
        ie(e, "path");
        const t = e.length;
        ...
        if ($(s))
          if (((r = !0), $(e.charCodeAt(1)))) {
            let l = 2,
              o = l;
            for (; l < t && !$(e.charCodeAt(l)); ) l++;
            if (l < t && l !== o) {
              const u = e.slice(o, l);
              for (o = l; l < t && $(e.charCodeAt(l)); ) l++;
              if (l < t && l !== o) {
                for (o = l; l < t && !$(e.charCodeAt(l)); ) l++;
        ...
        else Pe(s) && e.charCodeAt(1) === Ue && ((i = e.slice(0, 2)), (n = 2), t > 2 && $(e.charCodeAt(2)) && ((r = !0), (n = 3)));
        let a = n < t ? nn(e.slice(n), !r, "\\", $) : "";
        if ((a.length === 0 && !r && (a = "."), a.length > 0 && $(e.charCodeAt(t - 1)) && (a += "\\"), !r && i === void 0 && e.includes(":"))) {
          if (a.length >= 2 && Pe(a.charCodeAt(0)) && a.charCodeAt(1) === Ue) return `.\\${a}`;
          let l = e.indexOf(":");
          do if (l === t - 1 || $(e.charCodeAt(l + 1))) return `.\\${a}`;
      ...
      isAbsolute(e) {
        ...
        return $(n) || (t > 2 && Pe(n) && e.charCodeAt(1) === Ue && $(e.charCodeAt(2)));
      },
      join(...e) {
        ...
        for (let s = 0; s < e.length; ++s) {
          const a = e[s];
          (ie(a, "path"), a.length > 0 && (t === void 0 ? (t = n = a) : (t += `\\${a}`)));
        }
        if (t === void 0) return ".";
        let i = !0,
          r = 0;
        if (typeof n == "string" && $(n.charCodeAt(0))) {
          ++r;
          const s = n.length;
          s > 1 && $(n.charCodeAt(1)) && (++r, s > 2 && ($(n.charCodeAt(2)) ? ++r : (i = !1)));
        }
        if (i) {
          for (; r < t.length && $(t.charCodeAt(r)); ) r++;
          r >= 2 && (t = `\\${t.slice(r)}`);
        }
        return ce.normalize(t);
      },
      relative(e, t) {
        if ((ie(e, "from"), ie(t, "to"), e === t)) return "";
        ...
        if (n.length !== e.length || i.length !== t.length) {
          const w = n.split("\\"),
            p = i.split("\\");
          (w[w.length - 1] === "" && w.pop(), p[p.length - 1] === "" && p.pop());
          const x = w.length,
            T = p.length,
            y = x < T ? x : T;
          let L;
          for (L = 0; L < y && w[L].toLowerCase() === p[L].toLowerCase(); L++);
          return L === 0
            ? i
            : L === y
              ? T > y
                ...
                : x > y
                  ? "..\\".repeat(x - 1 - L) + ".."
                  : ""
              : "..\\".repeat(x - L) + p.slice(L).join("\\");
        }
        let r = 0;
        for (; r < e.length && e.charCodeAt(r) === de; ) r++;
        let s = e.length;
        for (; s - 1 > r && e.charCodeAt(s - 1) === de; ) s--;
        const a = s - r;
        let l = 0;
        for (; l < t.length && t.charCodeAt(l) === de; ) l++;
        let o = t.length;
        for (; o - 1 > l && t.charCodeAt(o - 1) === de; ) o--;
        const u = o - l,
          c = a < u ? a : u;
        let d = -1,
          m = 0;
        ...
        if (m !== c) {
          ...
          if (u > c) {
            if (t.charCodeAt(l + m) === de) return i.slice(l + m + 1);
            if (m === 2) return i.slice(l + m);
          }
          (a > c && (e.charCodeAt(r + m) === de ? (d = m) : m === 2 && (d = 3)), d === -1 && (d = 0));
        }
        let f = "";
        for (m = r + d + 1; m <= s; ++m) (m === s || e.charCodeAt(m) === de) && (f += f.length === 0 ? ".." : "\\..");
        return ((l += d), f.length > 0 ? `${f}${i.slice(l, o)}` : (i.charCodeAt(l) === de && ++l, i.slice(l, o)));
      },
      toNamespacedPath(e) {
        ...
        if (t.charCodeAt(0) === de) {
          if (t.charCodeAt(1) === de) {
            ...
            if (n !== _l && n !== tt) return `\\\\?\\UNC\\${t.slice(2)}`;
          }
        } else if (Pe(t.charCodeAt(0)) && t.charCodeAt(1) === Ue && t.charCodeAt(2) === de) return `\\\\?\\${t}`;
        return t;
      },
      dirname(e) {
        ie(e, "path");
        ...
        } else Pe(r) && e.charCodeAt(1) === Ue && ((n = t > 2 && $(e.charCodeAt(2)) ? 3 : 2), (i = n));
        let s = -1,
          a = !0;
        for (let l = t - 1; l >= i; --l)
          if ($(e.charCodeAt(l))) {
      ...
      basename(e, t) {
        (t !== void 0 && ie(t, "suffix"), ie(e, "path"));
        let n = 0,
          i = -1,
          r = !0,
          s;
        if ((e.length >= 2 && Pe(e.charCodeAt(0)) && e.charCodeAt(1) === Ue && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length)) {
          if (t === e) return "";
          let a = t.length - 1,
            l = -1;
          for (s = e.length - 1; s >= n; --s) {
            ...
            } else (l === -1 && ((r = !1), (l = s + 1)), a >= 0 && (o === t.charCodeAt(a) ? --a === -1 && (i = s) : ((a = -1), (i = l))));
          }
      ...
      extname(e) {
        ...
        let t = 0,
          ...
          s = !0,
          a = 0;
        e.length >= 2 && e.charCodeAt(1) === Ue && Pe(e.charCodeAt(0)) && (t = i = 2);
        for (let l = e.length - 1; l >= t; --l) {
          ...
          (r === -1 && ((s = !1), (r = l + 1)), o === tt ? (n === -1 ? (n = l) : a !== 1 && (a = 1)) : n !== -1 && (a = -1));
        }
      ...
      parse(e) {
        ...
        let i = 0,
          r = e.charCodeAt(0);
        if (n === 1) return $(r) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
        if ($(r)) {
          if (((i = 1), $(e.charCodeAt(1)))) {
            let d = 2,
              m = d;
            for (; d < n && !$(e.charCodeAt(d)); ) d++;
            if (d < n && d !== m) {
              for (m = d; d < n && $(e.charCodeAt(d)); ) d++;
              if (d < n && d !== m) {
                for (m = d; d < n && !$(e.charCodeAt(d)); ) d++;
                d === n ? (i = d) : d !== m && (i = d + 1);
              }
        ...
        } else if (Pe(r) && e.charCodeAt(1) === Ue) {
          if (n <= 2) return ((t.root = t.dir = e), t);
          if (((i = 2), $(e.charCodeAt(2)))) {
        ...
        for (; u >= i; --u) {
          ...
          (l === -1 && ((o = !1), (l = u + 1)), r === tt ? (s === -1 ? (s = u) : c !== 1 && (c = 1)) : s !== -1 && (c = -1));
        }
        return (
          l !== -1 &&
            (s === -1 || c === 0 || (c === 1 && s === l - 1 && s === a + 1)
              ? (t.base = t.name = e.slice(a, l))
              : ((t.name = e.slice(a, s)), (t.base = e.slice(a, l)), (t.ext = e.slice(s, l)))),
          a > 0 && a !== i ? (t.dir = e.slice(0, a - 1)) : (t.dir = t.root),
          t
        );
      },
      sep: "\\",
    ...
    me = {
      resolve(...e) {
        ...
        for (let i = e.length - 1; i >= 0 && !n; i--) {
          const r = e[i];
          (ie(r, `paths[${i}]`), r.length !== 0 && ((t = `${r}/${t}`), (n = r.charCodeAt(0) === oe)));
        }
        if (!n) {
          const i = Tl();
          ((t = `${i}/${t}`), (n = i.charCodeAt(0) === oe));
        }
        return ((t = nn(t, !n, "/", Jn)), n ? `/${t}` : t.length > 0 ? t : ".");
      },
      normalize(e) {
        if ((ie(e, "path"), e.length === 0)) return ".";
        const t = e.charCodeAt(0) === oe,
          n = e.charCodeAt(e.length - 1) === oe;
        return ((e = nn(e, !t, "/", Jn)), e.length === 0 ? (t ? "/" : n ? "./" : ".") : (n && (e += "/"), t ? `/${e}` : e));
      },
      isAbsolute(e) {
        return (ie(e, "path"), e.length > 0 && e.charCodeAt(0) === oe);
      },
      join(...e) {
        if (e.length === 0) return ".";
        const t = [];
        for (let n = 0; n < e.length; ++n) {
          const i = e[n];
          (ie(i, "path"), i.length > 0 && t.push(i));
        }
        return t.length === 0 ? "." : me.normalize(t.join("/"));
      },
      relative(e, t) {
        if ((ie(e, "from"), ie(t, "to"), e === t || ((e = me.resolve(e)), (t = me.resolve(t)), e === t))) return "";
        const n = 1,
          i = e.length,
          r = i - n,
          s = 1,
        ...
        if (u === l)
          ...
          } else r > l && (e.charCodeAt(n + u) === oe ? (o = u) : u === 0 && (o = 0));
        let c = "";
        for (u = n + o + 1; u <= i; ++u) (u === i || e.charCodeAt(u) === oe) && (c += c.length === 0 ? ".." : "/..");
      ...
      parse(e) {
        ...
        for (; o >= i; --o) {
          ...
          (a === -1 && ((l = !1), (a = o + 1)), c === tt ? (r === -1 ? (r = o) : u !== 1 && (u = 1)) : r !== -1 && (u = -1));
        }
        if (a !== -1) {
          const c = s === 0 && n ? 1 : s;
          r === -1 || u === 0 || (u === 1 && r === a - 1 && r === s + 1)
            ? (t.base = t.name = e.slice(c, a))
            : ((t.name = e.slice(c, r)), (t.base = e.slice(c, a)), (t.ext = e.slice(r, a)));
        }
  ...
  ((me.win32 = ce.win32 = ce),
    ...
    $e ? ce.normalize : me.normalize,
    $e ? ce.resolve : me.resolve,
    $e ? ce.relative : me.relative,
    $e ? ce.dirname : me.dirname,
    $e ? ce.basename : me.basename,
    $e ? ce.extname : me.extname,
    $e ? ce.sep : me.sep);
  const xl = /^\w[\w\d+.-]*$/,
    kl = /^\//,
    Sl = /^\/\//;
  function Al(e, t) {
    ...
    if (e.scheme && !xl.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (e.path) {
      if (e.authority) {
        if (!kl.test(e.path))
          throw new Error(
  ...
  let Qn = class Ln {
    ...
    constructor(t, n, i, r, s, a = !1) {
      typeof t == "object"
        ? ((this.scheme = t.scheme || ee),
          (this.authority = t.authority || ee),
          (this.path = t.path || ee),
          (this.query = t.query || ee),
          (this.fragment = t.fragment || ee))
        : ((this.scheme = Ll(t, a)),
          (this.authority = n || ee),
          (this.path = Cl(this.scheme, i || ee)),
          (this.query = r || ee),
          (this.fragment = s || ee),
          Al(this, a));
    }
    ...
    with(t) {
      ...
      return (
        n === void 0 ? (n = this.scheme) : n === null && (n = ee),
        i === void 0 ? (i = this.authority) : i === null && (i = ee),
        r === void 0 ? (r = this.path) : r === null && (r = ee),
        s === void 0 ? (s = this.query) : s === null && (s = ee),
        a === void 0 ? (a = this.fragment) : a === null && (a = ee),
        n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new dt(n, i, r, s, a)
      );
    }
    static parse(t, n = !1) {
      const i = El.exec(t);
      return i ? new dt(i[2] || ee, rn(i[4] || ee), rn(i[5] || ee), rn(i[7] || ee), rn(i[9] || ee), n) : new dt(ee, ee, ee, ee, ee);
    }
    static file(t) {
      let n = ee;
      if ((Ct && (t = t.replace(/\\/g, Se)), t[0] === Se && t[1] === Se)) {
        const i = t.indexOf(Se, 2);
        i === -1 ? ((n = t.substring(2)), (t = Se)) : ((n = t.substring(2, i)), (t = t.substring(i) || Se));
      }
      return new dt("file", n, t, ee, ee);
    }
    static from(t, n) {
    ...
    static joinPath(t, ...n) {
      ...
      let i;
      return (Ct && t.scheme === "file" ? (i = Ln.file(ce.join(Yn(t, !0), ...n)).path) : (i = me.join(t.path, ...n)), t.with({ path: i }));
    }
    toString(t = !1) {
      return Zn(this, t);
    }
    ...
    static revive(t) {
      if (t) {
        ...
        {
          const n = new dt(t);
          return ((n._formatted = t.external ?? null), (n._fsPath = t._sep === ir ? (t.fsPath ?? null) : null), n);
        }
      } else return t;
    }
  };
  const ir = Ct ? 1 : void 0;
  class dt extends Qn {
    constructor() {
    ...
    toJSON() {
      const t = { $mid: 1 };
      return (
        this._fsPath && ((t.fsPath = this._fsPath), (t._sep = ir)),
  ...
  function Rl(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const i = e.charCodeAt(n);
      i === 35 || i === 63 ? (t === void 0 && (t = e.substr(0, n)), (t += rr[i])) : t !== void 0 && (t += e[n]);
    }
    return t !== void 0 ? t : e;
  }
  function Yn(e, t) {
    ...
    return (
      e.authority && e.path.length > 1 && e.scheme === "file"
        ...
        : e.path.charCodeAt(0) === 47 &&
            ((e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90) || (e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122)) &&
  ...
  function Zn(e, t) {
    const n = t ? Rl : sr;
    let i = "",
      { scheme: r, authority: s, path: a, query: l, fragment: o } = e;
    if ((r && ((i += r), (i += ":")), (s || r === "file") && ((i += Se), (i += Se)), s)) {
      let u = s.indexOf("@");
      if (u !== -1) {
        const c = s.substr(0, u);
        ((s = s.substr(u + 1)),
          (u = c.lastIndexOf(":")),
          u === -1 ? (i += n(c, !1, !1)) : ((i += n(c.substr(0, u), !1, !1)), (i += ":"), (i += n(c.substr(u + 1), !1, !0))),
          (i += "@"));
      }
    ...
    return (l && ((i += "?"), (i += n(l, !1, !1))), o && ((i += "#"), (i += t ? o : sr(o, !1, !1))), i);
  }
  function ar(e) {
    try {
      return decodeURIComponent(e);
    } catch {
      return e.length > 3 ? e.substr(0, 3) + ar(e.substr(3)) : e;
    }
  }
  const or = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
  function rn(e) {
    return e.match(or) ? e.replace(or, (t) => ar(t)) : e;
  }
  class ge extends j {
    constructor(t, n, i, r) {
      (super(t, n, i, r),
    ...
    toString() {
      return (
        "[" + this.selectionStartLineNumber + "," + this.selectionStartColumn + " -> " + this.positionLineNumber + "," + this.positionColumn + "]"
      );
    }
    equalsSelection(t) {
    ...
    static fromRange(t, n) {
      return n === 0
        ? new ge(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
        : new ge(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
    }
    ...
    static selectionsArrEqual(t, n) {
      ...
      for (let i = 0, r = t.length; i < r; i++) if (!this.selectionsEqual(t[i], n[i])) return !1;
      return !0;
    }
  ...
  const Dl = {
      ...
      commentDiscussionSparkle: h("comment-discussion-sparkle", 60500),
      chatSparkleWarning: h("chat-sparkle-warning", 60501),
      chatSparkleError: h("chat-sparkle-error", 60502),
      collection: h("collection", 60503),
      newCollection: h("new-collection", 60504),
      thinking: h("thinking", 60505),
      build: h("build", 60506),
      commentDiscussionQuote: h("comment-discussion-quote", 60507),
      cursor: h("cursor", 60508),
      eraser: h("eraser", 60509),
      fileText: h("file-text", 60510),
      gitLens: h("git-lens", 60511),
      quotes: h("quotes", 60512),
      rename: h("rename", 60513),
      runWithDeps: h("run-with-deps", 60514),
      debugConnected: h("debug-connected", 60515),
      strikethrough: h("strikethrough", 60516),
      openInProduct: h("open-in-product", 60517),
      indexZero: h("index-zero", 60518),
      agent: h("agent", 60519),
      editCode: h("edit-code", 60520),
      repoSelected: h("repo-selected", 60521),
      skip: h("skip", 60522),
      mergeInto: h("merge-into", 60523),
      gitBranchChanges: h("git-branch-changes", 60524),
      gitBranchStagedChanges: h("git-branch-staged-changes", 60525),
      gitBranchConflicts: h("git-branch-conflicts", 60526),
      gitBranch: h("git-branch", 60527),
      gitBranchCreate: h("git-branch-create", 60527),
      gitBranchDelete: h("git-branch-delete", 60527),
      searchLarge: h("search-large", 60528),
      terminalGitBash: h("terminal-git-bash", 60529),
    },
    Ml = {
  ...
  class Nl {
    ...
    setColorMap(t) {
      ((this._colorMap = t), this._onDidChange.fire({ changedLanguages: Array.from(this._tokenizationSupports.keys()), changedColorMap: !0 }));
    }
    getColorMap() {
  ...
  (function (e) {
    const t = new Map();
    (t.set(0, B.symbolMethod),
      t.set(1, B.symbolFunction),
      t.set(2, B.symbolConstructor),
      t.set(3, B.symbolField),
      t.set(4, B.symbolVariable),
      t.set(5, B.symbolClass),
      t.set(6, B.symbolStruct),
      t.set(7, B.symbolInterface),
      t.set(8, B.symbolModule),
      t.set(9, B.symbolProperty),
      t.set(10, B.symbolEvent),
      t.set(11, B.symbolOperator),
      t.set(12, B.symbolUnit),
      t.set(13, B.symbolValue),
      t.set(15, B.symbolEnum),
      t.set(14, B.symbolConstant),
      t.set(15, B.symbolEnum),
      t.set(16, B.symbolEnumMember),
      t.set(17, B.symbolKeyword),
      t.set(28, B.symbolSnippet),
      t.set(18, B.symbolText),
      t.set(19, B.symbolColor),
      t.set(20, B.symbolFile),
      t.set(21, B.symbolReference),
      t.set(22, B.symbolCustomColor),
      t.set(23, B.symbolFolder),
      t.set(24, B.symbolTypeParameter),
      t.set(25, B.account),
      t.set(26, B.issues),
      t.set(27, B.tools));
    function n(a) {
      let l = t.get(a);
      return (l || (console.info("No codicon found for CompletionItemKind " + a), (l = B.symbolProperty)), l);
    }
    e.toIcon = n;
    function i(a) {
      switch (a) {
        case 0:
          return q(728, "Method");
        case 1:
          return q(729, "Function");
        case 2:
          return q(730, "Constructor");
        case 3:
          return q(731, "Field");
        case 4:
          return q(732, "Variable");
        case 5:
          return q(733, "Class");
        case 6:
          return q(734, "Struct");
        case 7:
          return q(735, "Interface");
        case 8:
          return q(736, "Module");
        case 9:
          return q(737, "Property");
        case 10:
          return q(738, "Event");
        case 11:
          return q(739, "Operator");
        case 12:
          return q(740, "Unit");
        case 13:
          return q(741, "Value");
        case 14:
          return q(742, "Constant");
        case 15:
          return q(743, "Enum");
        case 16:
          return q(744, "Enum Member");
        case 17:
          return q(745, "Keyword");
        case 18:
          return q(746, "Text");
        case 19:
          return q(747, "Color");
        case 20:
          return q(748, "File");
        case 21:
          return q(749, "Reference");
        case 22:
          return q(750, "Custom Color");
        case 23:
          return q(751, "Folder");
        case 24:
          return q(752, "Type Parameter");
        case 25:
          return q(753, "User");
        case 26:
          return q(754, "Issue");
  ...
  ((function (e) {
    ...
    q(779, "string"),
    q(780, "struct"),
    q(781, "type parameter"),
    q(782, "variable"));
  var br;
  (function (e) {
    const t = new Map();
    (t.set(0, B.symbolFile),
      t.set(1, B.symbolModule),
      t.set(2, B.symbolNamespace),
      t.set(3, B.symbolPackage),
      t.set(4, B.symbolClass),
      t.set(5, B.symbolMethod),
      t.set(6, B.symbolProperty),
      t.set(7, B.symbolField),
      t.set(8, B.symbolConstructor),
      t.set(9, B.symbolEnum),
      t.set(10, B.symbolInterface),
      t.set(11, B.symbolFunction),
      t.set(12, B.symbolVariable),
      t.set(13, B.symbolConstant),
      t.set(14, B.symbolString),
      t.set(15, B.symbolNumber),
      t.set(16, B.symbolBoolean),
      t.set(17, B.symbolArray),
      t.set(18, B.symbolObject),
      t.set(19, B.symbolKey),
      t.set(20, B.symbolNull),
      t.set(21, B.symbolEnumMember),
      t.set(22, B.symbolStruct),
      t.set(23, B.symbolEvent),
      t.set(24, B.symbolOperator),
      t.set(25, B.symbolTypeParameter));
    function n(s) {
      let a = t.get(s);
  ...
  (function (e) {
    ((e[(e.acceptSuggestionOnCommitCharacter = 0)] = "acceptSuggestionOnCommitCharacter"),
      ...
      (e[(e.allowOverflow = 4)] = "allowOverflow"),
      (e[(e.allowVariableLineHeights = 5)] = "allowVariableLineHeights"),
      (e[(e.allowVariableFonts = 6)] = "allowVariableFonts"),
      (e[(e.allowVariableFontsInAccessibilityMode = 7)] = "allowVariableFontsInAccessibilityMode"),
      (e[(e.ariaLabel = 8)] = "ariaLabel"),
      (e[(e.ariaRequired = 9)] = "ariaRequired"),
      (e[(e.autoClosingBrackets = 10)] = "autoClosingBrackets"),
      (e[(e.autoClosingComments = 11)] = "autoClosingComments"),
      (e[(e.screenReaderAnnounceInlineSuggestion = 12)] = "screenReaderAnnounceInlineSuggestion"),
      (e[(e.autoClosingDelete = 13)] = "autoClosingDelete"),
      (e[(e.autoClosingOvertype = 14)] = "autoClosingOvertype"),
      (e[(e.autoClosingQuotes = 15)] = "autoClosingQuotes"),
      (e[(e.autoIndent = 16)] = "autoIndent"),
      (e[(e.autoIndentOnPaste = 17)] = "autoIndentOnPaste"),
      (e[(e.autoIndentOnPasteWithinString = 18)] = "autoIndentOnPasteWithinString"),
      (e[(e.automaticLayout = 19)] = "automaticLayout"),
      (e[(e.autoSurround = 20)] = "autoSurround"),
      (e[(e.bracketPairColorization = 21)] = "bracketPairColorization"),
      (e[(e.guides = 22)] = "guides"),
      (e[(e.codeLens = 23)] = "codeLens"),
      (e[(e.codeLensFontFamily = 24)] = "codeLensFontFamily"),
      (e[(e.codeLensFontSize = 25)] = "codeLensFontSize"),
      (e[(e.colorDecorators = 26)] = "colorDecorators"),
      (e[(e.colorDecoratorsLimit = 27)] = "colorDecoratorsLimit"),
      (e[(e.columnSelection = 28)] = "columnSelection"),
      (e[(e.comments = 29)] = "comments"),
      (e[(e.contextmenu = 30)] = "contextmenu"),
      (e[(e.copyWithSyntaxHighlighting = 31)] = "copyWithSyntaxHighlighting"),
      (e[(e.cursorBlinking = 32)] = "cursorBlinking"),
      (e[(e.cursorSmoothCaretAnimation = 33)] = "cursorSmoothCaretAnimation"),
      (e[(e.cursorStyle = 34)] = "cursorStyle"),
      (e[(e.cursorSurroundingLines = 35)] = "cursorSurroundingLines"),
      (e[(e.cursorSurroundingLinesStyle = 36)] = "cursorSurroundingLinesStyle"),
      (e[(e.cursorWidth = 37)] = "cursorWidth"),
      (e[(e.cursorHeight = 38)] = "cursorHeight"),
      (e[(e.disableLayerHinting = 39)] = "disableLayerHinting"),
      (e[(e.disableMonospaceOptimizations = 40)] = "disableMonospaceOptimizations"),
      (e[(e.domReadOnly = 41)] = "domReadOnly"),
      (e[(e.dragAndDrop = 42)] = "dragAndDrop"),
      (e[(e.dropIntoEditor = 43)] = "dropIntoEditor"),
      (e[(e.editContext = 44)] = "editContext"),
      (e[(e.emptySelectionClipboard = 45)] = "emptySelectionClipboard"),
      (e[(e.experimentalGpuAcceleration = 46)] = "experimentalGpuAcceleration"),
      (e[(e.experimentalWhitespaceRendering = 47)] = "experimentalWhitespaceRendering"),
      (e[(e.extraEditorClassName = 48)] = "extraEditorClassName"),
      (e[(e.fastScrollSensitivity = 49)] = "fastScrollSensitivity"),
      (e[(e.find = 50)] = "find"),
      (e[(e.fixedOverflowWidgets = 51)] = "fixedOverflowWidgets"),
      (e[(e.folding = 52)] = "folding"),
      (e[(e.foldingStrategy = 53)] = "foldingStrategy"),
      (e[(e.foldingHighlight = 54)] = "foldingHighlight"),
      (e[(e.foldingImportsByDefault = 55)] = "foldingImportsByDefault"),
      (e[(e.foldingMaximumRegions = 56)] = "foldingMaximumRegions"),
      (e[(e.unfoldOnClickAfterEndOfLine = 57)] = "unfoldOnClickAfterEndOfLine"),
      (e[(e.fontFamily = 58)] = "fontFamily"),
      (e[(e.fontInfo = 59)] = "fontInfo"),
      (e[(e.fontLigatures = 60)] = "fontLigatures"),
      (e[(e.fontSize = 61)] = "fontSize"),
      (e[(e.fontWeight = 62)] = "fontWeight"),
      (e[(e.fontVariations = 63)] = "fontVariations"),
      (e[(e.formatOnPaste = 64)] = "formatOnPaste"),
      (e[(e.formatOnType = 65)] = "formatOnType"),
      (e[(e.glyphMargin = 66)] = "glyphMargin"),
      (e[(e.gotoLocation = 67)] = "gotoLocation"),
      (e[(e.hideCursorInOverviewRuler = 68)] = "hideCursorInOverviewRuler"),
      (e[(e.hover = 69)] = "hover"),
      (e[(e.inDiffEditor = 70)] = "inDiffEditor"),
      (e[(e.inlineSuggest = 71)] = "inlineSuggest"),
      (e[(e.letterSpacing = 72)] = "letterSpacing"),
      (e[(e.lightbulb = 73)] = "lightbulb"),
      (e[(e.lineDecorationsWidth = 74)] = "lineDecorationsWidth"),
      (e[(e.lineHeight = 75)] = "lineHeight"),
      (e[(e.lineNumbers = 76)] = "lineNumbers"),
      (e[(e.lineNumbersMinChars = 77)] = "lineNumbersMinChars"),
      (e[(e.linkedEditing = 78)] = "linkedEditing"),
      (e[(e.links = 79)] = "links"),
      (e[(e.matchBrackets = 80)] = "matchBrackets"),
      (e[(e.minimap = 81)] = "minimap"),
      (e[(e.mouseStyle = 82)] = "mouseStyle"),
      (e[(e.mouseWheelScrollSensitivity = 83)] = "mouseWheelScrollSensitivity"),
      (e[(e.mouseWheelZoom = 84)] = "mouseWheelZoom"),
      (e[(e.multiCursorMergeOverlapping = 85)] = "multiCursorMergeOverlapping"),
      (e[(e.multiCursorModifier = 86)] = "multiCursorModifier"),
      (e[(e.mouseMiddleClickAction = 87)] = "mouseMiddleClickAction"),
      (e[(e.multiCursorPaste = 88)] = "multiCursorPaste"),
      (e[(e.multiCursorLimit = 89)] = "multiCursorLimit"),
      (e[(e.occurrencesHighlight = 90)] = "occurrencesHighlight"),
      (e[(e.occurrencesHighlightDelay = 91)] = "occurrencesHighlightDelay"),
      (e[(e.overtypeCursorStyle = 92)] = "overtypeCursorStyle"),
      (e[(e.overtypeOnPaste = 93)] = "overtypeOnPaste"),
      (e[(e.overviewRulerBorder = 94)] = "overviewRulerBorder"),
      (e[(e.overviewRulerLanes = 95)] = "overviewRulerLanes"),
      (e[(e.padding = 96)] = "padding"),
      (e[(e.pasteAs = 97)] = "pasteAs"),
      (e[(e.parameterHints = 98)] = "parameterHints"),
      (e[(e.peekWidgetDefaultFocus = 99)] = "peekWidgetDefaultFocus"),
      (e[(e.placeholder = 100)] = "placeholder"),
      (e[(e.definitionLinkOpensInPeek = 101)] = "definitionLinkOpensInPeek"),
      (e[(e.quickSuggestions = 102)] = "quickSuggestions"),
      (e[(e.quickSuggestionsDelay = 103)] = "quickSuggestionsDelay"),
      (e[(e.readOnly = 104)] = "readOnly"),
      (e[(e.readOnlyMessage = 105)] = "readOnlyMessage"),
      (e[(e.renameOnType = 106)] = "renameOnType"),
      (e[(e.renderRichScreenReaderContent = 107)] = "renderRichScreenReaderContent"),
      (e[(e.renderControlCharacters = 108)] = "renderControlCharacters"),
      (e[(e.renderFinalNewline = 109)] = "renderFinalNewline"),
      (e[(e.renderLineHighlight = 110)] = "renderLineHighlight"),
      (e[(e.renderLineHighlightOnlyWhenFocus = 111)] = "renderLineHighlightOnlyWhenFocus"),
      (e[(e.renderValidationDecorations = 112)] = "renderValidationDecorations"),
      (e[(e.renderWhitespace = 113)] = "renderWhitespace"),
      (e[(e.revealHorizontalRightPadding = 114)] = "revealHorizontalRightPadding"),
      (e[(e.roundedSelection = 115)] = "roundedSelection"),
      (e[(e.rulers = 116)] = "rulers"),
      (e[(e.scrollbar = 117)] = "scrollbar"),
      (e[(e.scrollBeyondLastColumn = 118)] = "scrollBeyondLastColumn"),
      (e[(e.scrollBeyondLastLine = 119)] = "scrollBeyondLastLine"),
      (e[(e.scrollPredominantAxis = 120)] = "scrollPredominantAxis"),
      (e[(e.selectionClipboard = 121)] = "selectionClipboard"),
      (e[(e.selectionHighlight = 122)] = "selectionHighlight"),
      (e[(e.selectionHighlightMaxLength = 123)] = "selectionHighlightMaxLength"),
      (e[(e.selectionHighlightMultiline = 124)] = "selectionHighlightMultiline"),
      (e[(e.selectOnLineNumbers = 125)] = "selectOnLineNumbers"),
      (e[(e.showFoldingControls = 126)] = "showFoldingControls"),
      (e[(e.showUnused = 127)] = "showUnused"),
      (e[(e.snippetSuggestions = 128)] = "snippetSuggestions"),
      (e[(e.smartSelect = 129)] = "smartSelect"),
      (e[(e.smoothScrolling = 130)] = "smoothScrolling"),
      (e[(e.stickyScroll = 131)] = "stickyScroll"),
      (e[(e.stickyTabStops = 132)] = "stickyTabStops"),
      (e[(e.stopRenderingLineAfter = 133)] = "stopRenderingLineAfter"),
      (e[(e.suggest = 134)] = "suggest"),
      (e[(e.suggestFontSize = 135)] = "suggestFontSize"),
      (e[(e.suggestLineHeight = 136)] = "suggestLineHeight"),
      (e[(e.suggestOnTriggerCharacters = 137)] = "suggestOnTriggerCharacters"),
      (e[(e.suggestSelection = 138)] = "suggestSelection"),
      (e[(e.tabCompletion = 139)] = "tabCompletion"),
      (e[(e.tabIndex = 140)] = "tabIndex"),
      (e[(e.trimWhitespaceOnDelete = 141)] = "trimWhitespaceOnDelete"),
      (e[(e.unicodeHighlighting = 142)] = "unicodeHighlighting"),
      (e[(e.unusualLineTerminators = 143)] = "unusualLineTerminators"),
      (e[(e.useShadowDOM = 144)] = "useShadowDOM"),
      (e[(e.useTabStops = 145)] = "useTabStops"),
      (e[(e.wordBreak = 146)] = "wordBreak"),
      (e[(e.wordSegmenterLocales = 147)] = "wordSegmenterLocales"),
      (e[(e.wordSeparators = 148)] = "wordSeparators"),
      (e[(e.wordWrap = 149)] = "wordWrap"),
      (e[(e.wordWrapBreakAfterCharacters = 150)] = "wordWrapBreakAfterCharacters"),
      (e[(e.wordWrapBreakBeforeCharacters = 151)] = "wordWrapBreakBeforeCharacters"),
      (e[(e.wordWrapColumn = 152)] = "wordWrapColumn"),
      (e[(e.wordWrapOverride1 = 153)] = "wordWrapOverride1"),
      (e[(e.wordWrapOverride2 = 154)] = "wordWrapOverride2"),
      (e[(e.wrappingIndent = 155)] = "wrappingIndent"),
      (e[(e.wrappingStrategy = 156)] = "wrappingStrategy"),
      (e[(e.showDeprecated = 157)] = "showDeprecated"),
      (e[(e.inertialScroll = 158)] = "inertialScroll"),
      (e[(e.inlayHints = 159)] = "inlayHints"),
      (e[(e.wrapOnEscapedLineFeeds = 160)] = "wrapOnEscapedLineFeeds"),
      (e[(e.effectiveCursorStyle = 161)] = "effectiveCursorStyle"),
      (e[(e.editorClassName = 162)] = "editorClassName"),
      (e[(e.pixelRatio = 163)] = "pixelRatio"),
      (e[(e.tabFocusMode = 164)] = "tabFocusMode"),
      (e[(e.layoutInfo = 165)] = "layoutInfo"),
      (e[(e.wrappingInfo = 166)] = "wrappingInfo"),
      (e[(e.defaultColorDecorators = 167)] = "defaultColorDecorators"),
      (e[(e.colorDecoratorsActivatedOn = 168)] = "colorDecoratorsActivatedOn"),
      (e[(e.inlineCompletionsAccessibilityVerbose = 169)] = "inlineCompletionsAccessibilityVerbose"),
      (e[(e.effectiveEditContext = 170)] = "effectiveEditContext"),
      (e[(e.scrollOnMiddleClick = 171)] = "scrollOnMiddleClick"),
      (e[(e.effectiveAllowVariableFonts = 172)] = "effectiveAllowVariableFonts"));
  })(Nr || (Nr = {}));
  var Ir;
  (function (e) {
  ...
  ((St.CtrlCmd = 2048), (St.Shift = 1024), (St.Alt = 512), (St.WinCtrl = 256));
  let ii = St;
  function Hl() {
    return {
      editor: void 0,
      languages: void 0,
      CancellationTokenSource: ll,
      Emitter: Re,
      KeyCode: Kn,
      KeyMod: ii,
      Position: K,
  ...
  class Ul {
    constructor() {
      ((this[ds] = "LinkedMap"), (this._map = new Map()), (this._head = void 0), (this._tail = void 0), (this._size = 0), (this._state = 0));
    }
    clear() {
    ...
    [((ds = Symbol.toStringTag), Symbol.iterator)]() {
      return this.entries();
    }
    trimOld(t) {
    ...
    touch(t, n) {
      ...
      if (!(n !== 1 && n !== 2)) {
        if (n === 1) {
          ...
          const i = t.next,
            r = t.previous;
          (t === this._tail ? ((r.next = void 0), (this._tail = r)) : ((i.previous = r), (r.next = i)),
            (t.previous = void 0),
            (t.next = this._head),
          ...
          const i = t.next,
            r = t.previous;
          (t === this._head ? ((i.previous = void 0), (this._head = i)) : ((i.previous = r), (r.next = i)),
            (t.next = void 0),
  ...
  function Vl(e, t, n, i, r) {
    return ql(e, t, n, i, r) && Ol(e, t, n, i, r);
  }
  class jl {
    constructor(t, n) {
    ...
    next(t) {
      ...
      let i;
      do {
        if (this._prevMatchStartIndex + this._prevMatchLength === n || ((i = this._searchRegex.exec(t)), !i)) return null;
        const r = i.index,
          s = i[0].length;
        if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            Vo(t, n, this._searchRegex.lastIndex) > 65535 ? (this._searchRegex.lastIndex += 2) : (this._searchRegex.lastIndex += 1);
            continue;
          }
          return null;
        }
        if (((this._prevMatchStartIndex = r), (this._prevMatchLength = s), !this._wordSeparators || Vl(this._wordSeparators, t, n, r, s))) return i;
      } while (i);
      return null;
    }
  }
  ...
  function Gl(e = "") {
    let t = "(-?\\d*\\.\\d\\w*)|([^";
    for (const n of $l) e.indexOf(n) >= 0 || (t += "\\" + n);
  ...
  const _s = new wo();
  _s.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
  function ri(e, t, n, i, r) {
    if (((t = ws(t)), r || (r = Gt.first(_s)), n.length > r.maxLen)) {
      let u = e - r.maxLen / 2;
      return (u < 0 ? (u = 0) : (i += u), (n = n.substring(u, e + r.maxLen / 2)), ri(e, t, n, i, r));
    }
    const s = Date.now(),
      a = e - 1 - i;
    let l = -1,
    ...
    for (let u = 1; !(Date.now() - s >= r.timeBudget); u++) {
      ...
      const d = Xl(t, n, a, l);
      if ((!d && o) || ((o = d), c <= 0)) break;
      l = c;
    }
    if (o) {
      const u = { word: o[0], startColumn: i + 1 + o.index, endColumn: i + 1 + o.index + o[0].length };
  ...
  class Jl {
    static computeUnicodeHighlights(t, n, i) {
      const r = i ? i.startLineNumber : 1,
        ...
        a = new vs(n),
        l = a.getCandidateCodePoints();
      let o;
      l === "allNonBasicAscii" ? (o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g")) : (o = new RegExp(`${Ql(Array.from(l))}`, "g"));
      const u = new jl(null, o),
        c = [];
      let d = !1,
        m,
        f = 0,
        w = 0,
        p = 0;
      e: for (let x = r, T = s; x <= T; x++) {
        const y = t.getLineContent(x),
          L = y.length;
        u.reset(0);
        do
          if (((m = u.next(y)), m)) {
            ...
            if (I > 0) {
              const _ = y.charCodeAt(I - 1);
              Fn(_) && I--;
            }
            if (H + 1 < L) {
              const _ = y.charCodeAt(H - 1);
              Fn(_) && H++;
            }
            const P = y.substring(I, H);
            let b = ri(I + 1, bs, y, 0);
            b && b.endColumn <= I + 1 && (b = null);
            const g = a.shouldHighlightNonBasicASCII(P, b ? b.word : null);
            if (g !== 0) {
              if ((g === 3 ? f++ : g === 2 ? w++ : g === 1 ? p++ : ho(), c.length >= 1e3)) {
                d = !0;
                break e;
              }
              c.push(new j(x, I + 1, x, H + 1));
            }
          }
        while (m);
      }
      return { ranges: c, hasMore: d, ambiguousCharacterCount: f, invisibleCharacterCount: w, nonBasicAsciiCharacterCount: p };
    }
      ...
      switch (i.shouldHighlightNonBasicASCII(t, null)) {
        ...
        case 3: {
          const s = t.codePointAt(0),
            a = i.ambiguousCharacters.getPrimaryConfusable(s),
            l = Et.getLocales().filter((o) => !Et.getInstance(new Set([...n.allowedLocales, o])).isAmbiguous(s));
  ...
  function Ql(e, t) {
    return `[${zo(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
  }
  class vs {
    constructor(t) {
      ((this.options = t),
        (this.allowedCodePoints = new Set(t.allowedCodePoints)),
        (this.ambiguousCharacters = Et.getInstance(new Set(t.allowedLocales))));
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return "allNonBasicAscii";
      const t = new Set();
      if (this.options.invisibleCharacters) for (const n of Rt.codePoints) ys(String.fromCodePoint(n)) || t.add(n);
      if (this.options.ambiguousCharacters) for (const n of this.ambiguousCharacters.getConfusableCodePoints()) t.add(n);
      ...
      if (n)
        for (const a of n) {
          const l = a.codePointAt(0),
            o = $o(a);
          ((r = r || o), !o && !this.ambiguousCharacters.isAmbiguous(l) && !Rt.isInvisibleCharacter(l) && (s = !0));
        }
      return !r && s
        ? 0
        : this.options.invisibleCharacters && !ys(t) && Rt.isInvisibleCharacter(i)
          ? 2
          : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i)
            ? 3
            : 0;
    }
  }
...
` ||
  ...
  function* Kl(e, t) {
    let n, i;
    for (const r of e) (i !== void 0 && t(i, r) ? n.push(r) : (n && (yield n), (n = [r])), (i = r));
    n && (yield n);
  }
  function eu(e, t) {
  ...
  const At = class At {
    ...
    filter(t) {
      return new At((n) => this.iterate((i) => (t(i) ? n(i) : !0)));
    }
    map(t) {
      return new At((n) => this.iterate((i) => n(t(i))));
    }
    findLast(t) {
      let n;
    ...
    findLastMaxBy(t) {
      let n,
        i = !0;
      return (this.iterate((r) => ((i || si.isGreaterThan(t(r, n))) && ((i = !1), (n = r)), !0)), n);
    }
  };
  At.empty = new At((t) => {});
  let Ts = At;
  class G {
    ...
    static addRange(t, n) {
      ...
      if (i === r) n.splice(i, 0, t);
        ...
        const s = Math.min(t.start, n[i].start),
          a = Math.max(t.endExclusive, n[r - 1].endExclusive);
        n.splice(i, r - i, new G(s, a));
      }
    }
    static tryCreate(t, n) {
      if (!(t > n)) return new G(t, n);
    }
    static ofLength(t) {
      return new G(0, t);
    }
    ...
    joinRightTouching(t) {
      ...
      return new G(this.start, t.endExclusive);
    }
  }
  function mt(e, t) {
    const n = ft(e, t);
  ...
  function ai(e, t, n = 0, i = e.length) {
    let r = n,
      s = i;
    for (; r < s; ) {
      const a = Math.floor((r + s) / 2);
  ...
  const _e = class _e {
    ...
    static fromRange(t) {
      return new _e(t.startLineNumber, t.endLineNumber);
    }
    static fromRangeInclusive(t) {
      return new _e(t.startLineNumber, t.endLineNumber + 1);
    }
    static joinMany(t) {
      if (t.length === 0) return [];
      let n = new Me(t[0].slice());
      for (let i = 1; i < t.length; i++) n = n.getUnion(new Me(t[i].slice()));
      return n.ranges;
    }
    static join(t) {
      ...
      for (let r = 1; r < t.length; r++) ((n = Math.min(n, t[r].startLineNumber)), (i = Math.max(i, t[r].endLineNumberExclusive)));
      return new _e(n, i);
    }
    static deserialize(t) {
      return new _e(t[0], t[1]);
    }
    constructor(t, n) {
    ...
    delta(t) {
      return new _e(this.startLineNumber + t, this.endLineNumberExclusive + t);
    }
    deltaLength(t) {
      return new _e(this.startLineNumber, this.endLineNumberExclusive + t);
    }
    get length() {
      return this.endLineNumberExclusive - this.startLineNumber;
    }
    join(t) {
      return new _e(Math.min(this.startLineNumber, t.startLineNumber), Math.max(this.endLineNumberExclusive, t.endLineNumberExclusive));
    }
    toString() {
      return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
    }
    ...
    addMargin(t, n) {
      return new _e(this.startLineNumber - t, this.endLineNumberExclusive + n);
    }
  };
  _e.compareByStart = Mt((t) => t.startLineNumber, Nt);
  let X = _e;
  class Me {
    constructor(t = []) {
    ...
    addRange(t) {
      if (t.length === 0) return;
      const n = ai(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber),
        i = ft(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
      ...
      for (; i < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
        ...
        s === null
          ...
          : s.endLineNumberExclusive >= a.startLineNumber
            ? (s = new X(s.startLineNumber, Math.max(s.endLineNumberExclusive, a.endLineNumberExclusive)))
            : (n.push(s), (s = a));
      }
      return (s !== null && n.push(s), new Me(n));
    }
    subtractFrom(t) {
      const n = ai(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber),
        i = ft(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
      if (n === i) return new Me([t]);
      const r = [];
      let s = t.startLineNumber;
      for (let a = n; a < i; a++) {
        const l = this._normalizedRanges[a];
        (l.startLineNumber > s && r.push(new X(s, l.startLineNumber)), (s = l.endLineNumberExclusive));
      }
      return (s < t.endLineNumberExclusive && r.push(new X(s, t.endLineNumberExclusive)), new Me(r));
    }
    toString() {
    ...
    getWithDelta(t) {
      return new Me(this._normalizedRanges.map((n) => n.delta(t)));
    }
  }
  const Ce = class Ce {
    ...
    static fromPosition(t) {
      return new Ce(t.lineNumber - 1, t.column - 1);
    }
    static ofRange(t) {
...
`
    ...
    add(t) {
      return t.lineCount === 0 ? new Ce(this.lineCount, this.columnCount + t.columnCount) : new Ce(this.lineCount + t.lineCount, t.columnCount);
    }
    createRange(t) {
      return this.lineCount === 0
        ? new j(t.lineNumber, t.column, t.lineNumber, t.column + this.columnCount)
        : new j(t.lineNumber, t.column, t.lineNumber + this.lineCount, this.columnCount + 1);
    }
    toRange() {
      return new j(1, 1, this.lineCount + 1, this.columnCount + 1);
    }
    toLineRange() {
      return X.ofLength(1, this.lineCount + 1);
    }
    addToPosition(t) {
  ...
  class su {
    getOffsetRange(t) {
      return new G(this.getOffset(t.getStartPosition()), this.getOffset(t.getEndPosition()));
    }
    getRange(t) {
      return j.fromPositions(this.getPosition(t.start), this.getPosition(t.endExclusive));
    }
...
` &&
          ...
          n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
    ...
    _validatePosition(t) {
      if (t.lineNumber < 1) return new K(1, 1);
      const n = this.textLength.lineCount + 1;
      if (t.lineNumber > n) {
        const r = this.getLineLength(n);
        return new K(n, r + 1);
      }
      if (t.column < 1) return new K(t.lineNumber, 1);
      const i = this.getLineLength(t.lineNumber);
      return t.column - 1 > i ? new K(t.lineNumber, i + 1) : t;
    }
    getPosition(t) {
      const n = ft(this.lineStartOffsetByLineIdx, (s) => s <= t),
        i = n + 1,
        r = t - this.lineStartOffsetByLineIdx[n] + 1;
      return new K(i, r);
    }
    get textLength() {
  ...
  class ou {
    ...
    get endPositionExclusive() {
      return this.length.addToPosition(new K(1, 1));
    }
    get lineRange() {
    ...
    getLineLength(t) {
      return this.getValueOfRange(new j(t, 1, t, Number.MAX_SAFE_INTEGER)).length;
    }
    getTransformer() {
      return (this._transformer || (this._transformer = new au(this.getValue())), this._transformer);
    }
    getLineAt(t) {
      return this.getValueOfRange(new j(t, 1, t, Number.MAX_SAFE_INTEGER));
    }
  }
  class lu extends ou {
    constructor(t, n) {
      (mo(n >= 1), super(), (this._getLineContent = t), (this._lineCount = n));
    }
    getValueOfRange(t) {
      if (t.startLineNumber === t.endLineNumber) return this._getLineContent(t.startLineNumber).substring(t.startColumn - 1, t.endColumn - 1);
...
` + this._getLineContent(i);
      return (
        (n +=
          `
` + this._getLineContent(t.endLineNumber).substring(0, t.endColumn - 1)),
        n
      );
    }
    getLineLength(t) {
    ...
    get length() {
      ...
      return new It(this._lineCount - 1, t.length);
    }
  }
  class on extends lu {
    constructor(t) {
  ...
  class Ge {
    static joinReplacements(t, n) {
      ...
      const i = t[0].range.getStartPosition(),
        r = t[t.length - 1].range.getEndPosition();
      let s = "";
      for (let a = 0; a < t.length; a++) {
        const l = t[a];
        if (((s += l.text), a < t.length - 1)) {
          const o = t[a + 1],
            u = j.fromPositions(l.range.getEndPosition(), o.range.getStartPosition()),
            c = n.getValueOfRange(u);
          s += c;
        }
      }
      return new Ge(j.fromPositions(i, r), s);
    }
    static fromStringReplacement(t, n) {
      return new Ge(n.getTransformer().getRange(t.replaceRange), t.newText);
    }
    static delete(t) {
      return new Ge(t, "");
    }
...
`,
        ...
        r = Fo(n, i),
        s = It.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()),
        a = i.substring(r),
        l = j.fromPositions(s, this.range.getEndPosition());
      return new Ge(l, a);
    }
...
`,
        ...
        r = Bo(n, i),
        s = It.ofText(n.substring(0, n.length - r)).addToPosition(this.range.getStartPosition()),
        a = i.substring(0, i.length - r),
        l = j.fromPositions(this.range.getStartPosition(), s);
      return new Ge(l, a);
    }
    toString() {
      const t = this.range.getStartPosition(),
  ...
  class ve {
    static inverse(t, n, i) {
      ...
      let s = 1,
        a = 1;
      for (const o of t) {
        const u = new ve(new X(s, o.original.startLineNumber), new X(a, o.modified.startLineNumber));
        (u.modified.isEmpty || r.push(u), (s = o.original.endLineNumberExclusive), (a = o.modified.endLineNumberExclusive));
      }
      const l = new ve(new X(s, n + 1), new X(a, i + 1));
    ...
    toRangeMapping() {
      ...
      if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
        ...
        return new ye(
          new j(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new j(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
        );
      } else
        return new ye(
          new j(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER),
          new j(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER),
        );
    }
    toRangeMapping2(t, n) {
      if (xs(this.original.endLineNumberExclusive, t) && xs(this.modified.endLineNumberExclusive, n))
        return new ye(
          new j(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new j(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
        );
      if (!this.original.isEmpty && !this.modified.isEmpty)
        return new ye(
          j.fromPositions(new K(this.original.startLineNumber, 1), gt(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)),
          j.fromPositions(new K(this.modified.startLineNumber, 1), gt(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)),
        );
      if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
        return new ye(
          j.fromPositions(
            gt(new K(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t),
            gt(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t),
          ),
          j.fromPositions(
            gt(new K(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
            gt(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n),
          ),
        );
      throw new ue();
    }
  ...
  class We extends ve {
    static fromRangeMappings(t) {
      const n = X.join(t.map((r) => X.fromRangeInclusive(r.originalRange))),
        i = X.join(t.map((r) => X.fromRangeInclusive(r.modifiedRange)));
      return new We(n, i, t);
    }
    constructor(t, n, i) {
  ...
  class ye {
    static fromEdit(t) {
      ...
      return t.replacements.map((r, s) => new ye(r.range, n[s]));
    }
    static assertSorted(t) {
      for (let n = 1; n < t.length; n++) {
        ...
        if (
          !(
            i.originalRange.getEndPosition().isBeforeOrEqual(r.originalRange.getStartPosition()) &&
            i.modifiedRange.getEndPosition().isBeforeOrEqual(r.modifiedRange.getStartPosition())
          )
        )
  ...
  function ks(e, t, n, i = !1) {
    ...
    for (const s of Kl(
      e.map((a) => uu(a, t, n)),
      (a, l) => a.original.intersectsOrTouches(l.original) || a.modified.intersectsOrTouches(l.modified),
    )) {
      const a = s[0],
        l = s[s.length - 1];
      r.push(
    ...
    return (
      $t(() =>
        !i &&
        r.length > 0 &&
        (r[0].modified.startLineNumber !== r[0].original.startLineNumber ||
          n.length.lineCount - r[r.length - 1].modified.endLineNumberExclusive !==
            t.length.lineCount - r[r.length - 1].original.endLineNumberExclusive)
          ? !1
          : Pi(
              r,
              (s, a) =>
                a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive &&
                s.original.endLineNumberExclusive < a.original.startLineNumber &&
  ...
  function uu(e, t, n) {
    ...
    (e.modifiedRange.endColumn === 1 &&
      ...
      e.originalRange.startLineNumber + i <= e.originalRange.endLineNumber &&
      e.modifiedRange.startLineNumber + i <= e.modifiedRange.endLineNumber &&
      (r = -1),
      e.modifiedRange.startColumn - 1 >= n.getLineLength(e.modifiedRange.startLineNumber) &&
        e.originalRange.startColumn - 1 >= t.getLineLength(e.originalRange.startLineNumber) &&
        e.originalRange.startLineNumber <= e.originalRange.endLineNumber + r &&
        e.modifiedRange.startLineNumber <= e.modifiedRange.endLineNumber + r &&
        (i = 1));
    const s = new X(e.originalRange.startLineNumber + i, e.originalRange.endLineNumber + 1 + r),
      a = new X(e.modifiedRange.startLineNumber + i, e.modifiedRange.endLineNumber + 1 + r);
    return new We(s, a, [e]);
  }
  const cu = 3;
  class hu {
    computeDiff(t, n, i) {
      ...
      for (const u of s.changes) {
        ...
        u.originalEndLineNumber === 0
          ? (c = new X(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1))
          : (c = new X(u.originalStartLineNumber, u.originalEndLineNumber + 1));
        let d;
        u.modifiedEndLineNumber === 0
          ? (d = new X(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1))
          : (d = new X(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1));
        let m = new We(
          c,
          d,
          (o = u.charChanges) == null
            ? void 0
            : o.map(
                (f) =>
                  new ye(
                    new j(f.originalStartLineNumber, f.originalStartColumn, f.originalEndLineNumber, f.originalEndColumn),
                    new j(f.modifiedStartLineNumber, f.modifiedStartColumn, f.modifiedEndLineNumber, f.modifiedEndColumn),
                  ),
              ),
        );
        (l &&
          (l.modified.endLineNumberExclusive === m.modified.startLineNumber || l.original.endLineNumberExclusive === m.original.startLineNumber) &&
          ((m = new We(
      ...
      return (
        $t(() =>
          Pi(
            a,
            (u, c) =>
              c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive &&
              u.original.endLineNumberExclusive < c.original.startLineNumber &&
              u.modified.endLineNumberExclusive < c.modified.startLineNumber,
          ),
        ),
        new sn(a, [], s.quitEarly)
      );
    }
  }
  function Ss(e, t, n, i) {
  ...
  let As = class {
    constructor(t) {
      const n = [],
        i = [];
      for (let r = 0, s = t.length; r < s; r++) ((n[r] = oi(t[r], 1)), (i[r] = li(t[r], 1)));
      ((this.lines = t), (this._startColumns = n), (this._endColumns = i));
    }
    getElements() {
      const t = [];
      for (let n = 0, i = this.lines.length; n < i; n++) t[n] = this.lines[n].substring(this._startColumns[n] - 1, this._endColumns[n] - 1);
      return t;
    }
    getStrictElement(t) {
      return this.lines[t];
    ...
    createCharSequence(t, n, i) {
      ...
      let l = 0;
      for (let o = n; o <= i; o++) {
        const u = this.lines[o],
          c = t ? this._startColumns[o] : 1,
          d = t ? this._endColumns[o] : u.length + 1;
        for (let m = c; m < d; m++) ((r[l] = u.charCodeAt(m - 1)), (s[l] = o + 1), (a[l] = m), l++);
        !t && o < i && ((r[l] = 10), (s[l] = o + 1), (a[l] = u.length + 1), l++);
      }
      return new du(r, s, a);
    }
  };
  class du {
    ...
    getEndLineNumber(t) {
      return t === -1
        ...
        : (this._assertIndex(t, this._lineNumbers), this._charCodes[t] === 10 ? this._lineNumbers[t] + 1 : this._lineNumbers[t]);
    }
    getStartColumn(t) {
  ...
  class bt {
    ...
    static createFromDiffChange(t, n, i) {
      const r = n.getStartLineNumber(t.originalStart),
        ...
        a = n.getEndLineNumber(t.originalStart + t.originalLength - 1),
        l = n.getEndColumn(t.originalStart + t.originalLength - 1),
        o = i.getStartLineNumber(t.modifiedStart),
  ...
  class zt {
    ...
    static createFromDiffResult(t, n, i, r, s, a, l) {
      ...
      if (
        (n.originalLength === 0
          ? ((o = i.getStartLineNumber(n.originalStart) - 1), (u = 0))
          : ((o = i.getStartLineNumber(n.originalStart)), (u = i.getEndLineNumber(n.originalStart + n.originalLength - 1))),
        n.modifiedLength === 0
          ? ((c = r.getStartLineNumber(n.modifiedStart) - 1), (d = 0))
          : ((c = r.getStartLineNumber(n.modifiedStart)), (d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1))),
        a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s())
      ) {
        const f = i.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1),
          w = r.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
        if (f.getElements().length > 0 && w.getElements().length > 0) {
          let p = Ss(f, w, s, !0).changes;
          (l && (p = mu(p)), (m = []));
          for (let x = 0, T = p.length; x < T; x++) m.push(bt.createFromDiffChange(p[x], f, w));
        }
      }
      return new zt(o, u, c, d, m);
    }
  }
  class fu {
    constructor(t, n, i) {
      ((this.shouldComputeCharChanges = i.shouldComputeCharChanges),
        ...
        (this.original = new As(t)),
        (this.modified = new As(n)),
        (this.continueLineDiff = Ls(i.maxComputationTime)),
        (this.continueCharDiff = Ls(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3))));
    }
    computeDiff() {
      ...
      const t = Ss(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
        n = t.changes,
        i = t.quitEarly;
      ...
      for (let l = -1, o = n.length; l < o; l++) {
        const u = l + 1 < o ? n[l + 1] : null,
          c = u ? u.originalStart : this.originalLines.length,
          d = u ? u.modifiedStart : this.modifiedLines.length;
        for (; s < c && a < d; ) {
          const m = this.originalLines[s],
            f = this.modifiedLines[a];
          if (m !== f) {
            {
              let w = oi(m, 1),
                p = oi(f, 1);
              for (; w > 1 && p > 1; ) {
                const x = m.charCodeAt(w - 2),
                  T = f.charCodeAt(p - 2);
                if (x !== T) break;
                (w--, p--);
              }
              (w > 1 || p > 1) && this._pushTrimWhitespaceCharChange(r, s + 1, 1, w, a + 1, 1, p);
            }
            {
              let w = li(m, 1),
                p = li(f, 1);
              ...
              (w < x || p < T) && this._pushTrimWhitespaceCharChange(r, s + 1, w, x, a + 1, p, T);
            }
          }
          (s++, a++);
        }
    ...
    _pushTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
      if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l)) return;
      let o;
      (this.shouldComputeCharChanges && (o = [new bt(n, i, n, r, s, a, s, l)]), t.push(new zt(n, n, s, s, o)));
    }
    _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
      ...
      return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0
        ...
        : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s
          ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new bt(n, i, n, r, s, a, s, l)), !0)
          : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s
            ? ((u.originalEndLineNumber = n),
              (u.modifiedEndLineNumber = s),
              this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new bt(n, i, n, r, s, a, s, l)),
              !0)
            : !1;
    }
  }
  ...
  class Fe {
    static trivial(t, n) {
      return new Fe([new ne(G.ofLength(t.length), G.ofLength(n.length))], !1);
    }
    static trivialTimedOut(t, n) {
      return new Fe([new ne(G.ofLength(t.length), G.ofLength(n.length))], !0);
    }
    constructor(t, n) {
  ...
  class ne {
    static invert(t, n) {
      ...
      return (
        eu(t, (r, s) => {
          i.push(
            ne.fromOffsetPairs(
              r ? r.getEndExclusives() : Be.zero,
              s ? s.getStarts() : new Be(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n),
            ),
          );
        }),
        i
    ...
    static fromOffsetPairs(t, n) {
      return new ne(new G(t.offset1, n.offset1), new G(t.offset2, n.offset2));
    }
    static assertSorted(t) {
      let n;
      for (const i of t) {
  ...
  class pu {
    constructor(t) {
      if (((this.timeout = t), (this.startTime = Date.now()), (this.valid = !0), t <= 0)) throw new ue("timeout must be positive");
    }
    isValid() {
...
`);
    ...
    computeSimilarity(t) {
      ...
      for (let r = 0; r < i; r++) n += Math.abs((this.histogram[r] ?? 0) - (t.histogram[r] ?? 0));
  ...
  let ln = Vt;
  class gu {
    compute(t, n, i = Ht.instance, r) {
      if (t.length === 0 || n.length === 0) return Fe.trivial(t, n);
      const s = new ui(t.length, n.length),
        a = new ui(t.length, n.length),
        l = new ui(t.length, n.length);
      for (let w = 0; w < t.length; w++)
        for (let p = 0; p < n.length; p++) {
          if (!i.isValid()) return Fe.trivialTimedOut(t, n);
          const x = w === 0 ? 0 : s.get(w - 1, p),
            T = p === 0 ? 0 : s.get(w, p - 1);
          let y;
          t.getElement(w) === n.getElement(p)
            ? (w === 0 || p === 0 ? (y = 0) : (y = s.get(w - 1, p - 1)),
              w > 0 && p > 0 && a.get(w - 1, p - 1) === 3 && (y += l.get(w - 1, p - 1)),
              (y += r ? r(w, p) : 1))
            : (y = -1);
          const L = Math.max(x, T, y);
          if (L === y) {
            const I = w > 0 && p > 0 ? l.get(w - 1, p - 1) : 0;
            (l.set(w, p, I + 1), a.set(w, p, 3));
          } else L === x ? (l.set(w, p, 0), a.set(w, p, 1)) : L === T && (l.set(w, p, 0), a.set(w, p, 2));
          s.set(w, p, L);
        }
      const o = [];
      let u = t.length,
        c = n.length;
      function d(w, p) {
        ((w + 1 !== u || p + 1 !== c) && o.push(new ne(new G(w + 1, u), new G(p + 1, c))), (u = w), (c = p));
      }
      let m = t.length - 1,
        f = n.length - 1;
      for (; m >= 0 && f >= 0; ) a.get(m, f) === 3 ? (d(m, f), m--, f--) : a.get(m, f) === 1 ? m-- : f--;
      return (d(-1, -1), o.reverse(), new Fe(o, !1));
    }
  }
  class Cs {
    compute(t, n, i = Ht.instance) {
      if (t.length === 0 || n.length === 0) return Fe.trivial(t, n);
      const r = t,
        s = n;
      function a(p, x) {
        for (; p < r.length && x < s.length && r.getElement(p) === s.getElement(x); ) (p++, x++);
        return p;
      }
      let l = 0;
      const o = new bu();
      o.set(0, a(0, 0));
      const u = new wu();
      u.set(0, o.get(0) === 0 ? null : new Es(null, 0, 0, o.get(0)));
      let c = 0;
      e: for (;;) {
        if ((l++, !i.isValid())) return Fe.trivialTimedOut(r, s);
        const p = -Math.min(l, s.length + (l % 2)),
          x = Math.min(l, r.length + (l % 2));
        for (c = p; c <= x; c += 2) {
          const T = c === x ? -1 : o.get(c + 1),
            y = c === p ? -1 : o.get(c - 1) + 1,
            L = Math.min(Math.max(T, y), r.length),
            I = L - c;
          if (L > r.length || I > s.length) continue;
          const H = a(L, I);
          o.set(c, H);
          const P = L === T ? u.get(c + 1) : u.get(c - 1);
          if ((u.set(c, H !== L ? new Es(P, L, I, H - L) : P), o.get(c) === r.length && o.get(c) - c === s.length)) break e;
        }
      }
      let d = u.get(c);
      const m = [];
      let f = r.length,
        w = s.length;
      for (;;) {
        const p = d ? d.x + d.length : 0,
          x = d ? d.y + d.length : 0;
        if (((p !== f || x !== w) && m.push(new ne(new G(p, f), new G(x, w))), !d)) break;
  ...
  class un {
    constructor(t, n, i) {
      ...
      for (let r = this.range.startLineNumber; r <= this.range.endLineNumber; r++) {
        let s = t[r - 1],
          a = 0;
        (r === this.range.startLineNumber && this.range.startColumn > 1 && ((a = this.range.startColumn - 1), (s = s.substring(a))),
    ...
    getBoundaryScore(t) {
      const n = Ms(t > 0 ? this.elements[t - 1] : -1),
        i = Ms(t < this.elements.length ? this.elements[t] : -1);
      if (n === 7 && i === 8) return 0;
      if (n === 8) return 150;
      let r = 0;
      return (n !== i && ((r += 10), n === 0 && i === 1 && (r += 1)), (r += Ds(n)), (r += Ds(i)), r);
    }
    translateOffset(t, n = "right") {
      const i = ft(this.firstElementOffsetByLineIdx, (s) => s <= t),
    ...
    findWordContaining(t) {
      if (t < 0 || t >= this.elements.length || !wt(this.elements[t])) return;
      let n = t;
      for (; n > 0 && wt(this.elements[n - 1]); ) n--;
      let i = t;
      for (; i < this.elements.length && wt(this.elements[i]); ) i++;
      return new G(n, i);
    }
    findSubWordContaining(t) {
      if (t < 0 || t >= this.elements.length || !wt(this.elements[t])) return;
      let n = t;
      for (; n > 0 && wt(this.elements[n - 1]) && !Rs(this.elements[n]); ) n--;
      let i = t;
      for (; i < this.elements.length && wt(this.elements[i]) && !Rs(this.elements[i]); ) i++;
      return new G(n, i);
    }
    countLinesIn(t) {
    ...
    extendToFullLines(t) {
      const n = mt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0,
        i = ru(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
      return new G(n, i);
    }
  }
  function wt(e) {
  ...
  const _u = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
  function Ds(e) {
    return _u[e];
  }
  function Ms(e) {
  ...
  function vu(e, t, n, i, r, s) {
    let { moves: a, excludedChanges: l } = Tu(e, t, n, s);
    if (!s.isValid()) return [];
    const o = e.filter((c) => !l.has(c)),
      u = xu(o, i, r, t, n, s);
    return (
      nu(a, u),
      (a = ku(a)),
...
`).length >= 15 && yu(d, (f) => f.length >= 2) >= 2
  ...
  function Tu(e, t, n, i) {
    const r = [],
      s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new ln(o.original, t, o)),
      a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new ln(o.modified, n, o))),
      l = new Set();
    for (const o of s) {
      let u = -1,
        c;
      ...
      if ((u > 0.9 && c && (a.delete(c), r.push(new ve(o.range, c.range)), l.add(o.source), l.add(c.source)), !i.isValid()))
  ...
  function xu(e, t, n, i, r, s) {
    ...
    for (const m of e)
      for (let f = m.original.startLineNumber; f < m.original.endLineNumberExclusive - 2; f++) {
        ...
        l.add(w, { range: new X(f, f + 3) });
      }
    const o = [];
    e.sort(Mt((m) => m.modified.startLineNumber, Nt));
    for (const m of e) {
      let f = [];
      for (let w = m.modified.startLineNumber; w < m.modified.endLineNumberExclusive - 2; w++) {
        const p = `${n[w - 1]}:${n[w + 1 - 1]}:${n[w + 2 - 1]}`,
          x = new X(w, w + 3),
          T = [];
        (l.forEach(p, ({ range: y }) => {
          for (const I of f)
            if (
              I.originalLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive &&
              I.modifiedLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive
            ) {
              ((I.originalLineRange = new X(I.originalLineRange.startLineNumber, y.endLineNumberExclusive)),
                (I.modifiedLineRange = new X(I.modifiedLineRange.startLineNumber, x.endLineNumberExclusive)),
                T.push(I));
              return;
            }
          const L = { modifiedLineRange: x, originalLineRange: y };
          (o.push(L), T.push(L));
        }),
          (f = T));
      }
    ...
    o.sort(iu(Mt((m) => m.modifiedLineRange.length, Nt)));
    const u = new Me(),
      c = new Me();
    for (const m of o) {
      const f = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber,
        w = u.subtractFrom(m.modifiedLineRange),
        p = c.subtractFrom(m.originalLineRange).getWithDelta(f),
        x = w.getIntersection(p);
      for (const T of x.ranges) {
        if (T.length < 3) continue;
        const y = T,
          L = T.delta(-f);
        (a.push(new ve(L, y)), u.addRange(y), c.addRange(L));
      }
    }
    a.sort(Mt((m) => m.original.startLineNumber, Nt));
    const d = new an(e);
    for (let m = 0; m < a.length; m++) {
      const f = a[m],
        w = d.findLastMonotonous((P) => P.original.startLineNumber <= f.original.startLineNumber),
        p = mt(e, (P) => P.modified.startLineNumber <= f.modified.startLineNumber),
        x = Math.max(f.original.startLineNumber - w.original.startLineNumber, f.modified.startLineNumber - p.modified.startLineNumber),
        T = d.findLastMonotonous((P) => P.original.startLineNumber < f.original.endLineNumberExclusive),
        y = mt(e, (P) => P.modified.startLineNumber < f.modified.endLineNumberExclusive),
        L = Math.max(
          T.original.endLineNumberExclusive - f.original.endLineNumberExclusive,
          y.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive,
        );
      let I;
      for (I = 0; I < x; I++) {
        const P = f.original.startLineNumber - I - 1,
          b = f.modified.startLineNumber - I - 1;
        if (P > i.length || b > r.length || u.contains(b) || c.contains(P) || !Ns(i[P - 1], r[b - 1], s)) break;
      }
      I > 0 &&
        (c.addRange(new X(f.original.startLineNumber - I, f.original.startLineNumber)),
        u.addRange(new X(f.modified.startLineNumber - I, f.modified.startLineNumber)));
      let H;
      for (H = 0; H < L; H++) {
        const P = f.original.endLineNumberExclusive + H,
          b = f.modified.endLineNumberExclusive + H;
        if (P > i.length || b > r.length || u.contains(b) || c.contains(P) || !Ns(i[P - 1], r[b - 1], s)) break;
      }
      (H > 0 &&
        (c.addRange(new X(f.original.endLineNumberExclusive, f.original.endLineNumberExclusive + H)),
        u.addRange(new X(f.modified.endLineNumberExclusive, f.modified.endLineNumberExclusive + H))),
        (I > 0 || H > 0) &&
          (a[m] = new ve(
            new X(f.original.startLineNumber - I, f.original.endLineNumberExclusive + H),
            new X(f.modified.startLineNumber - I, f.modified.endLineNumberExclusive + H),
          )));
    }
    return a;
  }
  function Ns(e, t, n) {
    ...
    const r = new Cs().compute(new un([e], new j(1, 1, 1, e.length), !1), new un([t], new j(1, 1, 1, t.length), !1), n);
    let s = 0;
    const a = ne.invert(r.diffs, e.length);
    for (const c of a)
    ...
    function l(c) {
      let d = 0;
      for (let m = 0; m < e.length; m++) ci(c.charCodeAt(m)) || d++;
      return d;
    }
  ...
  function ku(e) {
    ...
    e.sort(Mt((n) => n.original.startLineNumber, Nt));
    const t = [e[0]];
    for (let n = 1; n < e.length; n++) {
      const i = t[t.length - 1],
        r = e[n],
        s = r.original.startLineNumber - i.original.endLineNumberExclusive,
        a = r.modified.startLineNumber - i.modified.endLineNumberExclusive;
      if (s >= 0 && a >= 0 && s + a <= 2) {
  ...
  function Su(e, t) {
    ...
    return (
      (t = t.filter((i) => {
        const r = n.findLastMonotonous((l) => l.original.startLineNumber < i.original.endLineNumberExclusive) || new ve(new X(1, 1), new X(1, 1)),
          s = mt(e, (l) => l.modified.startLineNumber < i.modified.endLineNumberExclusive);
        return r !== s;
      })),
      t
    );
  ...
  function Is(e, t, n) {
    let i = n;
    return ((i = zs(e, t, i)), (i = zs(e, t, i)), (i = Au(e, t, i)), i);
  }
  function zs(e, t, n) {
    ...
    for (let s = 1; s < n.length; s++) {
      ...
      if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
        ...
        for (
          ...
          u <= o &&
          !(
            e.getElement(l.seq1Range.start - u) !== e.getElement(l.seq1Range.endExclusive - u) ||
            t.getElement(l.seq2Range.start - u) !== t.getElement(l.seq2Range.endExclusive - u)
          );
          u++
        );
        if ((u--, u === o)) {
          i[i.length - 1] = new ne(new G(a.seq1Range.start, l.seq1Range.endExclusive - o), new G(a.seq2Range.start, l.seq2Range.endExclusive - o));
          continue;
        }
        l = l.delta(-u);
      }
    ...
    for (let s = 0; s < i.length - 1; s++) {
      ...
      if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
        ...
        for (
          ...
          u < o &&
          !(
            !e.isStronglyEqual(l.seq1Range.start + u, l.seq1Range.endExclusive + u) ||
            !t.isStronglyEqual(l.seq2Range.start + u, l.seq2Range.endExclusive + u)
          );
          u++
        );
        if (u === o) {
          i[s + 1] = new ne(new G(l.seq1Range.start + o, a.seq1Range.endExclusive), new G(l.seq2Range.start + o, a.seq2Range.endExclusive));
          continue;
        }
        u > 0 && (l = l.delta(u));
      }
  ...
  function Au(e, t, n) {
    ...
    for (let i = 0; i < n.length; i++) {
      const r = i > 0 ? n[i - 1] : void 0,
        ...
        l = new G(r ? r.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : e.length),
        o = new G(r ? r.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : t.length);
      s.seq1Range.isEmpty ? (n[i] = Hs(s, e, t, l, o)) : s.seq2Range.isEmpty && (n[i] = Hs(s.swap(), t, e, o, l).swap());
    }
    return n;
  }
  function Hs(e, t, n, i, r) {
    ...
    for (
      ;
      e.seq1Range.start - a >= i.start &&
      e.seq2Range.start - a >= r.start &&
    ...
    for (let c = -a; c <= l; c++) {
      const d = e.seq2Range.start + c,
        ...
        w = t.getBoundaryScore(f) + n.getBoundaryScore(d) + n.getBoundaryScore(m);
      w > u && ((u = w), (o = c));
    }
    return e.delta(o);
  }
  function Lu(e, t, n) {
    ...
    for (const r of n) {
      ...
      r.seq1Range.start - s.seq1Range.endExclusive <= 2 || r.seq2Range.start - s.seq2Range.endExclusive <= 2
        ? (i[i.length - 1] = new ne(s.seq1Range.join(r.seq1Range), s.seq2Range.join(r.seq2Range)))
        : i.push(r);
    }
    return i;
  }
  function Us(e, t, n, i, r = !1) {
    const s = ne.invert(n, e.length),
      a = [];
    let l = new Be(0, 0);
    function o(c, d) {
      if (c.offset1 < l.offset1 || c.offset2 < l.offset2) return;
      const m = i(e, c.offset1),
        f = i(t, c.offset2);
      if (!m || !f) return;
      let w = new ne(m, f);
      const p = w.intersect(d);
      let x = p.seq1Range.length,
        T = p.seq2Range.length;
      for (; s.length > 0; ) {
        const y = s[0];
        if (!(y.seq1Range.intersects(w.seq1Range) || y.seq2Range.intersects(w.seq2Range))) break;
        const I = i(e, y.seq1Range.start),
          H = i(t, y.seq2Range.start),
          P = new ne(I, H),
          b = P.intersect(y);
        if (((x += b.seq1Range.length), (T += b.seq2Range.length), (w = w.join(P)), w.seq1Range.endExclusive >= y.seq1Range.endExclusive)) s.shift();
        else break;
      }
      (((r && x + T < w.seq1Range.length + w.seq2Range.length) || x + T < ((w.seq1Range.length + w.seq2Range.length) * 2) / 3) && a.push(w),
        (l = w.getEndExclusives()));
    }
    for (; s.length > 0; ) {
      const c = s.shift();
  ...
  function Cu(e, t) {
    ...
    for (; e.length > 0 || t.length > 0; ) {
      const i = e[0],
        r = t[0];
      let s;
      (i && (!r || i.seq1Range.start < r.seq1Range.start) ? (s = e.shift()) : (s = t.shift()),
        n.length > 0 && n[n.length - 1].seq1Range.endExclusive >= s.seq1Range.start ? (n[n.length - 1] = n[n.length - 1].join(s)) : n.push(s));
    }
    return n;
  }
  function Eu(e, t, n) {
    ...
    do {
      ...
      for (let l = 1; l < i.length; l++) {
        let c = function (m, f) {
          const w = new G(u.seq1Range.endExclusive, o.seq1Range.start);
          return (
            e.getText(w).replace(/\s/g, "").length <= 4 &&
            (m.seq1Range.length + m.seq2Range.length > 5 || f.seq1Range.length + f.seq2Range.length > 5)
          );
        };
        const o = i[l],
          u = a[a.length - 1];
  ...
  function Ru(e, t, n) {
    ...
    do {
      ...
      for (let o = 1; o < i.length; o++) {
        let d = function (f, w) {
          ...
          const T = e.getText(p).trim();
          if (T.length > 20 || T.split(/\r\n|\r|\n/).length > 1) return !1;
          const y = e.countLinesIn(f.seq1Range),
            L = f.seq1Range.length,
            I = t.countLinesIn(f.seq2Range),
            H = f.seq2Range.length,
            P = e.countLinesIn(w.seq1Range),
            b = w.seq1Range.length,
            g = t.countLinesIn(w.seq2Range),
            _ = w.seq2Range.length,
            N = 2 * 40 + 50;
          function S(v) {
            return Math.min(v, N);
          }
          return (
            Math.pow(Math.pow(S(y * 40 + L), 1.5) + Math.pow(S(I * 40 + H), 1.5), 1.5) +
              Math.pow(Math.pow(S(P * 40 + b), 1.5) + Math.pow(S(g * 40 + _), 1.5), 1.5) >
            (N ** 1.5) ** 1.5 * 1.3
          );
        };
        const u = i[o],
    ...
    return (
      tu(i, (l, o, u) => {
        ...
        const m = e.extendToFullLines(o.seq1Range),
          f = e.getText(new G(m.start, o.seq1Range.start));
        d(f) && (c = c.deltaStart(-f.length));
        const w = e.getText(new G(o.seq1Range.endExclusive, m.endExclusive));
        d(w) && (c = c.deltaEnd(w.length));
        const p = ne.fromOffsetPairs(l ? l.getEndExclusives() : Be.zero, u ? u.getStarts() : Be.max),
          x = c.intersect(p);
  ...
  class Ps {
    ...
    getBoundaryScore(t) {
      const n = t === 0 ? 0 : Ws(this.lines[t - 1]),
        i = t === this.lines.length ? 0 : Ws(this.lines[t]);
      return 1e3 - (n + i);
    }
    getText(t) {
...
`);
  ...
  class Du {
    constructor() {
      ((this.dynamicProgrammingDiffing = new gu()), (this.myersDiffingAlgorithm = new Cs()));
    }
    computeDiff(t, n, i) {
      if (t.length <= 1 && Zl(t, n, (b, g) => b === g)) return new sn([], [], !1);
      if ((t.length === 1 && t[0].length === 0) || (n.length === 1 && n[0].length === 0))
        return new sn(
          [
            new We(new X(1, t.length + 1), new X(1, n.length + 1), [
              new ye(new j(1, 1, t.length, t[t.length - 1].length + 1), new j(1, 1, n.length, n[n.length - 1].length + 1)),
            ]),
          ],
          [],
          !1,
        );
      const r = i.maxComputationTimeMs === 0 ? Ht.instance : new pu(i.maxComputationTimeMs),
        s = !i.ignoreTrimWhitespace,
        a = new Map();
      function l(b) {
        let g = a.get(b);
        return (g === void 0 && ((g = a.size), a.set(b, g)), g);
      }
      const o = t.map((b) => l(b.trim())),
        u = n.map((b) => l(b.trim())),
        c = new Ps(o, t),
        d = new Ps(u, n),
        m =
          c.length + d.length < 1700
            ? this.dynamicProgrammingDiffing.compute(c, d, r, (b, g) =>
                t[b] === n[g] ? (n[g].length === 0 ? 0.1 : 1 + Math.log(1 + n[g].length)) : 0.99,
              )
            : this.myersDiffingAlgorithm.compute(c, d, r);
      let f = m.diffs,
        w = m.hitTimeout;
      ((f = Is(c, d, f)), (f = Eu(c, d, f)));
      const p = [],
        x = (b) => {
          if (s)
            for (let g = 0; g < b; g++) {
              const _ = T + g,
                N = y + g;
              if (t[_] !== n[N]) {
                const S = this.refineDiff(t, n, new ne(new G(_, _ + 1), new G(N, N + 1)), r, s, i);
                for (const v of S.mappings) p.push(v);
                S.hitTimeout && (w = !0);
              }
            }
        };
      let T = 0,
        y = 0;
      for (const b of f) {
        $t(() => b.seq1Range.start - T === b.seq2Range.start - y);
        const g = b.seq1Range.start - T;
        (x(g), (T = b.seq1Range.endExclusive), (y = b.seq2Range.endExclusive));
        const _ = this.refineDiff(t, n, b, r, s, i);
        _.hitTimeout && (w = !0);
        for (const N of _.mappings) p.push(N);
      }
      x(t.length - T);
      const L = new on(t),
        I = new on(n),
      ...
      let P = [];
      return (
        i.computeMoves && (P = this.computeMoves(H, t, n, o, u, r, s, i)),
        $t(() => {
          function b(_, N) {
            if (_.lineNumber < 1 || _.lineNumber > N.length) return !1;
            const S = N[_.lineNumber - 1];
            return !(_.column < 1 || _.column > S.length + 1);
          }
          function g(_, N) {
            return !(
              _.startLineNumber < 1 ||
              _.startLineNumber > N.length + 1 ||
              _.endLineNumberExclusive < 1 ||
              _.endLineNumberExclusive > N.length + 1
            );
          }
          for (const _ of H) {
            if (!_.innerChanges) return !1;
            for (const N of _.innerChanges)
              if (
                !(
                  b(N.modifiedRange.getStartPosition(), n) &&
                  b(N.modifiedRange.getEndPosition(), n) &&
                  b(N.originalRange.getStartPosition(), t) &&
                  b(N.originalRange.getEndPosition(), t)
                )
              )
                return !1;
            if (!g(_.modified, n) || !g(_.original, t)) return !1;
          }
          return !0;
        }),
        new sn(H, P, w)
    ...
    computeMoves(t, n, i, r, s, a, l, o) {
      return vu(t, n, i, r, s, a).map((d) => {
        const m = this.refineDiff(n, i, new ne(d.original.toOffsetRange(), d.modified.toOffsetRange()), a, l, o),
          f = ks(m.mappings, new on(n), new on(i), !0);
        return new Yl(d, f);
      });
    }
    refineDiff(t, n, i, r, s, a) {
      const o = Mu(i).toRangeMapping2(t, n),
        u = new un(t, o.originalRange, s),
        c = new un(n, o.modifiedRange, s),
        d = u.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(u, c, r) : this.myersDiffingAlgorithm.compute(u, c, r);
      let m = d.diffs;
      return (
        (m = Is(u, c, m)),
        (m = Us(u, c, m, (w, p) => w.findWordContaining(p))),
        a.extendToSubwords && (m = Us(u, c, m, (w, p) => w.findSubWordContaining(p), !0)),
        (m = Lu(u, c, m)),
        (m = Ru(u, c, m)),
        { mappings: m.map((w) => new ye(u.translateRange(w.seq1Range), c.translateRange(w.seq2Range))), hitTimeout: d.hitTimeout }
      );
    }
  }
  function Mu(e) {
    return new ve(new X(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new X(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
  }
  const Fs = { getLegacy: () => new hu(), getDefault: () => new Du() };
  function Xe(e, t) {
  ...
  class C {
    constructor(t, n, i, r = 1) {
      ((this._rgbaBrand = void 0),
        ...
        (this.a = Xe(Math.max(Math.min(1, r), 0), 3)));
    }
    static equals(t, n) {
  ...
  class Te {
    constructor(t, n, i, r) {
      ((this._hslaBrand = void 0),
        ...
        (this.s = Xe(Math.max(Math.min(1, n), 0), 3)),
        (this.l = Xe(Math.max(Math.min(1, i), 0), 3)),
        (this.a = Xe(Math.max(Math.min(1, r), 0), 3)));
    }
    static equals(t, n) {
    ...
    static toRGBA(t) {
      ...
      if (i === 0) a = l = o = r;
        ...
        const u = r < 0.5 ? r * (1 + i) : r + i - r * i,
          c = 2 * r - u;
        ((a = Te._hue2rgb(c, u, n + 1 / 3)), (l = Te._hue2rgb(c, u, n)), (o = Te._hue2rgb(c, u, n - 1 / 3)));
      }
      return new C(Math.round(a * 255), Math.round(l * 255), Math.round(o * 255), s);
    }
  }
  class _t {
    constructor(t, n, i, r) {
      ((this._hsvaBrand = void 0),
        (this.h = Math.max(Math.min(360, t), 0) | 0),
        (this.s = Xe(Math.max(Math.min(1, n), 0), 3)),
        (this.v = Xe(Math.max(Math.min(1, i), 0), 3)),
        (this.a = Xe(Math.max(Math.min(1, r), 0), 3)));
    }
    static equals(t, n) {
    ...
    static fromRGBA(t) {
      ...
      let u;
      return (
        l === 0 ? (u = 0) : s === n ? (u = ((((i - r) / l) % 6) + 6) % 6) : s === i ? (u = (r - n) / l + 2) : (u = (n - i) / l + 4),
        new _t(Math.round(u * 60), o, s, t.a)
      );
    }
    static toRGBA(t) {
      const { h: n, s: i, v: r, a: s } = t,
        a = r * i,
        l = a * (1 - Math.abs(((n / 60) % 2) - 1)),
        o = r - a;
      let [u, c, d] = [0, 0, 0];
      return (
        n < 60
        ...
        (c = Math.round((c + o) * 255)),
        (d = Math.round((d + o) * 255)),
        new C(u, c, d, s)
      );
    }
  }
  let cn =
    ((Q = class {
      ...
      constructor(t) {
        if (t)
          if (t instanceof C) this.rgba = t;
          else if (t instanceof Te) ((this._hsla = t), (this.rgba = Te.toRGBA(t)));
          else if (t instanceof _t) ((this._hsva = t), (this.rgba = _t.toRGBA(t)));
          else throw new Error("Invalid color ctor argument");
        else throw new Error("Color needs a value");
      }
      equals(t) {
        return !!t && C.equals(this.rgba, t.rgba) && Te.equals(this.hsla, t.hsla) && _t.equals(this.hsva, t.hsva);
      }
      getRelativeLuminance() {
        const t = Q._relativeLuminanceForComponent(this.rgba.r),
          n = Q._relativeLuminanceForComponent(this.rgba.g),
          i = Q._relativeLuminanceForComponent(this.rgba.b),
      ...
      opposite() {
        return new Q(new C(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
      }
      mix(t, n = 0.5) {
        const i = Math.min(Math.max(n, 0), 1),
          r = this.rgba,
          s = t.rgba,
          a = r.r + (s.r - r.r) * i,
          l = r.g + (s.g - r.g) * i,
          o = r.b + (s.b - r.b) * i,
          u = r.a + (s.a - r.a) * i;
        return new Q(new C(a, l, o, u));
      }
      makeOpaque(t) {
        if (this.isOpaque() || t.rgba.a !== 1) return this;
        const { r: n, g: i, b: r, a: s } = this.rgba;
        return new Q(new C(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - i), t.rgba.b - s * (t.rgba.b - r), 1));
      }
      toString() {
    ...
    (Q.white = new Q(new C(255, 255, 255, 1))),
    (Q.black = new Q(new C(0, 0, 0, 1))),
    (Q.red = new Q(new C(255, 0, 0, 1))),
    (Q.blue = new Q(new C(0, 0, 255, 1))),
    (Q.green = new Q(new C(0, 255, 0, 1))),
    (Q.cyan = new Q(new C(0, 255, 255, 1))),
    (Q.lightgrey = new Q(new C(211, 211, 211, 1))),
    (Q.transparent = new Q(new C(0, 0, 0, 0))),
    Q);
  (function (e) {
    (function (t) {
      (function (n) {
        ...
        n.formatHex = o;
        function u(p, x = !1) {
          return x && p.rgba.a === 1 ? e.Format.CSS.formatHex(p) : `#${l(p.rgba.r)}${l(p.rgba.g)}${l(p.rgba.b)}${l(Math.round(p.rgba.a * 255))}`;
        }
        n.formatHexA = u;
        function c(p) {
        ...
        function d(p) {
          ...
          if (p.startsWith("rgba(")) {
            ...
            if (!b) throw new Error("Invalid color format " + p);
            const g = parseInt(((x = b.groups) == null ? void 0 : x.r) ?? "0"),
              _ = parseInt(((T = b.groups) == null ? void 0 : T.g) ?? "0"),
              N = parseInt(((y = b.groups) == null ? void 0 : y.b) ?? "0"),
              S = parseFloat(((L = b.groups) == null ? void 0 : L.a) ?? "0");
            return new e(new C(g, _, N, S));
          }
          if (p.startsWith("rgb(")) {
            const b = p.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
            if (!b) throw new Error("Invalid color format " + p);
            const g = parseInt(((I = b.groups) == null ? void 0 : I.r) ?? "0"),
              _ = parseInt(((H = b.groups) == null ? void 0 : H.g) ?? "0"),
              N = parseInt(((P = b.groups) == null ? void 0 : P.b) ?? "0");
            return new e(new C(g, _, N));
          }
          return m(p);
        }
        n.parse = d;
        function m(p) {
          switch (p) {
            case "aliceblue":
              return new e(new C(240, 248, 255, 1));
            case "antiquewhite":
              return new e(new C(250, 235, 215, 1));
            case "aqua":
              return new e(new C(0, 255, 255, 1));
            case "aquamarine":
              return new e(new C(127, 255, 212, 1));
            case "azure":
              return new e(new C(240, 255, 255, 1));
            case "beige":
              return new e(new C(245, 245, 220, 1));
            case "bisque":
              return new e(new C(255, 228, 196, 1));
            case "black":
              return new e(new C(0, 0, 0, 1));
            case "blanchedalmond":
              return new e(new C(255, 235, 205, 1));
            case "blue":
              return new e(new C(0, 0, 255, 1));
            case "blueviolet":
              return new e(new C(138, 43, 226, 1));
            case "brown":
              return new e(new C(165, 42, 42, 1));
            case "burlywood":
              return new e(new C(222, 184, 135, 1));
            case "cadetblue":
              return new e(new C(95, 158, 160, 1));
            case "chartreuse":
              return new e(new C(127, 255, 0, 1));
            case "chocolate":
              return new e(new C(210, 105, 30, 1));
            case "coral":
              return new e(new C(255, 127, 80, 1));
            case "cornflowerblue":
              return new e(new C(100, 149, 237, 1));
            case "cornsilk":
              return new e(new C(255, 248, 220, 1));
            case "crimson":
              return new e(new C(220, 20, 60, 1));
            case "cyan":
              return new e(new C(0, 255, 255, 1));
            case "darkblue":
              return new e(new C(0, 0, 139, 1));
            case "darkcyan":
              return new e(new C(0, 139, 139, 1));
            case "darkgoldenrod":
              return new e(new C(184, 134, 11, 1));
            case "darkgray":
              return new e(new C(169, 169, 169, 1));
            case "darkgreen":
              return new e(new C(0, 100, 0, 1));
            case "darkgrey":
              return new e(new C(169, 169, 169, 1));
            case "darkkhaki":
              return new e(new C(189, 183, 107, 1));
            case "darkmagenta":
              return new e(new C(139, 0, 139, 1));
            case "darkolivegreen":
              return new e(new C(85, 107, 47, 1));
            case "darkorange":
              return new e(new C(255, 140, 0, 1));
            case "darkorchid":
              return new e(new C(153, 50, 204, 1));
            case "darkred":
              return new e(new C(139, 0, 0, 1));
            case "darksalmon":
              return new e(new C(233, 150, 122, 1));
            case "darkseagreen":
              return new e(new C(143, 188, 143, 1));
            case "darkslateblue":
              return new e(new C(72, 61, 139, 1));
            case "darkslategray":
              return new e(new C(47, 79, 79, 1));
            case "darkslategrey":
              return new e(new C(47, 79, 79, 1));
            case "darkturquoise":
              return new e(new C(0, 206, 209, 1));
            case "darkviolet":
              return new e(new C(148, 0, 211, 1));
            case "deeppink":
              return new e(new C(255, 20, 147, 1));
            case "deepskyblue":
              return new e(new C(0, 191, 255, 1));
            case "dimgray":
              return new e(new C(105, 105, 105, 1));
            case "dimgrey":
              return new e(new C(105, 105, 105, 1));
            case "dodgerblue":
              return new e(new C(30, 144, 255, 1));
            case "firebrick":
              return new e(new C(178, 34, 34, 1));
            case "floralwhite":
              return new e(new C(255, 250, 240, 1));
            case "forestgreen":
              return new e(new C(34, 139, 34, 1));
            case "fuchsia":
              return new e(new C(255, 0, 255, 1));
            case "gainsboro":
              return new e(new C(220, 220, 220, 1));
            case "ghostwhite":
              return new e(new C(248, 248, 255, 1));
            case "gold":
              return new e(new C(255, 215, 0, 1));
            case "goldenrod":
              return new e(new C(218, 165, 32, 1));
            case "gray":
              return new e(new C(128, 128, 128, 1));
            case "green":
              return new e(new C(0, 128, 0, 1));
            case "greenyellow":
              return new e(new C(173, 255, 47, 1));
            case "grey":
              return new e(new C(128, 128, 128, 1));
            case "honeydew":
              return new e(new C(240, 255, 240, 1));
            case "hotpink":
              return new e(new C(255, 105, 180, 1));
            case "indianred":
              return new e(new C(205, 92, 92, 1));
            case "indigo":
              return new e(new C(75, 0, 130, 1));
            case "ivory":
              return new e(new C(255, 255, 240, 1));
            case "khaki":
              return new e(new C(240, 230, 140, 1));
            case "lavender":
              return new e(new C(230, 230, 250, 1));
            case "lavenderblush":
              return new e(new C(255, 240, 245, 1));
            case "lawngreen":
              return new e(new C(124, 252, 0, 1));
            case "lemonchiffon":
              return new e(new C(255, 250, 205, 1));
            case "lightblue":
              return new e(new C(173, 216, 230, 1));
            case "lightcoral":
              return new e(new C(240, 128, 128, 1));
            case "lightcyan":
              return new e(new C(224, 255, 255, 1));
            case "lightgoldenrodyellow":
              return new e(new C(250, 250, 210, 1));
            case "lightgray":
              return new e(new C(211, 211, 211, 1));
            case "lightgreen":
              return new e(new C(144, 238, 144, 1));
            case "lightgrey":
              return new e(new C(211, 211, 211, 1));
            case "lightpink":
              return new e(new C(255, 182, 193, 1));
            case "lightsalmon":
              return new e(new C(255, 160, 122, 1));
            case "lightseagreen":
              return new e(new C(32, 178, 170, 1));
            case "lightskyblue":
              return new e(new C(135, 206, 250, 1));
            case "lightslategray":
              return new e(new C(119, 136, 153, 1));
            case "lightslategrey":
              return new e(new C(119, 136, 153, 1));
            case "lightsteelblue":
              return new e(new C(176, 196, 222, 1));
            case "lightyellow":
              return new e(new C(255, 255, 224, 1));
            case "lime":
              return new e(new C(0, 255, 0, 1));
            case "limegreen":
              return new e(new C(50, 205, 50, 1));
            case "linen":
              return new e(new C(250, 240, 230, 1));
            case "magenta":
              return new e(new C(255, 0, 255, 1));
            case "maroon":
              return new e(new C(128, 0, 0, 1));
            case "mediumaquamarine":
              return new e(new C(102, 205, 170, 1));
            case "mediumblue":
              return new e(new C(0, 0, 205, 1));
            case "mediumorchid":
              return new e(new C(186, 85, 211, 1));
            case "mediumpurple":
              return new e(new C(147, 112, 219, 1));
            case "mediumseagreen":
              return new e(new C(60, 179, 113, 1));
            case "mediumslateblue":
              return new e(new C(123, 104, 238, 1));
            case "mediumspringgreen":
              return new e(new C(0, 250, 154, 1));
            case "mediumturquoise":
              return new e(new C(72, 209, 204, 1));
            case "mediumvioletred":
              return new e(new C(199, 21, 133, 1));
            case "midnightblue":
              return new e(new C(25, 25, 112, 1));
            case "mintcream":
              return new e(new C(245, 255, 250, 1));
            case "mistyrose":
              return new e(new C(255, 228, 225, 1));
            case "moccasin":
              return new e(new C(255, 228, 181, 1));
            case "navajowhite":
              return new e(new C(255, 222, 173, 1));
            case "navy":
              return new e(new C(0, 0, 128, 1));
            case "oldlace":
              return new e(new C(253, 245, 230, 1));
            case "olive":
              return new e(new C(128, 128, 0, 1));
            case "olivedrab":
              return new e(new C(107, 142, 35, 1));
            case "orange":
              return new e(new C(255, 165, 0, 1));
            case "orangered":
              return new e(new C(255, 69, 0, 1));
            case "orchid":
              return new e(new C(218, 112, 214, 1));
            case "palegoldenrod":
              return new e(new C(238, 232, 170, 1));
            case "palegreen":
              return new e(new C(152, 251, 152, 1));
            case "paleturquoise":
              return new e(new C(175, 238, 238, 1));
            case "palevioletred":
              return new e(new C(219, 112, 147, 1));
            case "papayawhip":
              return new e(new C(255, 239, 213, 1));
            case "peachpuff":
              return new e(new C(255, 218, 185, 1));
            case "peru":
              return new e(new C(205, 133, 63, 1));
            case "pink":
              return new e(new C(255, 192, 203, 1));
            case "plum":
              return new e(new C(221, 160, 221, 1));
            case "powderblue":
              return new e(new C(176, 224, 230, 1));
            case "purple":
              return new e(new C(128, 0, 128, 1));
            case "rebeccapurple":
              return new e(new C(102, 51, 153, 1));
            case "red":
              return new e(new C(255, 0, 0, 1));
            case "rosybrown":
              return new e(new C(188, 143, 143, 1));
            case "royalblue":
              return new e(new C(65, 105, 225, 1));
            case "saddlebrown":
              return new e(new C(139, 69, 19, 1));
            case "salmon":
              return new e(new C(250, 128, 114, 1));
            case "sandybrown":
              return new e(new C(244, 164, 96, 1));
            case "seagreen":
              return new e(new C(46, 139, 87, 1));
            case "seashell":
              return new e(new C(255, 245, 238, 1));
            case "sienna":
              return new e(new C(160, 82, 45, 1));
            case "silver":
              return new e(new C(192, 192, 192, 1));
            case "skyblue":
              return new e(new C(135, 206, 235, 1));
            case "slateblue":
              return new e(new C(106, 90, 205, 1));
            case "slategray":
              return new e(new C(112, 128, 144, 1));
            case "slategrey":
              return new e(new C(112, 128, 144, 1));
            case "snow":
              return new e(new C(255, 250, 250, 1));
            case "springgreen":
              return new e(new C(0, 255, 127, 1));
            case "steelblue":
              return new e(new C(70, 130, 180, 1));
            case "tan":
              return new e(new C(210, 180, 140, 1));
            case "teal":
              return new e(new C(0, 128, 128, 1));
            case "thistle":
              return new e(new C(216, 191, 216, 1));
            case "tomato":
              return new e(new C(255, 99, 71, 1));
            case "turquoise":
              return new e(new C(64, 224, 208, 1));
            case "violet":
              return new e(new C(238, 130, 238, 1));
            case "wheat":
              return new e(new C(245, 222, 179, 1));
            case "white":
              return new e(new C(255, 255, 255, 1));
            case "whitesmoke":
              return new e(new C(245, 245, 245, 1));
            case "yellow":
              return new e(new C(255, 255, 0, 1));
            case "yellowgreen":
              return new e(new C(154, 205, 50, 1));
            default:
              return null;
          }
        }
        function f(p) {
          const x = p.length;
          if (x === 0 || p.charCodeAt(0) !== 35) return null;
          if (x === 7) {
            const T = 16 * w(p.charCodeAt(1)) + w(p.charCodeAt(2)),
              y = 16 * w(p.charCodeAt(3)) + w(p.charCodeAt(4)),
              L = 16 * w(p.charCodeAt(5)) + w(p.charCodeAt(6));
            return new e(new C(T, y, L, 1));
          }
          if (x === 9) {
            const T = 16 * w(p.charCodeAt(1)) + w(p.charCodeAt(2)),
              y = 16 * w(p.charCodeAt(3)) + w(p.charCodeAt(4)),
              L = 16 * w(p.charCodeAt(5)) + w(p.charCodeAt(6)),
              I = 16 * w(p.charCodeAt(7)) + w(p.charCodeAt(8));
            return new e(new C(T, y, L, I / 255));
          }
          if (x === 4) {
            const T = w(p.charCodeAt(1)),
              y = w(p.charCodeAt(2)),
              L = w(p.charCodeAt(3));
            return new e(new C(16 * T + T, 16 * y + y, 16 * L + L));
          }
          if (x === 5) {
            const T = w(p.charCodeAt(1)),
              y = w(p.charCodeAt(2)),
              L = w(p.charCodeAt(3)),
              I = w(p.charCodeAt(4));
            return new e(new C(16 * T + T, 16 * y + y, 16 * L + L, (16 * I + I) / 255));
          }
          return null;
        }
        n.parseHex = f;
  ...
  function Ut(e, t) {
    ...
    return { startLineNumber: r.lineNumber, startColumn: r.column, endLineNumber: r.lineNumber, endColumn: r.column + i };
  }
  function Nu(e, t) {
    if (!e) return;
    const n = cn.Format.CSS.parseHex(t);
    if (n) return { range: e, color: hi(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) };
  }
  function qs(e, t, n) {
    if (!e || t.length !== 1) return;
    const r = t[0].values(),
      s = Bs(r);
    return { range: e, color: hi(s[0], s[1], s[2], n ? s[3] : 1) };
  }
  function Os(e, t, n) {
    if (!e || t.length !== 1) return;
    const r = t[0].values(),
      s = Bs(r),
      a = new cn(new Te(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
    return { range: e, color: hi(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) };
  }
  function Pt(e, t) {
  ...
  function Fu(e, t) {
    ...
    const r = Bl(t.markSectionHeaderRegex),
      s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
    if (Ho(s)) return n;
    for (let a = 1; a <= i; a += Vs - Uu) {
      const l = Math.min(a + Vs - 1, i),
        o = [];
      for (let d = a; d <= l; d++) o.push(e.getLineContent(d));
      const u = o.join(`
`);
      s.lastIndex = 0;
      let c;
      for (; (c = s.exec(u)) !== null; ) {
        const d = u.substring(0, c.index),
          m = (d.match(/\n/g) || []).length,
          f = a + m,
          w = c[0].split(`
`),
...
`) + 1,
          y = c.index - T + 1,
          L = w[w.length - 1],
          I = p === 1 ? y + c[0].length : L.length + 1,
          H = { startLineNumber: f, startColumn: y, endLineNumber: x, endColumn: I },
          P = (c.groups ?? {}).label ?? "",
          b = ((c.groups ?? {}).separator ?? "") !== "",
          g = { range: H, text: P, hasSeparatorLine: b, shouldBeInComments: !0 };
        ((g.text || g.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < g.range.startLineNumber) && n.push(g),
          (s.lastIndex = c.index + c[0].length));
      }
    }
    return n;
  }
  ...
  class Ou {
    ...
    produce(t) {
      ...
      } else this._unconsumedValues.push(t);
    }
    produceFinal(t) {
      (this._ensureNoFinalValue(), (this._finalValue = t));
      for (const n of this._unsatisfiedConsumers) this._resolveOrRejectDeferred(n, t);
  ...
  const pe = class pe {
    constructor(t, n) {
      ((this._onReturn = n),
        (this._producerConsumer = new Ou()),
        (this._iterator = {
          next: () => this._producerConsumer.consume(),
          return: () => {
            var i;
            return ((i = this._onReturn) == null || i.call(this), Promise.resolve({ done: !0, value: void 0 }));
          },
          throw: async (i) => (this._finishError(i), { done: !0, value: void 0 }),
        }),
        queueMicrotask(async () => {
          const i = t({
            emitOne: (r) => this._producerConsumer.produce({ ok: !0, value: { done: !1, value: r } }),
            emitMany: (r) => {
              for (const s of r) this._producerConsumer.produce({ ok: !0, value: { done: !1, value: s } });
            },
            reject: (r) => this._finishError(r),
          });
    ...
    static merge(t) {
      return new pe(async (n) => {
        await Promise.all(
          t.map(async (i) => {
            for await (const r of i) n.emitOne(r);
          }),
        );
      });
    }
    static map(t, n) {
      return new pe(async (i) => {
        for await (const r of t) i.emitOne(n(r));
      });
    }
    map(t) {
    ...
    static filter(t, n) {
      return new pe(async (i) => {
        for await (const r of t) n(r) && i.emitOne(r);
      });
    }
    filter(t) {
  ...
  class Vu {
    ...
    setValue(t, n) {
      return (
        (t = ct(t)),
        (n = ct(n)),
        this.values[t] === n ? !1 : ((this.values[t] = n), t - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = t - 1), !0)
      );
    }
    removeValues(t, n) {
      ((t = ct(t)), (n = ct(n)));
    ...
    _getPrefixSum(t) {
      ...
      for (let i = n; i <= t; i++) this.prefixSum[i] = this.prefixSum[i - 1] + this.values[i];
    ...
    getIndexOf(t) {
      ...
      let n = 0,
        ...
        a = 0;
      for (; n <= i; )
        if (((r = (n + (i - n) / 2) | 0), (s = this.prefixSum[r]), (a = s - this.values[r]), t < a)) i = r - 1;
        else if (t >= s) n = r + 1;
        else break;
      return new ju(r, t - a);
    }
  ...
  class $u {
    ...
    onEvents(t) {
      ...
      const n = t.changes;
      for (const i of n) (this._acceptDeleteRange(i.range), this._acceptInsertText(new K(i.range.startLineNumber, i.range.startColumn), i.text));
    ...
    _acceptDeleteRange(t) {
      if (t.startLineNumber === t.endLineNumber) {
        ...
        this._setLineText(
          t.startLineNumber - 1,
          this._lines[t.startLineNumber - 1].substring(0, t.startColumn - 1) + this._lines[t.startLineNumber - 1].substring(t.endColumn - 1),
        );
        return;
      }
      (this._setLineText(
        t.startLineNumber - 1,
        this._lines[t.startLineNumber - 1].substring(0, t.startColumn - 1) + this._lines[t.endLineNumber - 1].substring(t.endColumn - 1),
      ),
    ...
    _acceptInsertText(t, n) {
      ...
      if (i.length === 1) {
        this._setLineText(
          t.lineNumber - 1,
          this._lines[t.lineNumber - 1].substring(0, t.column - 1) + i[0] + this._lines[t.lineNumber - 1].substring(t.column - 1),
        );
        return;
      }
      ((i[i.length - 1] += this._lines[t.lineNumber - 1].substring(t.column - 1)),
        this._setLineText(t.lineNumber - 1, this._lines[t.lineNumber - 1].substring(0, t.column - 1) + i[0]));
      const r = new Uint32Array(i.length - 1);
      for (let s = 1; s < i.length; s++) (this._lines.splice(t.lineNumber + s - 1, 0, i[s]), (r[s - 1] = i[s].length + this._eol.length));
  ...
  class Gu {
    ...
    $acceptNewModel(t) {
      this._models[t.url] = new Xu(Qn.parse(t.url), t.lines, t.EOL, t.versionId);
    }
  ...
  class Xu extends $u {
    ...
    findMatches(t) {
      ...
      for (let i = 0; i < this._lines.length; i++) {
        const r = this._lines[i],
          s = this.offsetAt(new K(i + 1, 1)),
          a = r.matchAll(t);
        for (const l of a) ((l.index || l.index === 0) && (l.index = l.index + s), n.push(l));
      }
      return n;
    }
    getLinesContent() {
    ...
    getWordAtPosition(t, n) {
      const i = ri(t.column, ws(n), this._lines[t.lineNumber - 1], 0);
      return i ? new j(t.lineNumber, i.startColumn, t.lineNumber, i.endColumn) : null;
    }
    words(t) {
      const n = this._lines,
        ...
        *[Symbol.iterator]() {
          for (;;)
            if (a < l.length) {
              ...
              ((a += 1), yield o);
            } else if (r < n.length) ((s = n[r]), (l = i(s, t)), (a = 0), (r += 1));
            else break;
        },
      };
    }
    getLineWords(t, n) {
      const i = this._lines[t - 1],
        ...
        s = [];
      for (const a of r) s.push({ word: i.substring(a.start, a.end), startColumn: a.start + 1, endColumn: a.end + 1 });
      return s;
    }
    _wordenize(t, n) {
      const i = [];
      let r;
      for (n.lastIndex = 0; (r = n.exec(t)) && r[0].length !== 0; ) i.push({ start: r.index, end: r.index + r[0].length });
      return i;
    }
    getValueInRange(t) {
      ...
      for (let a = i + 1; a < r; a++) s.push(this._lines[a]);
    ...
    positionAt(t) {
      ...
      return { lineNumber: 1 + n.index, column: 1 + Math.min(n.remainder, i) };
    }
    _validateRange(t) {
      const n = this._validatePosition({ lineNumber: t.startLineNumber, column: t.startColumn }),
        i = this._validatePosition({ lineNumber: t.endLineNumber, column: t.endColumn });
      return n.lineNumber !== t.startLineNumber || n.column !== t.startColumn || i.lineNumber !== t.endLineNumber || i.column !== t.endColumn
        ? { startLineNumber: n.lineNumber, startColumn: n.column, endLineNumber: i.lineNumber, endColumn: i.column }
        : t;
    }
    _validatePosition(t) {
      if (!K.isIPosition(t)) throw new Error("bad position");
      let { lineNumber: n, column: i } = t,
        r = !1;
      if (n < 1) ((n = 1), (i = 1), (r = !0));
      else if (n > this._lines.length) ((n = this._lines.length), (i = this._lines[n - 1].length + 1), (r = !0));
      else {
  ...
  const rt = class rt {
    constructor(t = null) {
      ((this._foreignModule = t), (this._requestHandlerBrand = void 0), (this._workerTextModelSyncServer = new Gu()));
    }
    dispose() {}
    async $ping() {
      return "pong";
    ...
    async $computeUnicodeHighlights(t, n, i) {
      ...
      return r
        ? Jl.computeUnicodeHighlights(r, n, i)
        : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
    }
    ...
    async $computeDiff(t, n, i, r) {
      const s = this._getModel(t),
        a = this._getModel(n);
      return !s || !a ? null : rt.computeDiff(s, a, i, r);
    }
    static computeDiff(t, n, i, r) {
      const s = r === "advanced" ? Fs.getDefault() : Fs.getLegacy(),
        a = t.getLinesContent(),
        l = n.getLinesContent(),
        o = s.computeDiff(a, l, i),
        u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
      function c(d) {
        return d.map((m) => {
          var f;
          return [
            ...
            (f = m.innerChanges) == null
              ? void 0
              : f.map((w) => [
                  w.originalRange.startLineNumber,
                  w.originalRange.startColumn,
                  w.originalRange.endLineNumber,
                  w.originalRange.endColumn,
                  w.modifiedRange.startLineNumber,
                  w.modifiedRange.startColumn,
                  w.modifiedRange.endLineNumber,
    ...
    async $computeMoreMinimalEdits(t, n, i) {
      ...
      n = n.slice(0).sort((o, u) => {
        if (o.range && u.range) return j.compareRangesUsingStarts(o.range, u.range);
        const c = o.range ? 0 : 1,
          d = u.range ? 0 : 1;
        return c - d;
      });
      ...
      for (let o = 1; o < n.length; o++)
        j.getEndPosition(n[l].range).equals(j.getStartPosition(n[o].range))
          ? ((n[l].range = j.fromPositions(j.getStartPosition(n[l].range), j.getEndPosition(n[o].range))), (n[l].text += n[o].text))
          : (l++, (n[l] = n[o]));
      n.length = l + 1;
      for (let { range: o, text: u, eol: c } of n) {
        if ((typeof c == "number" && (a = c), j.isEmpty(o) && !u)) continue;
        const d = r.getValueInRange(o);
        if (((u = u.replace(/\r\n|\n|\r/g, r.eol)), d === u)) continue;
        if (Math.max(u.length, d.length) > rt._diffLimit) {
          s.push({ range: o, text: u });
          continue;
        }
        const m = nl(d, u, i),
          f = r.offsetAt(j.lift(o).getStartPosition());
        for (const w of m) {
          const p = r.positionAt(f + w.originalStart),
            x = r.positionAt(f + w.originalStart + w.originalLength),
            T = {
    ...
    async $textualSuggest(t, n, i, r) {
      ...
      e: for (const o of t) {
        ...
        if (u) {
          for (const c of u.words(a)) if (!(c === n || !isNaN(Number(c))) && (l.add(c), l.size > rt._suggestionsLimit)) break e;
        }
      }
    ...
    async $computeWordRanges(t, n, i, r) {
      ...
      for (let o = n.startLineNumber; o < n.endLineNumber; o++) {
        ...
        for (const c of u) {
          ...
          let d = l[c.word];
          (d || ((d = []), (l[c.word] = d)), d.push({ startLineNumber: o, startColumn: c.startColumn, endLineNumber: o, endColumn: c.endColumn }));
        }
      }
      return l;
    }
    async $navigateValueSet(t, n, i, r, s) {
      ...
      n.startColumn === n.endColumn &&
        (n = { startLineNumber: n.startLineNumber, startColumn: n.startColumn, endLineNumber: n.endLineNumber, endColumn: n.endColumn + 1 });
      const o = a.getValueInRange(n),
        u = a.getWordAtPosition({ lineNumber: n.startLineNumber, column: n.startColumn }, l);
      if (!u) return null;
      const c = a.getValueInRange(u);
      return Vn.INSTANCE.navigateValueSet(n, o, u, c, i);
    }
    $fmr(t, n) {
  ...
  let di = rt;
  typeof importScripts == "function" && (globalThis.monaco = Hl());
  const jt = class jt {
    static getChannel(t) {
      return t.getChannel(jt.CHANNEL_NAME);
    }
    static setChannel(t, n) {
      t.setChannel(jt.CHANNEL_NAME, n);
    }
  };
  jt.CHANNEL_NAME = "editorWorkerHost";
  let mi = jt;
  function Ju(e) {
    let t;
    const n = el((i) => {
      const r = mi.getChannel(i),
        a = {
          host: new Proxy(
            {},
            {
  ...
  function Ae(...e) {
    const t = e[0];
    let n, i, r;
    if (typeof t == "string") ((n = t), (i = t), e.splice(0, 1), (r = !e || typeof e[0] != "object" ? e : e[0]));
      ...
      ((i = t.message),
        (n = i),
        t.comment && t.comment.length > 0 && (n += `/${Array.isArray(t.comment) ? t.comment.join("") : t.comment}`),
        (r = t.args ?? {}));
    return Zu(i, r);
  }
  var Yu = /{([^}]+)}/g;
  function Zu(e, t) {
    return Object.keys(t).length === 0 ? e : e.replace(Yu, (n, i) => t[i] ?? n);
  }
  var Gs;
  (function (e) {
    function t(n) {
  ...
  (function (e) {
    function t(i, r) {
      return (i === Number.MAX_VALUE && (i = hn.MAX_VALUE), r === Number.MAX_VALUE && (r = hn.MAX_VALUE), { line: i, character: r });
    }
    e.create = t;
    function n(i) {
      let r = i;
  ...
  (function (e) {
    function t(i, r, s, a) {
      if (R.uinteger(i) && R.uinteger(r) && R.uinteger(s) && R.uinteger(a)) return { start: se.create(i, r), end: se.create(s, a) };
      if (se.is(i) && se.is(r)) return { start: i, end: r };
      throw new Error(`Range#create called with invalid arguments[${i}, ${r}, ${s}, ${a}]`);
    }
    e.create = t;
    function n(i) {
      let r = i;
      return R.objectLiteral(r) && se.is(r.start) && se.is(r.end);
    }
    e.is = n;
  })(J || (J = {}));
  var dn;
  (function (e) {
    ...
    function n(i) {
      let r = i;
      return R.objectLiteral(r) && J.is(r.range) && (R.string(r.uri) || R.undefined(r.uri));
    }
    e.is = n;
  })(dn || (dn = {}));
  var Js;
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        R.objectLiteral(r) &&
        J.is(r.targetRange) &&
        R.string(r.targetUri) &&
        J.is(r.targetSelectionRange) &&
        (J.is(r.originSelectionRange) || R.undefined(r.originSelectionRange))
      );
    }
    e.is = n;
  })(Js || (Js = {}));
  ...
  (function (e) {
    function t(i, r, s, a) {
      return { red: i, green: r, blue: s, alpha: a };
    }
    e.create = t;
    function n(i) {
      const r = i;
      return (
        R.objectLiteral(r) &&
        R.numberRange(r.red, 0, 1) &&
        R.numberRange(r.green, 0, 1) &&
        R.numberRange(r.blue, 0, 1) &&
        R.numberRange(r.alpha, 0, 1)
      );
    }
    e.is = n;
  })(pi || (pi = {}));
  ...
  (function (e) {
    ...
    function n(i) {
      const r = i;
      return R.objectLiteral(r) && J.is(r.range) && pi.is(r.color);
    }
    e.is = n;
  })(Qs || (Qs = {}));
  var Ys;
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        R.objectLiteral(r) &&
        R.string(r.label) &&
        (R.undefined(r.textEdit) || le.is(r)) &&
        (R.undefined(r.additionalTextEdits) || R.typedArray(r.additionalTextEdits, le.is))
      );
    }
    e.is = n;
  })(Ys || (Ys = {}));
  ...
  (function (e) {
    function t(i, r, s, a, l, o) {
      ...
      return (
        R.defined(s) && (u.startCharacter = s),
        R.defined(a) && (u.endCharacter = a),
        R.defined(l) && (u.kind = l),
        R.defined(o) && (u.collapsedText = o),
        u
      );
    }
    e.create = t;
    function n(i) {
      ...
      return (
        R.objectLiteral(r) &&
        R.uinteger(r.startLine) &&
        R.uinteger(r.startLine) &&
        (R.undefined(r.startCharacter) || R.uinteger(r.startCharacter)) &&
        (R.undefined(r.endCharacter) || R.uinteger(r.endCharacter)) &&
        (R.undefined(r.kind) || R.string(r.kind))
      );
    }
    e.is = n;
  })(Zs || (Zs = {}));
  ...
  (function (e) {
    ...
    function n(i) {
      let r = i;
      return R.defined(r) && dn.is(r.location) && R.string(r.message);
    }
    e.is = n;
  })(gi || (gi = {}));
  var Ks;
  ...
  (function (e) {
    function t(i, r, s, a, l, o) {
      ...
      return (
        R.defined(s) && (u.severity = s),
        R.defined(a) && (u.code = a),
        R.defined(l) && (u.source = l),
        R.defined(o) && (u.relatedInformation = o),
        u
      );
    }
    e.create = t;
    function n(i) {
      ...
      return (
        ...
        (R.undefined(s.codeDescription) || R.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) &&
        (R.string(s.source) || R.undefined(s.source)) &&
        (R.undefined(s.relatedInformation) || R.typedArray(s.relatedInformation, gi.is))
      );
    }
    e.is = n;
  })(fn || (fn = {}));
  ...
  (function (e) {
    ...
    function r(s) {
      const a = s;
      return R.objectLiteral(a) && R.string(a.newText) && J.is(a.range);
    }
    e.is = r;
  })(le || (le = {}));
  var bi;
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        R.objectLiteral(r) &&
        R.string(r.label) &&
        (R.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) &&
  ...
  (function (e) {
    ...
    function r(s) {
      const a = s;
      return le.is(a) && (bi.is(a.annotationId) || yt.is(a.annotationId));
    }
    e.is = r;
  })(na || (na = {}));
  var wi;
  (function (e) {
    ...
    function n(i) {
      let r = i;
      return R.defined(r) && xi.is(r.textDocument) && Array.isArray(r.edits);
    }
    e.is = n;
  })(wi || (wi = {}));
  var _i;
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        ...
        R.string(r.uri) &&
        (r.options === void 0 ||
          ((r.options.overwrite === void 0 || R.boolean(r.options.overwrite)) &&
            (r.options.ignoreIfExists === void 0 || R.boolean(r.options.ignoreIfExists)))) &&
        (r.annotationId === void 0 || yt.is(r.annotationId))
      );
    }
    e.is = n;
  })(_i || (_i = {}));
  ...
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        ...
        R.string(r.uri) &&
        (r.options === void 0 ||
          ((r.options.recursive === void 0 || R.boolean(r.options.recursive)) &&
            (r.options.ignoreIfNotExists === void 0 || R.boolean(r.options.ignoreIfNotExists)))) &&
        (r.annotationId === void 0 || yt.is(r.annotationId))
      );
    }
    e.is = n;
  ...
  (function (e) {
    function t(n) {
      ...
      return (
        ...
        (i.documentChanges === void 0 || i.documentChanges.every((r) => (R.string(r.kind) ? _i.is(r) || vi.is(r) || yi.is(r) : wi.is(r))))
      );
    }
    e.is = t;
  })(Ti || (Ti = {}));
  ...
  (function (e) {
    function t(n) {
      const i = n;
      return R.objectLiteral(n) && qe.is(i.kind) && R.string(i.value);
    }
    e.is = t;
  })(Wt || (Wt = {}));
  var fe;
  ...
  (function (e) {
    ...
    function n(i) {
      const r = i;
      return r && R.string(r.newText) && J.is(r.insert) && J.is(r.replace);
    }
    e.is = n;
  })(oa || (oa = {}));
  var la;
  ...
  (function (e) {
    function t(n) {
      ...
      return (
        !!i &&
        R.objectLiteral(i) &&
        (Wt.is(i.contents) || pn.is(i.contents) || R.typedArray(i.contents, pn.is)) &&
        (n.range === void 0 || J.is(n.range))
      );
    }
    e.is = t;
  })(da || (da = {}));
  ...
  (function (e) {
    function t(n, i, ...r) {
      let s = { label: n };
      return (R.defined(i) && (s.documentation = i), R.defined(r) ? (s.parameters = r) : (s.parameters = []), s);
    }
    e.create = t;
  })(fa || (fa = {}));
  var gn;
  ...
  (function (e) {
    function t(i, r, s, a, l, o) {
      let u = { name: i, detail: r, kind: s, range: a, selectionRange: l };
    ...
    function n(i) {
      ...
      return (
        ...
        R.number(r.kind) &&
        J.is(r.range) &&
        J.is(r.selectionRange) &&
        (r.detail === void 0 || R.string(r.detail)) &&
        (r.deprecated === void 0 || R.boolean(r.deprecated)) &&
  ...
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        R.defined(r) &&
        R.typedArray(r.diagnostics, fn.is) &&
        (r.only === void 0 || R.typedArray(r.only, R.string)) &&
        (r.triggerKind === void 0 || r.triggerKind === bn.Invoked || r.triggerKind === bn.Automatic)
      );
    }
    e.is = n;
  })(_a || (_a = {}));
  ...
  (function (e) {
    function t(i, r, s) {
      let a = { title: i },
        l = !0;
      return (typeof r == "string" ? ((l = !1), (a.kind = r)) : vt.is(r) ? (a.command = r) : (a.edit = r), l && s !== void 0 && (a.kind = s), a);
    }
    e.create = t;
    function n(i) {
      let r = i;
      return (
        r &&
        R.string(r.title) &&
        (r.diagnostics === void 0 || R.typedArray(r.diagnostics, fn.is)) &&
        (r.kind === void 0 || R.string(r.kind)) &&
        (r.edit !== void 0 || r.command !== void 0) &&
        (r.command === void 0 || vt.is(r.command)) &&
        (r.isPreferred === void 0 || R.boolean(r.isPreferred)) &&
        (r.edit === void 0 || Ti.is(r.edit))
      );
    }
    e.is = n;
  })(va || (va = {}));
  ...
  (function (e) {
    function t(i, r) {
      let s = { range: i };
      return (R.defined(r) && (s.data = r), s);
    }
    e.create = t;
    function n(i) {
      let r = i;
      return R.defined(r) && J.is(r.range) && (R.undefined(r.command) || vt.is(r.command));
    }
    e.is = n;
  })(ya || (ya = {}));
  var Ta;
  ...
  (function (e) {
    ...
    function n(i) {
      let r = i;
      return R.defined(r) && J.is(r.range) && (R.undefined(r.target) || R.string(r.target));
    }
    e.is = n;
  })(xa || (xa = {}));
  var wn;
  (function (e) {
    ...
    function n(i) {
      let r = i;
      return R.objectLiteral(r) && J.is(r.range) && (r.parent === void 0 || e.is(r.parent));
    }
    e.is = n;
  })(wn || (wn = {}));
  var ka;
  ...
  (function (e) {
    ...
    function n(i) {
      const r = i;
      return r != null && J.is(r.range) && R.string(r.text);
    }
    e.is = n;
  })(La || (La = {}));
  var Ca;
  (function (e) {
    ...
    function n(i) {
      const r = i;
      return r != null && J.is(r.range) && R.boolean(r.caseSensitiveLookup) && (R.string(r.variableName) || r.variableName === void 0);
    }
    e.is = n;
  })(Ca || (Ca = {}));
  var Ea;
  (function (e) {
    ...
    function n(i) {
      const r = i;
      return r != null && J.is(r.range) && (R.string(r.expression) || r.expression === void 0);
    }
    e.is = n;
  })(Ea || (Ea = {}));
  var Ra;
  (function (e) {
    ...
    function n(i) {
      const r = i;
      return R.defined(r) && J.is(i.stoppedLocation);
    }
    e.is = n;
  })(Ra || (Ra = {}));
  var Li;
  ...
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        R.objectLiteral(r) &&
        (r.tooltip === void 0 || R.string(r.tooltip) || Wt.is(r.tooltip)) &&
        (r.location === void 0 || dn.is(r.location)) &&
        (r.command === void 0 || vt.is(r.command))
      );
    }
    e.is = n;
  ...
  (function (e) {
    ...
    function n(i) {
      ...
      return (
        (R.objectLiteral(r) &&
          se.is(r.position) &&
          (R.string(r.label) || R.typedArray(r.label, Ci.is)) &&
          (r.kind === void 0 || Li.is(r.kind)) &&
          r.textEdits === void 0) ||
        (R.typedArray(r.textEdits, le.is) &&
          (r.tooltip === void 0 || R.string(r.tooltip) || Wt.is(r.tooltip)) &&
          (r.paddingLeft === void 0 || R.boolean(r.paddingLeft)) &&
          (r.paddingRight === void 0 || R.boolean(r.paddingRight)))
      );
    }
    e.is = n;
  })(Da || (Da = {}));
  ...
  (function (e) {
    function t(n) {
      const i = n;
      return R.objectLiteral(i) && fi.is(i.uri) && R.string(i.name);
    }
    e.is = t;
  })(Pa || (Pa = {}));
  var Wa;
  (function (e) {
    ...
    function i(s, a) {
      ...
      for (let c = o.length - 1; c >= 0; c--) {
        ...
        if (f <= u) l = l.substring(0, m) + d.newText + l.substring(f, l.length);
    ...
    function r(s, a) {
      ...
      let c = 0,
        d = 0,
        m = 0;
      for (; c < o.length && d < u.length; ) a(o[c], u[d]) <= 0 ? (s[m++] = o[c++]) : (s[m++] = u[d++]);
      for (; c < o.length; ) s[m++] = o[c++];
...
` &&
  ...
  (function (e) {
    ...
    e.number = a;
    function l(f, w, p) {
      return t.call(f) === "[object Number]" && w <= f && f <= p;
    }
    e.numberRange = l;
    function o(f) {
      ...
      for (let i of t)
        if (Ft.isIncremental(i)) {
          ...
          const l = Math.max(r.start.line, 0),
            o = Math.max(r.end.line, 0);
          let u = this._lineOffsets;
          const c = Fa(i.text, !1, s);
          if (o - l === c.length) for (let m = 0, f = c.length; m < f; m++) u[m + l + 1] = c[m];
          else c.length < 1e4 ? u.splice(l + 1, o - l, ...c) : (this._lineOffsets = u = u.slice(0, l + 1).concat(c, u.slice(o + 1)));
          const d = i.text.length - (a - s);
          if (d !== 0) for (let m = l + 1 + c.length, f = u.length; m < f; m++) u[m] = u[m] + d;
        } else if (Ft.isFull(i)) ((this._content = i.text), (this._lineOffsets = void 0));
  ...
  (function (e) {
    function t(r, s, a, l) {
      return new Ft(r, s, a, l);
    }
    e.create = t;
    function n(r, s, a) {
      if (r instanceof Ft) return (r.update(s, a), r);
    ...
    function i(r, s) {
      ...
      for (const c of l) {
        ...
        if (d < o) throw new Error("Overlapping edit");
  ...
  function Ri(e, t) {
    ...
    let s = 0,
      a = 0,
      l = 0;
    for (; s < i.length && a < r.length; ) t(i[s], r[a]) <= 0 ? (e[l++] = i[s++]) : (e[l++] = r[a++]);
    for (; s < i.length; ) e[l++] = i[s++];
    for (; a < r.length; ) e[l++] = r[a++];
    return e;
  }
  function Fa(e, t, n = 0) {
    const i = t ? [n] : [];
  ...
  (function (e) {
    e.LATEST = {
      textDocument: {
        completion: { completionItem: { documentationFormat: [qe.Markdown, qe.PlainText] } },
        hover: { contentFormat: [qe.Markdown, qe.PlainText] },
      },
    };
  })(qa || (qa = {}));
  var Di;
  ...
  class tc {
    ...
    peekChar(t = 0) {
      return this.source.charCodeAt(this.position + t) || 0;
    }
    advanceIfChar(t) {
    ...
    advanceIfChars(t) {
      ...
      for (n = 0; n < t.length; n++) if (this.source.charCodeAt(this.position + n) !== t[n]) return !1;
      return (this.advance(n), !0);
    }
    advanceIfRegExp(t) {
      const i = this.source.substr(this.position).match(t);
      return i ? ((this.position = this.position + i.index + i[0].length), i[0]) : "";
    }
    advanceUntilRegExp(t) {
      const i = this.source.substr(this.position).match(t);
    ...
    advanceUntilChars(t) {
      for (; this.position + t.length <= this.source.length; ) {
        let n = 0;
        for (; n < t.length && this.source.charCodeAt(this.position + n) === t[n]; n++);
    ...
    skipWhitespace() {
      return this.advanceWhileChar((n) => n === lc || n === uc || n === sc || n === oc || n === ac) > 0;
    }
    advanceWhileChar(t) {
      const n = this.position;
      for (; this.position < this.len && t(this.source.charCodeAt(this.position)); ) this.position++;
  ...
  const Oa = 33,
    ...
    lc = 32,
    uc = 9,
    cc = { "text/x-handlebars-template": !0, "text/html": !0 };
  function be(e, t = 0, n = V.WithinContent, i = !1) {
    const r = new tc(e, t);
    let s = n,
      a = 0,
      l = z.Unknown,
    ...
    function p(y, L, I) {
      return ((l = L), (a = y), (o = I), L);
    }
    function x() {
      const y = r.pos(),
        L = s,
        I = T();
      return I !== z.EOS && y === r.pos() && !(i && (I === z.StartTagClose || I === z.EndTagClose))
        ? (console.warn("Scanner.scan has not advanced at offset " + y + ", state before: " + L + " after: " + s), r.advance(1), p(y, z.Unknown))
        : I;
    }
    function T() {
      const y = r.pos();
      if (r.eos()) return p(y, z.EOS);
      let L;
      switch (s) {
        case V.WithinComment:
          return r.advanceIfChars([Tt, Tt, Ne])
            ? ((s = V.WithinContent), p(y, z.EndCommentTag))
            : (r.advanceUntilChars([Tt, Tt, Ne]), p(y, z.Comment));
        case V.WithinDoctype:
          return r.advanceIfChar(Ne) ? ((s = V.WithinContent), p(y, z.EndDoctypeTag)) : (r.advanceUntilChar(Ne), p(y, z.Doctype));
        case V.WithinContent:
          if (r.advanceIfChar(_n)) {
            if (!r.eos() && r.peekChar() === Oa) {
              if (r.advanceIfChars([Oa, Tt, Tt])) return ((s = V.WithinComment), p(y, z.StartCommentTag));
              if (r.advanceIfRegExp(/^!doctype/i)) return ((s = V.WithinDoctype), p(y, z.StartDoctypeTag));
            }
            return r.advanceIfChar(Mi) ? ((s = V.AfterOpeningEndTag), p(y, z.EndTagOpen)) : ((s = V.AfterOpeningStartTag), p(y, z.StartTagOpen));
          }
          return (r.advanceUntilChar(_n), p(y, z.Content));
        case V.AfterOpeningEndTag:
          return f().length > 0
            ? ((s = V.WithinEndTag), p(y, z.EndTag))
            : r.skipWhitespace()
              ? p(y, z.Whitespace, Ae("Tag name must directly follow the open bracket."))
              : ((s = V.WithinEndTag), r.advanceUntilChar(Ne), y < r.pos() ? p(y, z.Unknown, Ae("End tag name expected.")) : T());
        case V.WithinEndTag:
          if (r.skipWhitespace()) return p(y, z.Whitespace);
          if (r.advanceIfChar(Ne)) return ((s = V.WithinContent), p(y, z.EndTagClose));
          if (i && r.peekChar() === _n) return ((s = V.WithinContent), p(y, z.EndTagClose, Ae("Closing bracket missing.")));
          L = Ae("Closing bracket expected.");
          break;
        case V.AfterOpeningStartTag:
          return (
            ...
            (d = void 0),
            c.length > 0
              ? ((u = !1), (s = V.WithinTag), p(y, z.StartTag))
              : r.skipWhitespace()
                ? p(y, z.Whitespace, Ae("Tag name must directly follow the open bracket."))
                : ((s = V.WithinTag), r.advanceUntilChar(Ne), y < r.pos() ? p(y, z.Unknown, Ae("Start tag name expected.")) : T())
          );
        case V.WithinTag:
          return r.skipWhitespace()
            ? ((u = !0), p(y, z.Whitespace))
            : u && ((d = w()), d.length > 0)
              ? ((s = V.AfterAttributeName), (u = !1), p(y, z.AttributeName))
              : r.advanceIfChars([Mi, Ne])
                ? ((s = V.WithinContent), p(y, z.StartTagSelfClose))
                : r.advanceIfChar(Ne)
                  ? (c === "script"
                      ? m && cc[m]
                        ? (s = V.WithinContent)
                        : (s = V.WithinScriptContent)
                      : c === "style"
                        ? (s = V.WithinStyleContent)
                        : (s = V.WithinContent),
                    p(y, z.StartTagClose))
                  : i && r.peekChar() === _n
                    ? ((s = V.WithinContent), p(y, z.StartTagClose, Ae("Closing bracket missing.")))
                    : (r.advance(1), p(y, z.Unknown, Ae("Unexpected character in tag.")));
        case V.AfterAttributeName:
          return r.skipWhitespace()
            ? ((u = !0), p(y, z.Whitespace))
            : r.advanceIfChar(nc)
              ? ((s = V.BeforeAttributeValue), p(y, z.DelimiterAssign))
              : ((s = V.WithinTag), T());
        case V.BeforeAttributeValue:
          if (r.skipWhitespace()) return p(y, z.Whitespace);
          let H = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
          if (
            H.length > 0 &&
            (r.peekChar() === Ne && r.peekChar(-1) === Mi && (r.goBack(1), (H = H.substring(0, H.length - 1))), d === "type" && (m = H), H.length > 0)
          )
            return ((s = V.WithinTag), (u = !1), p(y, z.AttributeValue));
          const P = r.peekChar();
          return P === rc || P === ic
            ? (r.advance(1),
              r.advanceUntilChar(P) && r.advance(1),
              d === "type" && (m = r.getSource().substring(y + 1, r.pos() - 1)),
              (s = V.WithinTag),
              (u = !1),
              p(y, z.AttributeValue))
            : ((s = V.WithinTag), (u = !1), T());
        case V.WithinScriptContent:
          let b = 1;
          for (; !r.eos(); ) {
            const g = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
            if (g.length === 0) return (r.goToEnd(), p(y, z.Script));
            if (g === "<!--") b === 1 && (b = 2);
            else if (g === "-->") b = 1;
            else if (g[1] !== "/") b === 2 && (b = 3);
            else if (b === 3) b = 2;
          ...
          return ((s = V.WithinContent), y < r.pos() ? p(y, z.Script) : T());
        case V.WithinStyleContent:
          return (r.advanceUntilRegExp(/<\/style/i), (s = V.WithinContent), y < r.pos() ? p(y, z.Styles) : T());
      }
      return (r.advance(1), (s = V.WithinContent), p(y, z.Unknown, L));
    }
    return {
      scan: x,
      getTokenType: () => l,
  ...
  class ja {
    ...
    findNodeBefore(t) {
      const n = Va(this.children, (i) => t <= i.start) - 1;
      if (n >= 0) {
        const i = this.children[n];
        if (t > i.start) {
          if (t < i.end) return i.findNodeBefore(t);
          const r = i.lastChild;
    ...
    findNodeAt(t) {
      ...
      if (n >= 0) {
        const i = this.children[n];
        if (t > i.start && t <= i.end) return i.findNodeAt(t);
      }
      return this;
    }
  }
  class dc {
    ...
    parseDocument(t) {
      return this.parse(t.getText(), this.dataManager.getVoidElements(t.languageId));
    }
    parse(t, n) {
      const i = be(t, void 0, void 0, !0),
        r = new ja(0, t.length, [], void 0);
      let s = r,
        a = -1,
        l,
        o = null,
      ...
      for (; u !== z.EOS; ) {
        switch (u) {
          case z.StartTagOpen:
            const c = new ja(i.getTokenOffset(), t.length, [], s);
            (s.children.push(c), (s = c));
            break;
          case z.StartTag:
          ...
          case z.StartTagClose:
            s.parent &&
              ((s.end = i.getTokenEnd()),
              i.getTokenLength()
                ? ((s.startTagEnd = i.getTokenEnd()), s.tag && this.dataManager.isVoidElement(s.tag, n) && ((s.closed = !0), (s = s.parent)))
                : (s = s.parent));
            break;
          ...
          case z.EndTagClose:
            let d = s;
            for (; !d.isSameTag(l) && d.parent; ) d = d.parent;
            if (d.parent) {
              for (; s !== d; ) ((s.end = a), (s.closed = !1), (s = s.parent));
              ((s.closed = !0), (s.endTagStart = a), (s.end = i.getTokenEnd()), (s = s.parent));
            }
            break;
          case z.AttributeName: {
            o = i.getTokenText();
            let m = s.attributes;
            (m || (s.attributes = m = {}), (m[o] = null));
            break;
          }
          case z.AttributeValue: {
            const m = i.getTokenText(),
              f = s.attributes;
            f && o && ((f[o] = m), (o = null));
            break;
          }
      ...
      return { roots: r.children, findNodeBefore: r.findNodeBefore.bind(r), findNodeAt: r.findNodeAt.bind(r) };
    }
  }
  const Bt = {
    "Aacute;": "Á",
...
`,
  ...
  function qt(e, t) {
    ...
    return (fc <= n && n <= pc) || (gc <= n && n <= bc) || (wc <= n && n <= _c);
  }
  function vn(e) {
    return typeof e < "u";
  }
  function vc(e) {
    if (e) return typeof e == "string" ? { kind: "markdown", value: e } : { kind: "markdown", value: e.value };
  }
  class Ga {
    isApplicable() {
      return !0;
    ...
    constructor(t, n) {
      ((this.id = t),
        ...
        this._tags.forEach((i) => {
          this._tagMap[i.name.toLowerCase()] = i;
        }),
        n.valueSets &&
          n.valueSets.forEach((i) => {
            this._valueSetMap[i.name] = i.values;
          }));
    }
    getId() {
      return this.id;
      ...
      const r = (a) => {
          a.forEach((l) => {
            l.name.toLowerCase() === n &&
              ...
              l.valueSet &&
                this._valueSetMap[l.valueSet] &&
                this._valueSetMap[l.valueSet].forEach((o) => {
                  i.push(o);
                }));
          });
        },
        s = this._tagMap[t.toLowerCase()];
      return (s && r(s.attributes), r(this._globalAttributes), i);
    }
  }
  function nt(e, t = {}, n) {
    const i = { kind: n ? "markdown" : "plaintext", value: "" };
    if (e.description && t.documentation !== !1) {
      const r = vc(e.description);
      r && (i.value += r.value);
    }
    if (
      (e.references &&
...
`),
        n
          ? (i.value += e.references.map((r) => `[${r.name}](${r.url})`).join(" | "))
          : (i.value += e.references.map((r) => `${r.name}: ${r.url}`).join(`
`))),
      i.value !== "")
    )
  ...
  class yc {
    constructor(t, n) {
      ((this.dataManager = t), (this.readDirectory = n), (this.atributeCompletions = []));
    }
    onHtmlAttributeValue(t) {
      this.dataManager.isPathAttribute(t.tag, t.attribute) && this.atributeCompletions.push(t);
    }
    async computeCompletions(t, n) {
      const i = { items: [], isIncomplete: !1 };
      for (const r of this.atributeCompletions) {
        const s = xc(t.getText(r.range));
        if (kc(s))
          if (s === "." || s === "..") i.isIncomplete = !0;
          else {
            const a = Sc(r.value, s, r.range),
              l = await this.providePathSuggestions(r.value, a, t, n);
            for (const o of l) i.items.push(o);
          }
      }
      return i;
    }
    async providePathSuggestions(t, n, i, r) {
      const s = t.substring(0, t.lastIndexOf("/") + 1);
      let a = r.resolveReference(s || ".", i.uri);
      if (a)
        try {
          const l = [],
            o = await this.readDirectory(a);
          for (const [u, c] of o) u.charCodeAt(0) !== Tc && l.push(Ac(u, c === Di.Directory, n));
          return l;
        } catch {}
      return [];
    }
  ...
  function Sc(e, t, n) {
    ...
    if (r === -1) i = Lc(n, 1, -1);
      ...
      const s = t.slice(r + 1),
        a = Ot(n.end, -1 - s.length),
        l = s.indexOf(" ");
      let o;
      (l !== -1 ? (o = Ot(a, l)) : (o = Ot(n.end, -1)), (i = J.create(a, o)));
    }
    return i;
  }
  function Ac(e, t, n) {
    return t
      ? ((e = e + "/"),
        { label: e, kind: fe.Folder, textEdit: le.replace(n, e), command: { title: "Suggest", command: "editor.action.triggerSuggest" } })
      : { label: e, kind: fe.File, textEdit: le.replace(n, e) };
  }
  function Ot(e, t) {
    return se.create(e.line, e.character + t);
  }
  function Lc(e, t, n) {
    const i = Ot(e.start, t),
      r = Ot(e.end, n);
    return J.create(i, r);
  }
  class Cc {
    ...
    setCompletionParticipants(t) {
      this.completionParticipants = t || [];
    }
    async doComplete2(t, n, i, r, s) {
      if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory) return this.doComplete(t, n, i, s);
      const a = new yc(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory),
        l = this.completionParticipants;
      this.completionParticipants = [a].concat(l);
      const o = this.doComplete(t, n, i, s);
      try {
        const u = await a.computeCompletions(t, r);
        return { isIncomplete: o.isIncomplete || u.isIncomplete, items: u.items.concat(o.items) };
      } finally {
        this.completionParticipants = l;
      }
    }
    doComplete(t, n, i, r) {
      const s = this._doComplete(t, n, i, r);
      return this.convertCompletionList(s);
    }
    _doComplete(t, n, i, r) {
      const s = { isIncomplete: !1, items: [] },
        a = this.completionParticipants,
        l = this.dataManager.getDataProviders().filter((k) => k.isApplicable(t.languageId) && (!r || r[k.getId()] !== !1)),
        o = this.dataManager.getVoidElements(l),
        u = this.doesSupportMarkdown(),
        c = t.getText(),
        d = t.offsetAt(n),
        m = i.findNodeBefore(d);
      if (!m) return s;
      const f = be(c, m.start);
      let w = "",
        p;
      function x(k, E = d) {
        return (k > d && (k = d), { start: t.positionAt(k), end: t.positionAt(E) });
      }
      function T(k, E) {
        const M = x(k, E);
        return (
          l.forEach((W) => {
            W.provideTags().forEach((F) => {
              s.items.push({
                label: F.name,
                kind: fe.Property,
                documentation: nt(F, void 0, u),
                textEdit: le.replace(M, F.name),
      ...
      function y(k) {
        let E = k;
        for (; E > 0; ) {
          const M = c.charAt(E - 1);
          if (
            `
\r`.indexOf(M) >= 0
          )
            return c.substring(E, k);
          if (!yn(M)) return null;
          E--;
        }
      ...
      function L(k, E, M = d) {
        const W = x(k, M),
          F = Xa(c, M, V.WithinEndTag, z.EndTagClose) ? "" : ">";
        let U = m;
        for (E && (U = U.parent); U; ) {
          const O = U.tag;
          if (O && (!U.closed || (U.endTagStart && U.endTagStart > d))) {
            const Z = {
                label: "/" + O,
                kind: fe.Property,
                filterText: "/" + O,
                textEdit: le.replace(W, "/" + O + F),
                insertTextFormat: Le.PlainText,
              },
              Y = y(U.start),
              xe = y(k - 1);
            if (Y !== null && xe !== null && Y !== xe) {
              const Ee = Y + "</" + O + F;
              ((Z.textEdit = le.replace(x(k - 1 - xe.length), Ee)), (Z.filterText = xe + "</" + O));
            }
            return (s.items.push(Z), s);
          }
          U = U.parent;
        }
        return (
          E ||
            l.forEach((O) => {
              O.provideTags().forEach((Z) => {
                s.items.push({
                  label: "/" + Z.name,
                  kind: fe.Property,
                  documentation: nt(Z, void 0, u),
                  filterText: "/" + Z.name + F,
                  textEdit: le.replace(W, "/" + Z.name + F),
                  insertTextFormat: Le.PlainText,
                });
              });
            }),
      ...
      const I = (k, E) => {
        if (r && r.hideAutoCompleteProposals) return s;
        if (!this.dataManager.isVoidElement(E, o)) {
          const M = t.positionAt(k);
          s.items.push({
            label: "</" + E + ">",
            kind: fe.Property,
            filterText: "</" + E + ">",
            textEdit: le.insert(M, "$0</" + E + ">"),
      ...
      function H(k, E) {
        return (T(k, E), L(k, !0, E), s);
      }
      function P() {
        const k = Object.create(null);
        return (
          m.attributeNames.forEach((E) => {
            k[E] = !0;
          }),
          k
        );
      ...
      function b(k, E = d) {
        let M = d;
        for (; M < E && c[M] !== "<"; ) M++;
        const W = c.substring(k, E),
          F = x(k, M);
        let U = "";
        if (!Xa(c, E, V.AfterAttributeName, z.DelimiterAssign)) {
          const Z = (r == null ? void 0 : r.attributeDefaultValue) ?? "doublequotes";
          Z === "empty" ? (U = "=$1") : Z === "singlequotes" ? (U = "='$1'") : (U = '="$1"');
        }
        const O = P();
        return (
          (O[W] = !1),
          l.forEach((Z) => {
            Z.provideAttributes(w).forEach((Y) => {
              if (O[Y.name]) return;
              O[Y.name] = !0;
              let xe = Y.name,
                Ee;
              (Y.valueSet !== "v" &&
                U.length &&
                ((xe = xe + U), (Y.valueSet || Y.name === "style") && (Ee = { title: "Suggest", command: "editor.action.triggerSuggest" })),
                s.items.push({
                  label: Y.name,
                  kind: Y.valueSet === "handler" ? fe.Function : fe.Value,
                  documentation: nt(Y, void 0, u),
                  textEdit: le.replace(F, xe),
                  insertTextFormat: Le.Snippet,
                  command: Ee,
                }));
            });
      ...
      function g(k, E) {
        ...
        W[M] = `${M}$1="$2"`;
        function F(U) {
          (U.attributeNames.forEach((O) => {
            Je(O, M) && !W[O] && !E[O] && (W[O] = O + '="$1"');
          }),
            U.children.forEach((O) => F(O)));
        }
        (i && i.roots.forEach((U) => F(U)),
          Object.keys(W).forEach((U) => s.items.push({ label: U, kind: fe.Value, textEdit: le.replace(k, W[U]), insertTextFormat: Le.Snippet })));
      }
      function _(k, E = d) {
        let M, W, F;
        if (d > k && d <= E && Ec(c[k])) {
          ...
          const Z = Rc(c, d, U),
            Y = Dc(c, d, O);
          ((M = x(Z, Y)), (F = d >= U && d <= O ? c.substring(U, d) : ""), (W = !1));
        } else ((M = x(k, E)), (F = c.substring(k, d)), (W = !0));
        if (a.length > 0) {
          const U = w.toLowerCase(),
            O = p.toLowerCase(),
            Z = x(k, E);
          for (const Y of a) Y.onHtmlAttributeValue && Y.onHtmlAttributeValue({ document: t, position: n, tag: U, attribute: O, value: F, range: Z });
        }
        return (
          l.forEach((U) => {
            U.provideValues(w, p).forEach((O) => {
              const Z = W ? '"' + O.name + '"' : O.name;
              s.items.push({
                label: O.name,
                filterText: Z,
                kind: fe.Unit,
                documentation: nt(O, void 0, u),
                textEdit: le.replace(M, Z),
                insertTextFormat: Le.PlainText,
              });
            });
          }),
      ...
      function N(k) {
        return d === f.getTokenEnd() && ((D = f.scan()), D === k && f.getTokenOffset() === d) ? f.getTokenEnd() : d;
      }
      function S() {
        for (const k of a) k.onHtmlContent && k.onHtmlContent({ document: t, position: n });
        return v();
      }
      function v() {
        let k = d - 1,
        ...
        for (; k >= 0 && qt(c, k); ) (k--, E--);
        if (k >= 0 && c[k] === "&") {
          const M = J.create(se.create(n.line, E - 1), n);
          for (const W in Bt)
            if (mc(W, ";")) {
              const F = "&" + W;
              s.items.push({
                label: F,
                kind: fe.Keyword,
                documentation: Ae("Character entity representing '{0}'", Bt[W]),
                textEdit: le.replace(M, F),
                insertTextFormat: Le.PlainText,
              });
            }
        }
      ...
      function A(k, E) {
        ...
        s.items.push({
          ...
          textEdit: le.replace(M, "!DOCTYPE html>"),
          insertTextFormat: Le.PlainText,
        });
      }
      let D = f.scan();
      for (; D !== z.EOS && f.getTokenOffset() <= d; ) {
        switch (D) {
          case z.StartTagOpen:
            if (f.getTokenEnd() === d) {
              const k = N(z.StartTag);
              return (n.line === 0 && A(d, k), H(d, k));
            }
            break;
          case z.StartTag:
            if (f.getTokenOffset() <= d && d <= f.getTokenEnd()) return T(f.getTokenOffset(), f.getTokenEnd());
            w = f.getTokenText();
            break;
          case z.AttributeName:
            if (f.getTokenOffset() <= d && d <= f.getTokenEnd()) return b(f.getTokenOffset(), f.getTokenEnd());
            p = f.getTokenText();
            break;
          case z.DelimiterAssign:
            if (f.getTokenEnd() === d) {
              const k = N(z.AttributeValue);
              return _(d, k);
            }
            break;
          case z.AttributeValue:
            if (f.getTokenOffset() <= d && d <= f.getTokenEnd()) return _(f.getTokenOffset(), f.getTokenEnd());
            break;
          case z.Whitespace:
            if (d <= f.getTokenEnd())
              switch (f.getScannerState()) {
                case V.AfterOpeningStartTag:
                  const k = f.getTokenOffset(),
                    E = N(z.StartTag);
                  return H(k, E);
                case V.WithinTag:
                case V.AfterAttributeName:
                ...
                case V.BeforeAttributeValue:
                  return _(f.getTokenEnd());
                case V.AfterOpeningEndTag:
                  return L(f.getTokenOffset() - 1, !1);
                case V.WithinContent:
                  return S();
              }
            break;
          ...
          case z.EndTag:
            if (d <= f.getTokenEnd()) {
              let k = f.getTokenOffset() - 1;
              for (; k >= 0; ) {
                const E = c.charAt(k);
                if (E === "/") return L(k, !1, f.getTokenEnd());
                if (!yn(E)) break;
                k--;
              }
            }
            break;
          case z.StartTagClose:
            if (d <= f.getTokenEnd() && w) return I(f.getTokenEnd(), w);
            break;
          case z.Content:
            if (d <= f.getTokenEnd()) return S();
            break;
          default:
            if (d <= f.getTokenEnd()) return s;
            break;
    ...
    doQuoteComplete(t, n, i, r) {
      const s = t.offsetAt(n);
      if (s <= 0) return null;
      const a = (r == null ? void 0 : r.attributeDefaultValue) ?? "doublequotes";
      if (a === "empty" || t.getText().charAt(s - 1) !== "=") return null;
      const o = a === "doublequotes" ? '"$1"' : "'$1'",
        u = i.findNodeBefore(s);
      if (u && u.attributes && u.start < s && (!u.endTagStart || u.endTagStart > s)) {
        const c = be(t.getText(), u.start);
        let d = c.scan();
        for (; d !== z.EOS && c.getTokenEnd() <= s; ) {
          if (d === z.AttributeName && c.getTokenEnd() === s - 1)
            return ((d = c.scan()), d !== z.DelimiterAssign || ((d = c.scan()), d === z.Unknown || d === z.AttributeValue) ? null : o);
          d = c.scan();
        }
      }
      return null;
    ...
    doTagComplete(t, n, i) {
      const r = t.offsetAt(n);
      if (r <= 0) return null;
      const s = t.getText().charAt(r - 1);
      if (s === ">") {
        const a = this.dataManager.getVoidElements(t.languageId),
          l = i.findNodeBefore(r);
        if (l && l.tag && !this.dataManager.isVoidElement(l.tag, a) && l.start < r && (!l.endTagStart || l.endTagStart > r)) {
          const o = be(t.getText(), l.start);
          let u = o.scan();
          for (; u !== z.EOS && o.getTokenEnd() <= r; ) {
            if (u === z.StartTagClose && o.getTokenEnd() === r) return `$0</${l.tag}>`;
            u = o.scan();
          }
        }
      } else if (s === "/") {
        let a = i.findNodeBefore(r);
        for (; a && a.closed && !(a.endTagStart && a.endTagStart > r); ) a = a.parent;
        if (a && a.tag) {
          const l = be(t.getText(), a.start);
          let o = l.scan();
          for (; o !== z.EOS && l.getTokenEnd() <= r; ) {
            if (o === z.EndTagOpen && l.getTokenEnd() === r) return t.getText().charAt(r) !== ">" ? `${a.tag}>` : a.tag;
            o = l.scan();
          }
        }
      }
    ...
    convertCompletionList(t) {
      return (
        this.doesSupportMarkdown() ||
          t.items.forEach((n) => {
            n.documentation && typeof n.documentation != "string" && (n.documentation = { kind: "plaintext", value: n.documentation.value });
          }),
        t
      );
    }
    doesSupportMarkdown() {
      ...
      if (!vn(this.supportsMarkdown)) {
        if (!vn(this.lsOptions.clientCapabilities)) return ((this.supportsMarkdown = !0), this.supportsMarkdown);
        const r =
          (i = (n = (t = this.lsOptions.clientCapabilities.textDocument) == null ? void 0 : t.completion) == null ? void 0 : n.completionItem) == null
            ? void 0
            : i.documentationFormat;
        this.supportsMarkdown = Array.isArray(r) && r.indexOf(qe.Markdown) !== -1;
      }
  ...
  class Mc {
    ...
    doHover(t, n, i, r) {
      const s = this.convertContents.bind(this),
        a = this.doesSupportMarkdown(),
        l = t.offsetAt(n),
        o = i.findNodeAt(l),
        u = t.getText();
      if (!o || !o.tag) return null;
      const c = this.dataManager.getDataProviders().filter((b) => b.isApplicable(t.languageId));
      function d(b, g, _) {
        for (const N of c) {
          let S = null;
          if (
            (N.provideTags().forEach((v) => {
              if (v.name.toLowerCase() === b.toLowerCase()) {
                let A = nt(v, r, a);
                (A || (A = { kind: a ? "markdown" : "plaintext", value: "" }), (S = { contents: A, range: g }));
              }
            }),
            S)
          )
            return ((S.contents = s(S.contents)), S);
        }
        return null;
      }
      function m(b, g, _) {
        for (const N of c) {
          let S = null;
          if (
            (N.provideAttributes(b).forEach((v) => {
              if (g === v.name && v.description) {
                const A = nt(v, r, a);
                A ? (S = { contents: A, range: _ }) : (S = null);
              }
            }),
            S)
          )
      ...
      function f(b, g, _, N) {
        for (const S of c) {
          let v = null;
          if (
            (S.provideValues(b, g).forEach((A) => {
              if (_ === A.name && A.description) {
                const D = nt(A, r, a);
                D ? (v = { contents: D, range: N }) : (v = null);
              }
            }),
            v)
          )
            return ((v.contents = s(v.contents)), v);
        }
        return null;
      }
      function w(b, g) {
        ...
        for (const N in Bt) {
          ...
          const v = "&" + N;
          if (_ === v) {
            let A = Bt[N].charCodeAt(0).toString(16).toUpperCase(),
              D = "U+";
            if (A.length < 4) {
              const E = 4 - A.length;
              let M = 0;
            ...
            D += A;
            const k = Ae("Character entity representing '{0}', unicode equivalent '{1}'", Bt[N], D);
            k ? (S = { contents: k, range: g }) : (S = null);
          }
          if (S) return ((S.contents = s(S.contents)), S);
        }
        return null;
      }
      function p(b, g) {
        const _ = be(t.getText(), g);
        let N = _.scan();
        for (; N !== z.EOS && (_.getTokenEnd() < l || (_.getTokenEnd() === l && N !== b)); ) N = _.scan();
        return N === b && l <= _.getTokenEnd() ? { start: t.positionAt(_.getTokenOffset()), end: t.positionAt(_.getTokenEnd()) } : null;
      }
      function x() {
        let b = l - 1,
          g = n.character;
        ...
        if (b >= 0 && u[b] === "&") {
          ...
          return (
            u[_] === ";"
              ? (S = J.create(se.create(n.line, g), se.create(n.line, N + 1)))
              : (S = J.create(se.create(n.line, g), se.create(n.line, N))),
            S
          );
        }
        return null;
      ...
      function T(b) {
        let g = l - 1,
          _ = "&";
        for (; g >= 0 && qt(b, g); ) g--;
        for (g = g + 1; qt(b, g); ) ((_ += b[g]), (g += 1));
        return ((_ += ";"), _);
      }
      if (o.endTagStart && l >= o.endTagStart) {
        const b = p(z.EndTag, o.endTagStart);
        return b ? d(o.tag, b) : null;
      }
      const y = p(z.StartTag, o.start);
      if (y) return d(o.tag, y);
      const L = p(z.AttributeName, o.start);
      if (L) {
        const b = o.tag,
          g = t.getText(L);
        return m(b, g, L);
      ...
      if (I) return w(u, I);
      function H(b, g) {
        const _ = be(t.getText(), b);
        let N = _.scan(),
          S;
        for (; N !== z.EOS && _.getTokenEnd() <= g; ) ((N = _.scan()), N === z.AttributeName && (S = _.getTokenText()));
        return S;
      }
      const P = p(z.AttributeValue, o.start);
      if (P) {
        const b = o.tag,
          g = Nc(t.getText(P)),
          _ = H(o.start, t.offsetAt(P.start));
        if (_) return f(b, _, g, P);
      }
      return null;
    }
    convertContents(t) {
      if (!this.doesSupportMarkdown()) {
        ...
        if (Array.isArray(t)) t.map((n) => (typeof n == "string" ? n : n.value));
        else return t.value;
      }
      return t;
    }
    doesSupportMarkdown() {
      ...
      if (!vn(this.supportsMarkdown)) {
        if (!vn(this.lsOptions.clientCapabilities)) return ((this.supportsMarkdown = !0), this.supportsMarkdown);
        const r =
          (i = (n = (t = this.lsOptions.clientCapabilities) == null ? void 0 : t.textDocument) == null ? void 0 : n.hover) == null
            ? void 0
            : i.contentFormat;
        this.supportsMarkdown = Array.isArray(r) && r.indexOf(qe.Markdown) !== -1;
      }
  ...
  function Nc(e) {
    return e.length <= 1
      ? e.replace(/['"]/, "")
      : ((e[0] === "'" || e[0] === '"') && (e = e.slice(1)), (e[e.length - 1] === "'" || e[e.length - 1] === '"') && (e = e.slice(0, -1)), e);
  }
  function Ic(e, t) {
    return e;
  }
        ...
        function (r) {
          ...
          ((s.prototype.clone_empty = function () {
            ...
            (s.prototype.has_match = function (o) {
              for (var u = this.__items.length - 1; u >= 0; u--) if (this.__items[u].match(o)) return !0;
              return !1;
            }),
            (s.prototype.set_indent = function (o, u) {
              this.is_empty() &&
                ((this.__indent_count = o || 0),
            ...
            (s.prototype._allow_wrap = function () {
              if (this._should_wrap()) {
                ...
                return (
                  o.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count),
                  (o.__items = this.__items.slice(this.__wrap_point_index)),
                  (this.__items = this.__items.slice(0, this.__wrap_point_index)),
                  (o.__character_count += this.__character_count - this.__wrap_point_character_count),
                  (this.__character_count = this.__wrap_point_character_count),
                  o.__items[0] === " " && (o.__items.splice(0, 1), (o.__character_count -= 1)),
                  !0
                );
              }
              return !1;
...
`);
            ...
            (s.prototype.toString = function () {
              ...
              return (
                this.is_empty()
                  ? this.__parent.indent_empty_lines && (o = this.__parent.get_indent_string(this.__indent_count))
                  : ((o = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count)), (o += this.__items.join(""))),
                o
              );
            }));
          function a(o, u) {
            ((this.__cache = [""]),
              (this.__indent_size = o.indent_size),
              (this.__indent_string = o.indent_char),
              o.indent_with_tabs || (this.__indent_string = new Array(o.indent_size + 1).join(o.indent_char)),
              (u = u || ""),
              o.indent_level > 0 && (u = new Array(o.indent_level + 1).join(this.__indent_string)),
          ...
          ((a.prototype.get_indent_size = function (o, u) {
            ...
            (a.prototype.__ensure_cache = function (o) {
              for (; o >= this.__cache.length; ) this.__add_column();
            }),
            (a.prototype.__add_column = function () {
              var o = this.__cache.length,
                u = 0,
                c = "";
              (this.__indent_size &&
                o >= this.__indent_size &&
                ((u = Math.floor(o / this.__indent_size)), (o -= u * this.__indent_size), (c = new Array(u + 1).join(this.__indent_string))),
                o && (c += new Array(o + 1).join(" ")),
                this.__cache.push(c));
            }));
          function l(o, u) {
            ((this.__indent_cache = new a(o, u)),
              (this.raw = !1),
              (this._end_with_newline = o.end_with_newline),
              (this.indent_size = o.indent_size),
              (this.wrap_line_length = o.wrap_line_length),
              (this.indent_empty_lines = o.indent_empty_lines),
              (this.__lines = []),
...
` && (c = c.replace(/[\n]/g, o)),
            ...
            (l.prototype.set_indent = function (o, u) {
              return (
                (o = o || 0),
                (u = u || 0),
                this.next_line.set_indent(o, u),
                this.__lines.length > 1 ? (this.current_line.set_indent(o, u), !0) : (this.current_line.set_indent(), !1)
              );
            }),
            (l.prototype.add_raw_token = function (o) {
              for (var u = 0; u < o.newlines; u++) this.__add_outputline();
              (this.current_line.set_indent(-1),
                this.current_line.push(o.whitespace_before),
                this.current_line.push(o.text),
                (this.space_before_token = !1),
                (this.non_breaking_space = !1),
                (this.previous_token_wrapped = !1));
            }),
            ...
            (l.prototype.remove_indent = function (o) {
              for (var u = this.__lines.length; o < u; ) (this.__lines[o]._remove_indent(), o++);
        ...
        function (r) {
          function s(o, u) {
            ((this.raw_options = a(o, u)),
              ...
              this.indent_with_tabs && ((this.indent_char = "	"), this.indent_size === 1 && (this.indent_size = 4)),
          ...
          ((s.prototype._get_array = function (o, u) {
            ...
            return (
              typeof c == "object"
                ? c !== null && typeof c.concat == "function" && (d = c.concat())
                : typeof c == "string" && (d = c.split(/[^a-zA-Z0-9_\/\-]+/)),
              d
            );
          }),
...
You passed in: '` +
            ...
            (s.prototype._get_selection_list = function (o, u, c) {
              if (!u || u.length === 0) throw new Error("Selection list cannot be empty.");
              if (((c = c || [u[0]]), !this._is_valid_selection(c, u))) throw new Error("Invalid Default Value!");
...
You passed in: '` +
          ...
          function a(o, u) {
            ...
            o = l(o);
            var d;
            for (d in o) d !== u && (c[d] = o[d]);
            if (u && o[u]) for (d in o[u]) c[d] = o[u][d];
            return c;
          }
          function l(o) {
            var u = {},
        ...
        function (r) {
          ...
          ((a.prototype.restart = function () {
            ...
            (a.prototype.readUntil = function (l, o) {
              ...
              return (
                d ? ((c = d.index), o && (c += d[0].length)) : (c = this.__input_length),
                (u = this.__input.substring(this.__position, c)),
                (this.__position = c),
                u
              );
            }),
        ...
        function (r) {
          function s(a, l) {
            ((a = typeof a == "string" ? a : a.source),
              (l = typeof l == "string" ? l : l.source),
              (this.__directives_block_pattern = new RegExp(a + / beautify( \w+[:]\w+)+ /.source + l, "g")),
              (this.__directive_pattern = / (\w+)[:](\w+)/g),
              (this.__directives_end_ignore_pattern = new RegExp(a + /\sbeautify\signore:end\s/.source + l, "g")));
          }
          ((s.prototype.get_directives = function (a) {
            if (!a.match(this.__directives_block_pattern)) return null;
            var l = {};
            this.__directive_pattern.lastIndex = 0;
            for (var o = this.__directive_pattern.exec(a); o; ) ((l[o[1]] = o[2]), (o = this.__directive_pattern.exec(a)));
            return l;
          }),
        ...
        function (r, s, a) {
          ...
          ((y.prototype.eatString = function (L) {
            var I = "";
            for (this._ch = this._input.next(); this._ch; ) {
              if (((I += this._ch), this._ch === "\\")) I += this._input.next();
              else if (
                L.indexOf(this._ch) !== -1 ||
                this._ch ===
                  `
`
              )
            ...
            (y.prototype.eatWhitespace = function (L) {
              for (var I = w.test(this._input.peek()), H = 0; w.test(this._input.peek()); )
                ((this._ch = this._input.next()),
                  L &&
                    this._ch ===
                      `
` &&
                    (H === 0 || H < this._options.max_preserve_newlines) &&
                    (H++, this._output.add_new_line(!0)));
              return I;
            }),
            (y.prototype.foundNestedPseudoClass = function () {
              for (var L = 0, I = 1, H = this._input.peek(I); H; ) {
                if (H === "{") return !0;
                if (H === "(") L += 1;
                else if (H === ")") {
                  if (L === 0) return !1;
...
`,
              ...
              var H = L.match(/^[\t ]*/)[0];
              ((this._output = new o(this._options, H)),
                (this._input = new u(L)),
                (this._indentLevel = 0),
                (this._nestedLevel = 0),
                (this._ch = null));
              for (
                var P = 0, b = !1, g = !1, _ = !1, N = !1, S = !1, v = this._ch, A = !1, D, k, E;
                (D = this._input.read(p)),
                  (k = D !== ""),
                  (E = v),
                  (this._ch = this._input.next()),
                ...
                if (this._ch === "/" && this._input.peek() === "*") {
                  ...
                  var M = this._input.read(x),
                    W = d.get_directives(M);
                  (W && W.ignore === "start" && (M += d.readIgnored(this._input)),
                    this.print_string(M),
                    this.eatWhitespace(!0),
                    this._output.add_new_line());
                } else if (this._ch === "/" && this._input.peek() === "/")
                  ((this._output.space_before_token = !0), this._input.back(), this.print_string(this._input.read(T)), this.eatWhitespace(!0));
                else if (this._ch === "$") {
                  (this.preserveSingleSpace(k), this.print_string(this._ch));
                  var F = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
                  (F.match(/[ :]$/) && ((F = this.eatString(": ").replace(/\s+$/, "")), this.print_string(F), (this._output.space_before_token = !0)),
                    P === 0 && F.indexOf(":") !== -1 && ((g = !0), this.indent()));
                } else if (this._ch === "@")
                  if ((this.preserveSingleSpace(k), this._input.peek() === "{")) this.print_string(this._ch + this.eatString("}"));
                  else {
                    this.print_string(this._ch);
                    var U = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
                    (U.match(/[ :]$/) &&
                      ((U = this.eatString(": ").replace(/\s+$/, "")), this.print_string(U), (this._output.space_before_token = !0)),
                      P === 0 && U.indexOf(":") !== -1
                        ? ((g = !0), this.indent())
                        : U in this.NESTED_AT_RULE
                          ? ((this._nestedLevel += 1), U in this.CONDITIONAL_GROUP_RULE && (_ = !0))
                          : P === 0 && !g && (N = !0));
                  }
                else if (this._ch === "#" && this._input.peek() === "{")
                  (this.preserveSingleSpace(k), this.print_string(this._ch + this.eatString("}")));
                else if (this._ch === "{")
                  (g && ((g = !1), this.outdent()),
                    (N = !1),
                    _ ? ((_ = !1), (b = this._indentLevel >= this._nestedLevel)) : (b = this._indentLevel >= this._nestedLevel - 1),
                    ...
                    this._options.brace_style === "expand"
                      ...
                      : (E === "(" ? (this._output.space_before_token = !1) : E !== "," && this.indent(), this.print_string(this._ch)),
                    this.eatWhitespace(!0),
                    this._output.add_new_line());
                else if (this._ch === "}")
                  (this.outdent(),
                    ...
                    this._input.peek() === ")" && (this._output.trim(!0), this._options.brace_style === "expand" && this._output.add_new_line(!0)));
                else if (this._ch === ":") {
                  ...
                  (b || _) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !N && P === 0
                  ...
                  var Z = E === '"' || E === "'";
                  (this.preserveSingleSpace(Z || k), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0));
                } else if (this._ch === ";")
                  ((A = !1),
                    P === 0
                      ? (g && (this.outdent(), (g = !1)),
                  ...
                  if (this._input.lookBack("url"))
                    (this.print_string(this._ch),
                      ...
                      this._ch === ")" || this._ch === '"' || this._ch === "'"
                        ? this._input.back()
                        : this._ch && (this.print_string(this._ch + this.eatString(")")), P && (P--, this.outdent())));
                  else {
                    var Y = !1;
                    (this._input.lookBack("with") && (Y = !0),
                      this.preserveSingleSpace(k || Y),
                      this.print_string(this._ch),
                      g && E === "$" && this._options.selector_separator_newline
                        ? (this._output.add_new_line(), (S = !0))
                        : (this.eatWhitespace(), P++, this.indent()));
                  }
                else if (this._ch === ")")
                  (P && (P--, this.outdent()),
                    S &&
                      ...
                      ((S = !1), this.outdent(), this._output.add_new_line()),
                    this.print_string(this._ch));
                else if (this._ch === ",")
                  (this.print_string(this._ch),
                    this.eatWhitespace(!0),
                    this._options.selector_separator_newline && (!g || S) && P === 0 && !N
                      ? this._output.add_new_line()
                      : (this._output.space_before_token = !0));
                else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !g && P === 0)
                  this._options.space_around_combinator
                    ...
                    : (this.print_string(this._ch), this.eatWhitespace(), this._ch && w.test(this._ch) && (this._ch = ""));
                else if (this._ch === "]") this.print_string(this._ch);
                else if (this._ch === "[") (this.preserveSingleSpace(k), this.print_string(this._ch));
                else if (this._ch === "=") (this.eatWhitespace(), this.print_string("="), w.test(this._ch) && (this._ch = ""));
                else if (this._ch === "!" && !this._input.lookBack("\\")) ((this._output.space_before_token = !0), this.print_string(this._ch));
                else {
                  var xe = E === '"' || E === "'";
                  (this.preserveSingleSpace(xe || k),
                    this.print_string(this._ch),
...
` &&
              ...
              var Ee = this._output.get_code(I);
              return Ee;
            }),
        ...
        function (r, s, a) {
          ...
          function o(u) {
            ...
            for (var m = 0; m < d.length; m++) d[m] !== "expand" ? (this.brace_style = "collapse") : (this.brace_style = d[m]);
          }
...
You passed in: '` +
        ...
        function (r, s, a) {
          var l = a(8).InputScanner,
            o = a(3).Token,
            u = a(10).TokenStream,
            c = a(11).WhitespacePattern,
            ...
            m = function (f, w) {
              ((this._input = new l(f)),
                ...
                (this.__tokens = null),
                (this._patterns = {}),
                (this._patterns.whitespace = new c(this._input)));
            };
          ((m.prototype.tokenize = function () {
            (this._input.restart(), (this.__tokens = new u()), this._reset());
            for (var f, w = new o(d.START, ""), p = null, x = [], T = new u(); w.type !== d.EOF; ) {
              for (f = this._get_next_token(w, p); this._is_comment(f); ) (T.add(f), (f = this._get_next_token(w, p)));
              (T.isEmpty() || ((f.comments_before = T), (T = new u())),
                (f.parent = p),
                this._is_opening(f)
                  ? (x.push(p), (p = f))
                  : p && this._is_closing(f, p) && ((f.opened = p), (p.closed = f), (p = x.pop()), (f.parent = p)),
                (f.previous = w),
                (w.next = f),
                this.__tokens.add(f),
                (w = f));
            ...
            (m.prototype._create_token = function (f, w) {
              var p = new o(f, w, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
              return p;
            }),
        ...
        function (r, s, a) {
          ...
          function o(u, c) {
            (l.call(this, u, c),
              c ? (this._line_regexp = this._input.get_regexp(c._line_regexp)) : this.__set_whitespace_patterns("", ""),
              (this.newline_count = 0),
              (this.whitespace_before_token = ""));
          }
          ((o.prototype = new l()),
            (o.prototype.__set_whitespace_patterns = function (u, c) {
              ((u += "\\t "),
                (c += "\\n\\r"),
                (this._match_pattern = this._input.get_regexp("[" + u + c + "]+", !0)),
            ...
            (o.prototype.__split = function (u, c) {
              u.lastIndex = 0;
              for (var d = 0, m = [], f = u.exec(c); f; ) (m.push(c.substring(d, f.index)), (d = f.index + f[0].length), (f = u.exec(c)));
        ...
        function (r) {
          function s(a, l) {
            ((this._input = a),
              ...
              (this._until_after = !1),
              l &&
                ((this._starting_pattern = this._input.get_regexp(l._starting_pattern, !0)),
                (this._match_pattern = this._input.get_regexp(l._match_pattern, !0)),
                (this._until_pattern = this._input.get_regexp(l._until_pattern)),
        ...
        function (r, s, a) {
          var l = a(12).Pattern,
            o = { django: !1, erb: !1, handlebars: !1, php: !1, smarty: !1, angular: !1 };
          function u(c, d) {
            (l.call(this, c, d),
              ...
              d &&
                ((this.__template_pattern = this._input.get_regexp(d.__template_pattern)),
          ...
          ((u.prototype = new l()),
            ...
            (u.prototype.read_options = function (c) {
              var d = this._create();
              for (var m in o) d._disabled[m] = c.templating.indexOf(m) === -1;
              return (d._update(), d);
            }),
            ...
            (u.prototype.read = function () {
              ...
              this._match_pattern
                ...
                : (c = this._input.read(this._starting_pattern, this.__template_pattern));
              for (var d = this._read_template(); d; )
                (this._match_pattern ? (d += this._input.read(this._match_pattern)) : (d += this._input.readUntil(this.__template_pattern)),
                  (c += d),
            ...
            (u.prototype.__set_templated_pattern = function () {
              var c = [];
              (this._disabled.php || c.push(this.__patterns.php._starting_pattern.source),
                this._disabled.handlebars || c.push(this.__patterns.handlebars._starting_pattern.source),
                this._disabled.erb || c.push(this.__patterns.erb._starting_pattern.source),
                this._disabled.django ||
                  (c.push(this.__patterns.django._starting_pattern.source),
                  c.push(this.__patterns.django_value._starting_pattern.source),
                  c.push(this.__patterns.django_comment._starting_pattern.source)),
                this._disabled.smarty || c.push(this.__patterns.smarty._starting_pattern.source),
                this._until_pattern && c.push(this._until_pattern.source),
                (this.__template_pattern = this._input.get_regexp("(?:" + c.join("|") + ")")));
            }),
            (u.prototype._read_template = function () {
              ...
              if (d === "<") {
                ...
                (!this._disabled.php && !this._excluded.php && m === "?" && (c = c || this.__patterns.php.read()),
                  !this._disabled.erb && !this._excluded.erb && m === "%" && (c = c || this.__patterns.erb.read()));
              } else
                d === "{" &&
                  (!this._disabled.handlebars &&
                    !this._excluded.handlebars &&
                    ((c = c || this.__patterns.handlebars_comment.read()),
                    (c = c || this.__patterns.handlebars_unescaped.read()),
                    (c = c || this.__patterns.handlebars.read())),
                  this._disabled.django ||
                    (!this._excluded.django && !this._excluded.handlebars && (c = c || this.__patterns.django_value.read()),
                    this._excluded.django || ((c = c || this.__patterns.django_comment.read()), (c = c || this.__patterns.django.read()))),
                  this._disabled.smarty ||
                    (this._disabled.django &&
                      this._disabled.handlebars &&
                      ((c = c || this.__patterns.smarty_comment.read()),
                      (c = c || this.__patterns.smarty_literal.read()),
                      (c = c || this.__patterns.smarty.read()))));
              return c;
            }),
        ...
        function (r, s, a) {
          ...
          ((f.prototype.current_line_has_match = function (b) {
            ...
            (f.prototype.print_preserved_newlines = function (b) {
              var g = 0;
              (b.type !== c.TEXT && b.previous.type !== c.TEXT && (g = b.newlines ? 1 : 0),
                this.preserve_newlines && (g = b.newlines < this.max_preserve_newlines + 1 ? b.newlines : this.max_preserve_newlines + 1));
              for (var _ = 0; _ < g; _++) this.print_newline(_ > 0);
              return g !== 0;
            }),
          ...
          var w = function (b) {
              for (var g = null, _ = b.next; _.type !== c.EOF && b.closed !== _; ) {
                if (_.type === c.ATTRIBUTE && _.text === "type") {
                  _.next && _.next.type === c.EQUALS && _.next.next && _.next.next.type === c.VALUE && (g = _.next.next.text);
                  break;
                }
                _ = _.next;
              }
            ...
            p = function (b, g) {
              var _ = null,
                N = null;
              return g.closed
                ? (b === "script" ? (_ = "text/javascript") : b === "style" && (_ = "text/css"),
                  (_ = w(g) || _),
                  _.search("text/css") > -1
                    ? (N = "css")
                    : _.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1
                      ? (N = "javascript")
                      : _.search(/(text|application|dojo)\/(x-)?(html)/) > -1
                        ? (N = "html")
                        : _.search(/test\/null/) > -1 && (N = "null"),
                  N)
                : null;
            };
          function x(b, g) {
          ...
          function T(b, g, _) {
            ((this.parent = b || null), (this.tag = g ? g.tag_name : ""), (this.indent_level = _ || 0), (this.parser_token = g || null));
          }
          function y(b) {
          ...
          ((y.prototype.get_parser_token = function () {
            ...
            (y.prototype.record_tag = function (b) {
              var g = new T(this._current_frame, b, this._printer.indent_level);
            ...
            (y.prototype._get_frame = function (b, g) {
              for (var _ = this._current_frame; _ && b.indexOf(_.tag) === -1; ) {
                if (g && g.indexOf(_.tag) !== -1) {
                  _ = null;
                  break;
                }
                _ = _.parent;
            ...
            (y.prototype.try_pop = function (b, g) {
              var _ = this._get_frame([b], g);
              return this._try_pop_frame(_);
            }),
          ...
          function L(b, g, _, N) {
            ((this._source_text = b || ""), (g = g || {}), (this._js_beautify = _), (this._css_beautify = N), (this._tag_stack = null));
            var S = new l(g, "html");
            ((this._options = S),
...
`,
            ...
            var _ = b.match(/^[\t ]*/)[0],
              N = { text: "", type: "" },
              S = new I(),
              v = new f(this._options, _),
              A = new u(b, this._options).tokenize();
            this._tag_stack = new y(v);
            for (var D = null, k = A.next(); k.type !== c.EOF; )
              (k.type === c.TAG_OPEN || k.type === c.COMMENT
                ? ((D = this._handle_tag_open(v, k, S, N, A)), (S = D))
                : k.type === c.ATTRIBUTE || k.type === c.EQUALS || k.type === c.VALUE || (k.type === c.TEXT && !S.tag_complete)
                  ? (D = this._handle_inside_tag(v, k, S, N))
                  : k.type === c.TAG_CLOSE
                    ? (D = this._handle_tag_close(v, k, S))
                    : k.type === c.TEXT
                      ? (D = this._handle_text(v, k, S))
                      : k.type === c.CONTROL_FLOW_OPEN
                        ? (D = this._handle_control_flow_open(v, k))
                        : k.type === c.CONTROL_FLOW_CLOSE
                          ? (D = this._handle_control_flow_close(v, k))
                          : v.add_raw_token(k),
                (N = D),
                (k = A.next()));
            var E = v._output.get_code(g);
            return E;
          }),
            (L.prototype._handle_control_flow_open = function (b, g) {
              var _ = { text: g.text, type: g.type };
              return (
                b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0),
                g.newlines ? b.print_preserved_newlines(g) : b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0),
                b.print_token(g),
                b.indent(),
                _
              );
            }),
            (L.prototype._handle_control_flow_close = function (b, g) {
              var _ = { text: g.text, type: g.type };
              return (
                b.deindent(),
                g.newlines ? b.print_preserved_newlines(g) : b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0),
            ...
            (L.prototype._handle_tag_close = function (b, g, _) {
              var N = { text: g.text, type: g.type };
              return (
                (b.alignment_size = 0),
                (_.tag_complete = !0),
                b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0),
                _.is_unformatted
                  ? b.add_raw_token(g)
                  : (_.tag_start_char === "<" &&
                      (b.set_space_before_token(g.text[0] === "/", !0),
                      this._is_wrap_attributes_force_expand_multiline && _.has_wrapped_attrs && b.print_newline(!1)),
                    b.print_token(g)),
                _.indent_content && !(_.is_unformatted || _.is_content_unformatted) && (b.indent(), (_.indent_content = !1)),
                !_.is_inline_element && !(_.is_unformatted || _.is_content_unformatted) && b.set_wrap_point(),
                N
              );
            }),
            (L.prototype._handle_inside_tag = function (b, g, _, N) {
              var S = _.has_wrapped_attrs,
                v = { text: g.text, type: g.type };
              return (
                b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0),
                _.is_unformatted
                  ? b.add_raw_token(g)
                  : _.tag_start_char === "{" && g.type === c.TEXT
                    ? b.print_preserved_newlines(g)
                      ? ((g.newlines = 0), b.add_raw_token(g))
                      : b.print_token(g)
                    : (g.type === c.ATTRIBUTE
                        ? b.set_space_before_token(!0)
                        : (g.type === c.EQUALS || (g.type === c.VALUE && g.previous.type === c.EQUALS)) && b.set_space_before_token(!1),
                      g.type === c.ATTRIBUTE &&
                        _.tag_start_char === "<" &&
                        ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) &&
                          (b.traverse_whitespace(g), (S = S || g.newlines !== 0)),
                        this._is_wrap_attributes_force &&
                          _.attr_count >= this._options.wrap_attributes_min_attrs &&
                          (N.type !== c.TAG_OPEN || this._is_wrap_attributes_force_expand_multiline) &&
                          (b.print_newline(!1), (S = !0))),
                      b.print_token(g),
                      (S = S || b.previous_token_wrapped()),
                      (_.has_wrapped_attrs = S)),
                v
              );
            }),
            (L.prototype._handle_text = function (b, g, _) {
              var N = { text: g.text, type: "TK_CONTENT" };
              return (
                _.custom_beautifier_name
                  ? this._print_custom_beatifier_text(b, g, _)
                  : _.is_unformatted || _.is_content_unformatted
                    ? b.add_raw_token(g)
                    : (b.traverse_whitespace(g), b.print_token(g)),
                N
              );
            }),
            (L.prototype._print_custom_beatifier_text = function (b, g, _) {
              var N = this;
              if (g.text !== "") {
                var S = g.text,
                  v,
                  ...
                  D = "",
                  k = "";
                (_.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function"
                  ? (v = this._js_beautify)
                  : _.custom_beautifier_name === "css" && typeof this._css_beautify == "function"
                    ? (v = this._css_beautify)
                    : _.custom_beautifier_name === "html" &&
                      (v = function (O, Z) {
                        var Y = new L(O, Z, N._js_beautify, N._css_beautify);
                        return Y.beautify();
                      }),
                  this._options.indent_scripts === "keep" ? (A = 0) : this._options.indent_scripts === "separate" && (A = -b.indent_level));
                var E = b.get_full_indent(A);
                if (((S = S.replace(/\n[ \t]*$/, "")), _.custom_beautifier_name !== "html" && S[0] === "<" && S.match(/^(<!--|<!\[CDATA\[)/))) {
                  var M = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(S);
                  if (!M) {
                    b.add_raw_token(g);
                    return;
...
`),
                    ...
                    (M[2] ||
                      M[3].indexOf(`
`) !== -1) &&
                      ((M = M[3].match(/[ \t]+$/)), M && (g.whitespace_before = M[0])));
                }
                if (S)
                  if (v) {
                    var W = function () {
...
` +
                    ...
                    : (S = D + k)),
                  b.print_newline(!1),
                  S && ((g.text = S), (g.whitespace_before = ""), (g.newlines = 0), b.add_raw_token(g), b.print_newline(!0)));
              }
            }),
            (L.prototype._handle_tag_open = function (b, g, _, N, S) {
              var v = this._get_tag_open_token(g);
              if (
                ((_.is_unformatted || _.is_content_unformatted) && !_.is_empty_element && g.type === c.TAG_OPEN && !v.is_start_tag
                  ? (b.add_raw_token(g), (v.start_tag_token = this._tag_stack.try_pop(v.tag_name)))
                  : (b.traverse_whitespace(g), this._set_tag_position(b, g, v, _, N), v.is_inline_element || b.set_wrap_point(), b.print_token(g)),
                v.is_start_tag && this._is_wrap_attributes_force)
              ) {
                var A = 0,
                  D;
                do ((D = S.peek(A)), D.type === c.ATTRIBUTE && (v.attr_count += 1), (A += 1));
                while (D.type !== c.EOF && D.type !== c.TAG_CLOSE);
              }
              return (
                (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) &&
                  (v.alignment_size = g.text.length + 1),
                !v.tag_complete && !v.is_unformatted && (b.alignment_size = v.alignment_size),
                v
              );
            }));
          var I = function (b, g) {
            if (
              ...
              var _;
              ((this.tag_start_char = g.text[0]),
                (this.text = g.text),
                this.tag_start_char === "<"
                  ? ((_ = g.text.match(/^<([^\s>]*)/)), (this.tag_check = _ ? _[1] : ""))
                  : ((_ = g.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
                    (this.tag_check = _ ? _[1] : ""),
                    (g.text.startsWith("{{#>") || g.text.startsWith("{{~#>")) &&
                      this.tag_check[0] === ">" &&
                      (this.tag_check === ">" && g.next !== null
                        ? (this.tag_check = g.next.text.split(" ")[0])
                        : (this.tag_check = g.text.split(">")[1]))),
                (this.tag_check = this.tag_check.toLowerCase()),
                g.type === c.COMMENT && (this.tag_complete = !0),
                (this.is_start_tag = this.tag_check.charAt(0) !== "/"),
                (this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1)),
                (this.is_end_tag = !this.is_start_tag || (g.closed && g.closed.text === "/>")));
              var N = 2;
              (this.tag_start_char === "{" && this.text.length >= 3 && this.text.charAt(2) === "~" && (N = 3),
                (this.is_end_tag = this.is_end_tag || (this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(N))))));
            }
          };
          ((L.prototype._get_tag_open_token = function (b) {
            var g = new I(this._tag_stack.get_parser_token(), b);
            return (
              (g.alignment_size = this._options.wrap_attributes_indent_size),
              (g.is_end_tag = g.is_end_tag || x(g.tag_check, this._options.void_elements)),
              (g.is_empty_element = g.tag_complete || (g.is_start_tag && g.is_end_tag)),
              (g.is_unformatted = !g.tag_complete && x(g.tag_check, this._options.unformatted)),
              (g.is_content_unformatted = !g.is_empty_element && x(g.tag_check, this._options.content_unformatted)),
              (g.is_inline_element =
                x(g.tag_name, this._options.inline) ||
                (this._options.inline_custom_elements && g.tag_name.includes("-")) ||
                g.tag_start_char === "{"),
              g
            );
          }),
            (L.prototype._set_tag_position = function (b, g, _, N, S) {
              if (
                (_.is_empty_element ||
                  (_.is_end_tag
                    ? (_.start_tag_token = this._tag_stack.try_pop(_.tag_name))
                    : (this._do_optional_end_element(_) && (_.is_inline_element || b.print_newline(!1)),
                      this._tag_stack.record_tag(_),
                      (_.tag_name === "script" || _.tag_name === "style") &&
                        !(_.is_unformatted || _.is_content_unformatted) &&
                        (_.custom_beautifier_name = p(_.tag_check, g)))),
                x(_.tag_check, this._options.extra_liners) && (b.print_newline(!1), b._output.just_added_blankline() || b.print_newline(!0)),
                _.is_empty_element)
              ) {
                if (_.tag_start_char === "{" && _.tag_check === "else") {
                  (this._tag_stack.indent_to_tag(["if", "unless", "each"]), (_.indent_content = !0));
                  var v = b.current_line_has_match(/{{#if/);
                  v || b.print_newline(!1);
                }
                (_.tag_name === "!--" &&
                  S.type === c.TAG_CLOSE &&
                  ...
                  _.text.indexOf(`
`) === -1) ||
                  (_.is_inline_element || _.is_unformatted || b.print_newline(!1), this._calcluate_parent_multiline(b, _));
              } else if (_.is_end_tag) {
                var A = !1;
                ((A = _.start_tag_token && _.start_tag_token.multiline_content),
                  (A =
                    A ||
                    (!_.is_inline_element &&
                      !(N.is_inline_element || N.is_unformatted) &&
                      !(S.type === c.TAG_CLOSE && _.start_tag_token === N) &&
                      S.type !== "TK_CONTENT")),
                  (_.is_content_unformatted || _.is_unformatted) && (A = !1),
                  A && b.print_newline(!1));
              } else
                ((_.indent_content = !_.custom_beautifier_name),
                  _.tag_start_char === "<" &&
                    (_.tag_name === "html"
                      ? (_.indent_content = this._options.indent_inner_html)
                      : _.tag_name === "head"
                        ? (_.indent_content = this._options.indent_head_inner_html)
                        : _.tag_name === "body" && (_.indent_content = this._options.indent_body_inner_html)),
                  !(_.is_inline_element || _.is_unformatted) && (S.type !== "TK_CONTENT" || _.is_content_unformatted) && b.print_newline(!1),
                  this._calcluate_parent_multiline(b, _));
            }),
            (L.prototype._calcluate_parent_multiline = function (b, g) {
              g.parent &&
                b._output.just_added_newline() &&
                !((g.is_inline_element || g.is_unformatted) && g.parent.is_inline_element) &&
                (g.parent.multiline_content = !0);
            }));
          var H = [
              "address",
              "article",
          ...
          ((L.prototype._do_optional_end_element = function (b) {
            var g = null;
            if (!(b.is_empty_element || !b.is_start_tag || !b.parent)) {
              if (b.tag_name === "body") g = g || this._tag_stack.try_pop("head");
              else if (b.tag_name === "li") g = g || this._tag_stack.try_pop("li", ["ol", "ul", "menu"]);
              else if (b.tag_name === "dd" || b.tag_name === "dt")
                ((g = g || this._tag_stack.try_pop("dt", ["dl"])), (g = g || this._tag_stack.try_pop("dd", ["dl"])));
              else if (b.parent.tag_name === "p" && H.indexOf(b.tag_name) !== -1) {
                var _ = b.parent.parent;
                (!_ || P.indexOf(_.tag_name) === -1) && (g = g || this._tag_stack.try_pop("p"));
              } else
                b.tag_name === "rp" || b.tag_name === "rt"
                  ? ((g = g || this._tag_stack.try_pop("rt", ["ruby", "rtc"])), (g = g || this._tag_stack.try_pop("rp", ["ruby", "rtc"])))
                  : b.tag_name === "optgroup"
                    ? (g = g || this._tag_stack.try_pop("optgroup", ["select"]))
                    : b.tag_name === "option"
                      ? (g = g || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]))
                      : b.tag_name === "colgroup"
                        ? (g = g || this._tag_stack.try_pop("caption", ["table"]))
                        : b.tag_name === "thead"
                          ? ((g = g || this._tag_stack.try_pop("caption", ["table"])), (g = g || this._tag_stack.try_pop("colgroup", ["table"])))
                          : b.tag_name === "tbody" || b.tag_name === "tfoot"
                            ? ((g = g || this._tag_stack.try_pop("caption", ["table"])),
                              (g = g || this._tag_stack.try_pop("colgroup", ["table"])),
                              (g = g || this._tag_stack.try_pop("thead", ["table"])),
                              (g = g || this._tag_stack.try_pop("tbody", ["table"])))
                            : b.tag_name === "tr"
                              ? ((g = g || this._tag_stack.try_pop("caption", ["table"])),
                                (g = g || this._tag_stack.try_pop("colgroup", ["table"])),
                                (g = g || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"])))
                              : (b.tag_name === "th" || b.tag_name === "td") &&
                                ((g = g || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])),
                                (g = g || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"])));
        ...
        function (r, s, a) {
          var l = a(9).Tokenizer,
            ...
            f = new u(/<\!--/, /-->/),
            w = function (p, x) {
              (l.call(this, p, x), (this._current_tag_name = ""));
              var T = new c(this._input).read_options(this._options),
                y = new d(this._input);
              if (
                ((this.__patterns = {
                  word: T.until(/[\n\r\t <]/),
                ...
                this.__patterns.unformatted_content_delimiter = y.matching(L).until_after(L);
              }
            };
          ((w.prototype = new l()),
            (w.prototype._is_comment = function (p) {
              return !1;
            }),
            (w.prototype._is_opening = function (p) {
              return p.type === m.TAG_OPEN || p.type === m.CONTROL_FLOW_OPEN;
            }),
            (w.prototype._is_closing = function (p, x) {
              return (
                (p.type === m.TAG_CLOSE &&
                  x &&
                  (((p.text === ">" || p.text === "/>") && x.text[0] === "<") || (p.text === "}}" && x.text[0] === "{" && x.text[1] === "{"))) ||
                (p.type === m.CONTROL_FLOW_CLOSE && p.text === "}" && x.text.endsWith("{"))
              );
            }),
            (w.prototype._reset = function () {
              this._current_tag_name = "";
            }),
            (w.prototype._get_next_token = function (p, x) {
              var T = null;
              this._readWhitespace();
              var y = this._input.peek();
              return y === null
                ? this._create_token(m.EOF, "")
                : ((T = T || this._read_open_handlebars(y, x)),
                  (T = T || this._read_attribute(y, p, x)),
                  (T = T || this._read_close(y, x)),
                  (T = T || this._read_control_flows(y, x)),
                  (T = T || this._read_raw_content(y, p, x)),
                  (T = T || this._read_content_word(y, x)),
                  (T = T || this._read_comment_or_cdata(y)),
                  (T = T || this._read_processing(y)),
                  (T = T || this._read_open(y, x)),
                  (T = T || this._create_token(m.UNKNOWN, this._input.next())),
                  T);
            }),
            (w.prototype._read_comment_or_cdata = function (p) {
              var x = null,
                T = null,
                y = null;
              if (p === "<") {
                ...
                (L === "!" &&
                  ((T = this.__patterns.comment.read()),
                  T
                    ? ((y = f.get_directives(T)), y && y.ignore === "start" && (T += f.readIgnored(this._input)))
                    : (T = this.__patterns.cdata.read())),
                  T && ((x = this._create_token(m.COMMENT, T)), (x.directives = y)));
              }
              return x;
            }),
            (w.prototype._read_processing = function (p) {
              var x = null,
                T = null,
                y = null;
              if (p === "<") {
                var L = this._input.peek(1);
                ((L === "!" || L === "?") && ((T = this.__patterns.conditional_comment.read()), (T = T || this.__patterns.processing.read())),
                  T && ((x = this._create_token(m.COMMENT, T)), (x.directives = y)));
              }
              return x;
            }),
            (w.prototype._read_open = function (p, x) {
              var T = null,
                y = null;
              return (
                (!x || x.type === m.CONTROL_FLOW_OPEN) &&
                  p === "<" &&
                  ((T = this._input.next()),
                  this._input.peek() === "/" && (T += this._input.next()),
                  (T += this.__patterns.element_name.read()),
                  (y = this._create_token(m.TAG_OPEN, T))),
                y
              );
            }),
            (w.prototype._read_open_handlebars = function (p, x) {
              var T = null,
                y = null;
              return (
                (!x || x.type === m.CONTROL_FLOW_OPEN) &&
                  ...
                  (this._input.peek(2) === "!"
                    ? ((T = this.__patterns.handlebars_comment.read()),
                      ...
                      (y = this._create_token(m.COMMENT, T)))
                    : ((T = this.__patterns.handlebars_open.read()), (y = this._create_token(m.TAG_OPEN, T)))),
                y
              );
            }),
            (w.prototype._read_control_flows = function (p, x) {
              var T = "",
                y = null;
              ...
              if (p === "@") {
                ...
                for (var L = T.endsWith("(") ? 1 : 0, I = 0; !(T.endsWith("{") && L === I); ) {
                  var H = this._input.next();
                  if (H === null) break;
                  (H === "(" ? L++ : H === ")" && I++, (T += H));
                }
                y = this._create_token(m.CONTROL_FLOW_OPEN, T);
              } else
                p === "}" && x && x.type === m.CONTROL_FLOW_OPEN && ((T = this._input.next()), (y = this._create_token(m.CONTROL_FLOW_CLOSE, T)));
              return y;
            }),
            (w.prototype._read_close = function (p, x) {
              var T = null,
                y = null;
              return (
                x &&
                  x.type === m.TAG_OPEN &&
                  (x.text[0] === "<" && (p === ">" || (p === "/" && this._input.peek(1) === ">"))
                    ? ((T = this._input.next()), p === "/" && (T += this._input.next()), (y = this._create_token(m.TAG_CLOSE, T)))
                    : x.text[0] === "{" &&
                      p === "}" &&
                      this._input.peek(1) === "}" &&
                      (this._input.next(), this._input.next(), (y = this._create_token(m.TAG_CLOSE, "}}")))),
                y
              );
            }),
            (w.prototype._read_attribute = function (p, x, T) {
              var y = null,
                L = "";
              if (T && T.text[0] === "<")
                if (p === "=") y = this._create_token(m.EQUALS, this._input.next());
                else if (p === '"' || p === "'") {
                  var I = this._input.next();
                  (p === '"' ? (I += this.__patterns.double_quote.read()) : (I += this.__patterns.single_quote.read()),
                    (y = this._create_token(m.VALUE, I)));
                } else
                  ((L = this.__patterns.attribute.read()),
                    L && (x.type === m.EQUALS ? (y = this._create_token(m.VALUE, L)) : (y = this._create_token(m.ATTRIBUTE, L))));
              return y;
            }),
            (w.prototype._is_content_unformatted = function (p) {
              return (
                this._options.void_elements.indexOf(p) === -1 &&
                (this._options.content_unformatted.indexOf(p) !== -1 || this._options.unformatted.indexOf(p) !== -1)
              );
            }),
            (w.prototype._read_raw_content = function (p, x, T) {
              var y = "";
              if (T && T.text[0] === "{") y = this.__patterns.handlebars_raw_close.read();
              else if (x.type === m.TAG_CLOSE && x.opened.text[0] === "<" && x.text[0] !== "/") {
                var L = x.opened.text.substr(1).toLowerCase();
                if (L === "script" || L === "style") {
                  var I = this._read_comment_or_cdata(p);
                  if (I) return ((I.type = m.TEXT), I);
                  y = this._input.readUntil(new RegExp("</" + L + "[\\n\\r\\t ]*?>", "ig"));
                } else this._is_content_unformatted(L) && (y = this._input.readUntil(new RegExp("</" + L + "[\\n\\r\\t ]*?>", "ig")));
              }
              return y ? this._create_token(m.TEXT, y) : null;
            }),
            (w.prototype._read_content_word = function (p, x) {
              var T = "";
              if (
                (this._options.unformatted_content_delimiter &&
                  p === this._options.unformatted_content_delimiter[0] &&
                  (T = this.__patterns.unformatted_content_delimiter.read()),
                T ||
                  (T = x && x.type === m.CONTROL_FLOW_OPEN ? this.__patterns.word_control_flow_close_excluded.read() : this.__patterns.word.read()),
                T)
              )
  ...
  function Uc(e, t, n) {
    ...
    if (t) {
      let u = e.offsetAt(t.start),
        c = u;
      for (; c > 0 && Za(i, c - 1); ) c--;
      c === 0 || Ya(i, c - 1) ? (u = c) : c < u && (u = c + 1);
      let d = e.offsetAt(t.end),
        m = d;
      for (; m < i.length && Za(i, m); ) m++;
      ((m === i.length || Ya(i, m)) && (d = m), (t = J.create(e.positionAt(u), e.positionAt(d))));
      const f = i.substring(0, u);
      if (new RegExp(/.*[<][^>]*$/).test(f)) return ((i = i.substring(u, d)), [{ range: t, newText: i }]);
      if (((r = d === i.length), (i = i.substring(u, d)), u !== 0)) {
        const w = e.offsetAt(se.create(t.start.line, 0));
        s = Fc(e.getText(), w, n);
      }
    } else t = J.create(se.create(0, 0), e.positionAt(i.length));
    const l = {
      indent_size: a,
      indent_char: n.insertSpaces ? " " : "	",
      indent_empty_lines: we(n, "indentEmptyLines", !1),
      wrap_line_length: we(n, "wrapLineLength", 120),
      unformatted: Ni(n, "unformatted", void 0),
      content_unformatted: Ni(n, "contentUnformatted", void 0),
      ...
      extra_liners: Ni(n, "extraLiners", void 0),
...
`,
    ...
    let o = Hc(Pc(i), l);
    if (s > 0) {
      const u = n.insertSpaces ? $a(" ", a * s) : $a("	", s);
      ((o = o
        .split(
          `
`,
...
`.indexOf(e.charAt(t)) !== -1
  ...
  (() => {
    var e = {
        470: (r) => {
          ...
          function a(o, u) {
            for (var c, d = "", m = 0, f = -1, w = 0, p = 0; p <= o.length; ++p) {
              ...
              if (c === 47) {
                if (!(f === p - 1 || w === 1))
                  if (f !== p - 1 && w === 2) {
                    if (d.length < 2 || m !== 2 || d.charCodeAt(d.length - 1) !== 46 || d.charCodeAt(d.length - 2) !== 46) {
                      if (d.length > 2) {
                        var x = d.lastIndexOf("/");
                        if (x !== d.length - 1) {
                          (x === -1 ? ((d = ""), (m = 0)) : (m = (d = d.slice(0, x)).length - 1 - d.lastIndexOf("/")), (f = p), (w = 0));
                          continue;
                        }
                  ...
                  } else (d.length > 0 ? (d += "/" + o.slice(f + 1, p)) : (d = o.slice(f + 1, p)), (m = p - f - 1));
                ((f = p), (w = 0));
              } else c === 46 && w !== -1 ? ++w : (w = -1);
            }
            return d;
          ...
          var l = {
            resolve: function () {
              for (var o, u = "", c = !1, d = arguments.length - 1; d >= -1 && !c; d--) {
                var m;
                (d >= 0 ? (m = arguments[d]) : (o === void 0 && (o = process.cwd()), (m = o)),
                  s(m),
                  m.length !== 0 && ((u = m + "/" + u), (c = m.charCodeAt(0) === 47)));
              }
            ...
            relative: function (o, u) {
              ...
              for (var d = o.length, m = d - c, f = 1; f < u.length && u.charCodeAt(f) === 47; ++f);
              for (var w = u.length - f, p = m < w ? m : w, x = -1, T = 0; T <= p; ++T) {
                if (T === p) {
                  if (w > p) {
                    if (u.charCodeAt(f + T) === 47) return u.slice(f + T + 1);
                    if (T === 0) return u.slice(f + T);
                  } else m > p && (o.charCodeAt(c + T) === 47 ? (x = T) : T === 0 && (x = 0));
                  break;
                }
                var y = o.charCodeAt(c + T);
                if (y !== u.charCodeAt(f + T)) break;
                y === 47 && (x = T);
              }
              var L = "";
              for (T = c + x + 1; T <= d; ++T) (T !== d && o.charCodeAt(T) !== 47) || (L.length === 0 ? (L += "..") : (L += "/.."));
              return L.length > 0 ? L + u.slice(f + x) : ((f += x), u.charCodeAt(f) === 47 && ++f, u.slice(f));
            },
            ...
            dirname: function (o) {
              if ((s(o), o.length === 0)) return ".";
              for (var u = o.charCodeAt(0), c = u === 47, d = -1, m = !0, f = o.length - 1; f >= 1; --f)
                if ((u = o.charCodeAt(f)) === 47) {
                  if (!m) {
                    d = f;
                    break;
                  }
            ...
            basename: function (o, u) {
              ...
              if (u !== void 0 && u.length > 0 && u.length <= o.length) {
                ...
                for (c = o.length - 1; c >= 0; --c) {
                  ...
                  } else (p === -1 && ((f = !1), (p = c + 1)), w >= 0 && (x === u.charCodeAt(w) ? --w == -1 && (m = c) : ((w = -1), (m = p))));
                }
            ...
            extname: function (o) {
              s(o);
              for (var u = -1, c = 0, d = -1, m = !0, f = 0, w = o.length - 1; w >= 0; --w) {
                var p = o.charCodeAt(w);
                if (p !== 47) (d === -1 && ((m = !1), (d = w + 1)), p === 46 ? (u === -1 ? (u = w) : f !== 1 && (f = 1)) : u !== -1 && (f = -1));
                else if (!m) {
                  c = w + 1;
                  break;
                }
              }
              return u === -1 || d === -1 || f === 0 || (f === 1 && u === d - 1 && u === c + 1) ? "" : o.slice(u, d);
            },
            format: function (o) {
            ...
            parse: function (o) {
              ...
              var c,
                ...
                m = d === 47;
              m ? ((u.root = "/"), (c = 1)) : (c = 0);
              for (var f = -1, w = 0, p = -1, x = !0, T = o.length - 1, y = 0; T >= c; --T)
                if ((d = o.charCodeAt(T)) !== 47)
                  (p === -1 && ((x = !1), (p = T + 1)), d === 46 ? (f === -1 ? (f = T) : y !== 1 && (y = 1)) : f !== -1 && (y = -1));
                else if (!x) {
                  w = T + 1;
                  break;
                }
              return (
                f === -1 || p === -1 || y === 0 || (y === 1 && f === p - 1 && f === w + 1)
                  ? p !== -1 && (u.base = u.name = w === 0 && m ? o.slice(1, p) : o.slice(w, p))
                  : (w === 0 && m ? ((u.name = o.slice(1, f)), (u.base = o.slice(1, p))) : ((u.name = o.slice(w, f)), (u.base = o.slice(w, p))),
                    (u.ext = o.slice(f, p))),
                w > 0 ? (u.dir = o.slice(0, w - 1)) : m && (u.dir = "/"),
                u
              );
            },
            sep: "/",
    ...
    ((n.d = (r, s) => {
      for (var a in s) n.o(s, a) && !n.o(r, a) && Object.defineProperty(r, a, { enumerable: !0, get: s[a] });
    }),
    ...
    ((() => {
      ...
      (n.r(i),
        ...
        typeof process == "object"
          ...
          : typeof navigator == "object" && (r = navigator.userAgent.indexOf("Windows") >= 0));
      const s = /^\w[\w\d+.-]*$/,
        a = /^\//,
        l = /^\/\//;
      function o(S, v) {
      ...
      class m {
        constructor(v, A, D, k, E, M = !1) {
          ...
          Qe(this, "fragment");
          typeof v == "object"
            ? ((this.scheme = v.scheme || u),
              (this.authority = v.authority || u),
              (this.path = v.path || u),
              (this.query = v.query || u),
              (this.fragment = v.fragment || u))
            : ((this.scheme = (function (W, F) {
                return W || F ? W : "file";
              })(v, M)),
              (this.authority = A || u),
              (this.path = (function (W, F) {
                switch (W) {
                  case "https":
                  case "http":
                  case "file":
        ...
        with(v) {
          if (!v) return this;
          let { scheme: A, authority: D, path: k, query: E, fragment: M } = v;
          return (
            A === void 0 ? (A = this.scheme) : A === null && (A = u),
            D === void 0 ? (D = this.authority) : D === null && (D = u),
            k === void 0 ? (k = this.path) : k === null && (k = u),
            E === void 0 ? (E = this.query) : E === null && (E = u),
            M === void 0 ? (M = this.fragment) : M === null && (M = u),
            A === this.scheme && D === this.authority && k === this.path && E === this.query && M === this.fragment ? this : new w(A, D, k, E, M)
          );
        }
        static parse(v, A = !1) {
          const D = d.exec(v);
          return D ? new w(D[2] || u, P(D[4] || u), P(D[5] || u), P(D[7] || u), P(D[9] || u), A) : new w(u, u, u, u, u);
        }
        static file(v) {
          let A = u;
          if ((r && (v = v.replace(/\\/g, c)), v[0] === c && v[1] === c)) {
            const D = v.indexOf(c, 2);
            D === -1 ? ((A = v.substring(2)), (v = c)) : ((A = v.substring(2, D)), (v = v.substring(D) || c));
          }
          return new w("file", A, v, u, u);
        }
        static from(v) {
          const A = new w(v.scheme, v.authority, v.path, v.query, v.fragment);
          return (o(A, !0), A);
        }
        toString(v = !1) {
          return L(this, v);
        ...
        static revive(v) {
          if (v) {
            if (v instanceof m) return v;
            {
              const A = new w(v);
              return ((A._formatted = v.external), (A._fsPath = v._sep === f ? v.fsPath : null), A);
            }
          }
          return v;
        }
      ...
      class w extends m {
        ...
        toString(A = !1) {
          return A ? L(this, !0) : (this._formatted || (this._formatted = L(this, !1)), this._formatted);
        }
        toJSON() {
          const A = { $mid: 1 };
          return (
            this._fsPath && ((A.fsPath = this._fsPath), (A._sep = f)),
      ...
      function x(S, v, A) {
        ...
        for (let E = 0; E < S.length; E++) {
          ...
          if (
            ...
            (k !== -1 && ((D += encodeURIComponent(S.substring(k, E))), (k = -1)), D !== void 0 && (D += S.charAt(E)));
          else {
            D === void 0 && (D = S.substr(0, E));
            const W = p[M];
            W !== void 0 ? (k !== -1 && ((D += encodeURIComponent(S.substring(k, E))), (k = -1)), (D += W)) : k === -1 && (k = E);
          }
        }
        return (k !== -1 && (D += encodeURIComponent(S.substring(k))), D !== void 0 ? D : S);
      }
      function T(S) {
        let v;
        for (let A = 0; A < S.length; A++) {
          const D = S.charCodeAt(A);
          D === 35 || D === 63 ? (v === void 0 && (v = S.substr(0, A)), (v += p[D])) : v !== void 0 && (v += S[A]);
        }
        return v !== void 0 ? v : S;
      }
      function y(S, v) {
          ...
          (A =
            S.authority && S.path.length > 1 && S.scheme === "file"
              ...
              : S.path.charCodeAt(0) === 47 &&
                  ((S.path.charCodeAt(1) >= 65 && S.path.charCodeAt(1) <= 90) || (S.path.charCodeAt(1) >= 97 && S.path.charCodeAt(1) <= 122)) &&
      ...
      function L(S, v) {
        const A = v ? T : x;
        let D = "",
          { scheme: k, authority: E, path: M, query: W, fragment: F } = S;
        if ((k && ((D += k), (D += ":")), (E || k === "file") && ((D += c), (D += c)), E)) {
          let U = E.indexOf("@");
          if (U !== -1) {
            const O = E.substr(0, U);
            ((E = E.substr(U + 1)),
              (U = O.lastIndexOf(":")),
              U === -1 ? (D += A(O, !1, !1)) : ((D += A(O.substr(0, U), !1, !1)), (D += ":"), (D += A(O.substr(U + 1), !1, !0))),
              (D += "@"));
          }
          ((E = E.toLowerCase()), (U = E.lastIndexOf(":")), U === -1 ? (D += A(E, !1, !0)) : ((D += A(E.substr(0, U), !1, !0)), (D += E.substr(U))));
        }
        if (M) {
          if (M.length >= 3 && M.charCodeAt(0) === 47 && M.charCodeAt(2) === 58) {
            const U = M.charCodeAt(1);
            U >= 65 && U <= 90 && (M = `/${String.fromCharCode(U + 32)}:${M.substr(3)}`);
          } else if (M.length >= 2 && M.charCodeAt(1) === 58) {
            const U = M.charCodeAt(0);
            U >= 65 && U <= 90 && (M = `${String.fromCharCode(U + 32)}:${M.substr(2)}`);
          }
          D += A(M, !0, !1);
        }
        return (W && ((D += "?"), (D += A(W, !1, !1))), F && ((D += "#"), (D += v ? F : x(F, !1, !1))), D);
      }
      function I(S) {
        try {
      ...
      function P(S) {
        return S.match(H) ? S.replace(H, (v) => I(v)) : S;
      }
      var b = n(470);
      const g = b.posix || b,
        _ = "/";
      var N;
      (function (S) {
        ((S.joinPath = function (v, ...A) {
          return v.with({ path: g.join(v.path, ...A) });
        }),
          (S.resolvePath = function (v, ...A) {
            let D = v.path,
              k = !1;
            D[0] !== _ && ((D = _ + D), (k = !0));
            let E = g.resolve(D, ...A);
            return (k && E[0] === _ && !v.authority && (E = E.substring(1)), v.with({ path: E }));
          }),
          (S.dirname = function (v) {
            if (v.path.length === 0 || v.path === _) return v;
            let A = g.dirname(v.path);
            return (A.length === 1 && A.charCodeAt(0) === 46 && (A = ""), v.with({ path: A }));
          }),
          (S.basename = function (v) {
            return g.basename(v.path);
          }),
          (S.extname = function (v) {
            return g.extname(v.path);
          }));
      })(N || (N = {}));
    })(),
      (Ka = i));
  })();
  const { URI: Bc, Utils: gh } = Ka;
  function Ii(e) {
    const t = e[0],
      n = e[e.length - 1];
  ...
  function Oc(e, t, n, i) {
    ...
    return /^\#/i.test(t)
      ? e + t
      : /^\/\//i.test(t)
        ? (Je(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "")
        : n
  ...
  function Vc(e, t, n, i, r, s) {
    const a = Ii(n);
    if (!qc(a, e.languageId)) return;
    a.length < n.length && (i++, r--);
    const l = Oc(e.uri, a, t, s);
    if (!l) return;
    const o = $c(l, e);
    return { range: J.create(e.positionAt(i), e.positionAt(r)), target: o };
  }
  const jc = 35;
  function $c(e, t) {
    try {
      let n = Bc.parse(e);
      return (
        n.scheme === "file" && n.query && ((n = n.with({ query: null })), (e = n.toString(!0))),
        n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === jc) ? n.with({ fragment: null }).toString(!0) : e
      );
    } catch {
      return;
    }
  ...
  class Gc {
    ...
    findDocumentLinks(t, n) {
      ...
      for (; s !== z.EOS; ) {
        switch (s) {
          case z.StartTag:
            ((l = r.getTokenText().toLowerCase()), u || (o = l === "base"));
            break;
          case z.AttributeName:
            a = r.getTokenText().toLowerCase();
            break;
          case z.AttributeValue:
            if (l && a && this.dataManager.isPathAttribute(l, a)) {
              const d = r.getTokenText();
              if (!o) {
                const m = Vc(t, n, d, r.getTokenOffset(), r.getTokenEnd(), u);
                m && i.push(m);
              }
              (o && typeof u > "u" && ((u = Ii(d)), u && n && (u = n.resolveReference(u, t.uri))), (o = !1), (a = void 0));
            } else if (a === "id") {
              const d = Ii(r.getTokenText());
              c[d] = r.getTokenOffset();
            }
            break;
        }
        s = r.scan();
      ...
      for (const d of i) {
        const m = t.uri + "#";
        if (d.target && Je(d.target, m)) {
          const f = d.target.substring(m.length),
            w = c[f];
          if (w !== void 0) {
            const p = t.positionAt(w);
            d.target = `${m}${p.line + 1},${p.character + 1}`;
          } else d.target = t.uri;
        }
      }
      return i;
  ...
  function Xc(e, t, n) {
    ...
    if (!r.tag) return [];
    const s = [],
      a = no(z.StartTag, e, r.start),
      l = typeof r.endTagStart == "number" && no(z.EndTag, e, r.endTagStart);
    return (((a && to(a, t)) || (l && to(l, t))) && (a && s.push({ kind: gn.Read, range: a }), l && s.push({ kind: gn.Read, range: l })), s);
  }
  function eo(e, t) {
    return e.line < t.line || (e.line === t.line && e.character <= t.character);
  }
  function to(e, t) {
    return eo(e.start, t) && eo(t, e.end);
  }
  function no(e, t, n) {
    const i = be(t.getText(), n);
    let r = i.scan();
  ...
  function Jc(e, t) {
    ...
    return n;
    function r(s, a) {
      const l = Si.create(s.name, s.kind, s.range, e.uri, a == null ? void 0 : a.name);
      if ((l.containerName ?? (l.containerName = ""), n.push(l), s.children)) for (const o of s.children) r(o, s);
    }
  }
  function io(e, t) {
    const n = [];
  ...
  function ro(e, t, n) {
    const i = Qc(t),
      r = J.create(e.positionAt(t.start), e.positionAt(t.end)),
      s = Ai.create(i, void 0, ki.Field, r, r);
    (n.push(s),
      t.children.forEach((a) => {
        (s.children ?? (s.children = []), ro(e, a, s.children));
      }));
  }
  function Qc(e) {
    let t = e.tag;
  ...
  function Yc(e, t, n, i) {
    const r = e.offsetAt(t),
      s = i.findNodeAt(r);
    if (!s.tag || !Zc(s, r, s.tag)) return null;
    const a = [],
      l = { start: e.positionAt(s.start + 1), end: e.positionAt(s.start + 1 + s.tag.length) };
    if ((a.push({ range: l, newText: n }), s.endTagStart)) {
      const u = { start: e.positionAt(s.endTagStart + 2), end: e.positionAt(s.endTagStart + 2 + s.tag.length) };
      a.push({ range: u, newText: n });
    }
    return { changes: { [e.uri.toString()]: a } };
  }
  function Zc(e, t, n) {
  ...
  function so(e, t, n) {
    ...
    return r.endTagStart && ((r.start + 1 <= i && i <= r.start + 1 + s) || (r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + s))
      ? [
          J.create(e.positionAt(r.start + 1), e.positionAt(r.start + 1 + s)),
          J.create(e.positionAt(r.endTagStart + 2), e.positionAt(r.endTagStart + 2 + s)),
        ]
      : null;
  }
  class eh {
    ...
    limitRanges(t, n) {
      t = t.sort((d, m) => {
        let f = d.startLine - m.startLine;
        return (f === 0 && (f = d.endLine - m.endLine), f);
      });
      let i;
      const r = [],
        s = [],
        a = [],
        l = (d, m) => {
          ((s[d] = m), m < 30 && (a[m] = (a[m] || 0) + 1));
        };
      for (let d = 0; d < t.length; d++) {
        const m = t[d];
        if (!i) ((i = m), l(d, 0));
        else if (m.startLine > i.startLine) {
          if (m.endLine <= i.endLine) (r.push(i), (i = m), l(d, r.length));
          else if (m.startLine > i.endLine) {
            do i = r.pop();
            while (i && m.startLine > i.endLine);
            (i && r.push(i), (i = m), l(d, r.length));
          }
        }
      }
      let o = 0,
      ...
      for (let d = 0; d < t.length; d++) {
        const m = s[d];
        typeof m == "number" && (m < u || (m === u && o++ < n)) && c.push(t[d]);
      }
      return c;
    }
    getFoldingRanges(t, n) {
      const i = this.dataManager.getVoidElements(t.languageId),
        r = be(t.getText());
      let s = r.scan();
      const a = [],
        l = [];
      let o = null,
        u = -1;
      function c(m) {
        (a.push(m), (u = m.startLine));
      }
      for (; s !== z.EOS; ) {
        switch (s) {
          case z.StartTag: {
            const m = r.getTokenText(),
              f = t.positionAt(r.getTokenOffset()).line;
            (l.push({ startLine: f, tagName: m }), (o = m));
            break;
          }
          case z.EndTag: {
            o = r.getTokenText();
          ...
          case z.StartTagClose:
            if (!o || !this.dataManager.isVoidElement(o, i)) break;
          case z.EndTagClose:
          case z.StartTagSelfClose: {
            let m = l.length - 1;
            for (; m >= 0 && l[m].tagName !== o; ) m--;
            if (m >= 0) {
              const f = l[m];
              l.length = m;
              const w = t.positionAt(r.getTokenOffset()).line,
                p = f.startLine,
                x = w - 1;
              x > p && u !== p && c({ startLine: p, endLine: x });
            }
            break;
          }
          case z.Comment: {
            let m = t.positionAt(r.getTokenOffset()).line;
            const w = r.getTokenText().match(/^\s*#(region\b)|(endregion\b)/);
            if (w)
              if (w[1]) l.push({ startLine: m, tagName: "" });
              else {
                let p = l.length - 1;
                for (; p >= 0 && l[p].tagName.length; ) p--;
                if (p >= 0) {
                  const x = l[p];
                  l.length = p;
                  const T = m;
                  ((m = x.startLine), T > m && u !== m && c({ startLine: m, endLine: T, kind: mn.Region }));
                }
              }
            else {
              const p = t.positionAt(r.getTokenOffset() + r.getTokenLength()).line;
              m < p && c({ startLine: m, endLine: p, kind: mn.Comment });
            }
            break;
          }
        }
      ...
      const d = (n && n.rangeLimit) || Number.MAX_VALUE;
      return a.length > d ? this.limitRanges(a, d) : a;
    }
  }
  class th {
    constructor(t) {
    ...
    getSelectionRanges(t, n) {
      const i = this.htmlParser.parseDocument(t);
      return n.map((r) => this.getSelectionRange(r, t, i));
    }
    getSelectionRange(t, n, i) {
      const r = this.getApplicableRanges(n, t, i);
      let s, a;
      for (let l = r.length - 1; l >= 0; l--) {
        const o = r[l];
        ((!s || o[0] !== s[0] || o[1] !== s[1]) && (a = wn.create(J.create(n.positionAt(r[l][0]), n.positionAt(r[l][1])), a)), (s = o));
      }
      return (a || (a = wn.create(J.create(t, t))), a);
    }
    getApplicableRanges(t, n, i) {
      const r = t.offsetAt(n),
        s = i.findNodeAt(r);
      let a = this.getAllParentTagRanges(s);
      if (s.startTagEnd && !s.endTagStart) {
        if (s.startTagEnd !== s.end) return [[s.start, s.end]];
        const l = J.create(t.positionAt(s.startTagEnd - 2), t.positionAt(s.startTagEnd));
        return (
          t.getText(l) === "/>" ? a.unshift([s.start + 1, s.startTagEnd - 2]) : a.unshift([s.start + 1, s.startTagEnd - 1]),
          (a = this.getAttributeLevelRanges(t, s, r).concat(a)),
          a
        );
      }
      return !s.startTagEnd || !s.endTagStart
        ? a
        : (a.unshift([s.start, s.end]),
          s.start < r && r < s.startTagEnd
            ? (a.unshift([s.start + 1, s.startTagEnd - 1]), (a = this.getAttributeLevelRanges(t, s, r).concat(a)), a)
            : s.startTagEnd <= r && r <= s.endTagStart
              ? (a.unshift([s.startTagEnd, s.endTagStart]), a)
              : (r >= s.endTagStart + 2 && a.unshift([s.endTagStart + 2, s.end - 1]), a));
    }
    getAllParentTagRanges(t) {
      let n = t;
      const i = [];
      for (; n.parent; ) ((n = n.parent), this.getNodeRanges(n).forEach((r) => i.push(r)));
      return i;
    }
    getNodeRanges(t) {
      return t.startTagEnd && t.endTagStart && t.startTagEnd < t.endTagStart
        ? [
            [t.startTagEnd, t.endTagStart],
            [t.start, t.end],
          ]
        : [[t.start, t.end]];
    }
    getAttributeLevelRanges(t, n, i) {
      const r = J.create(t.positionAt(n.start), t.positionAt(n.end)),
        s = t.getText(r),
        a = i - n.start,
        l = be(s);
      let o = l.scan();
      ...
      for (; o !== z.EOS; ) {
        switch (o) {
          case z.AttributeName: {
            if (a < l.getTokenOffset()) {
              d = !1;
              break;
            }
            (a <= l.getTokenEnd() && c.unshift([l.getTokenOffset(), l.getTokenEnd()]), (d = !0), (m = l.getTokenOffset()));
            break;
          }
          case z.AttributeValue: {
            if (!d) break;
            const f = l.getTokenText();
            if (a < l.getTokenOffset()) {
              c.push([m, l.getTokenEnd()]);
              break;
            }
            a >= l.getTokenOffset() &&
              a <= l.getTokenEnd() &&
              (c.unshift([l.getTokenOffset(), l.getTokenEnd()]),
              ((f[0] === '"' && f[f.length - 1] === '"') || (f[0] === "'" && f[f.length - 1] === "'")) &&
                a >= l.getTokenOffset() + 1 &&
                a <= l.getTokenEnd() - 1 &&
                c.unshift([l.getTokenOffset() + 1, l.getTokenEnd() - 1]),
              c.push([m, l.getTokenEnd()]));
            break;
          }
        }
  ...
  const nh = {
    ...
    tags: [
      ...
      {
        name: "head",
        description: { kind: "markdown", value: "The head element represents a collection of metadata for the Document." },
      ...
      {
        name: "link",
        description: { kind: "markdown", value: "The link element allows authors to link their document to other resources." },
        void: !0,
        attributes: [
          {
            name: "href",
...
*   \`viewport\`, which gives hints about the size of the initial size of the [viewport](https://developer.mozilla.org/en-US/docs/Glossary/viewport "viewport: A viewport represents a polygonal (normally rectangular) area in computer graphics that is currently being viewed. In web browser terms, it refers to the part of the document you're viewing which is currently visible in its window (or the screen, if the document is being viewed in full screen mode). Content outside the viewport is not visible onscreen until scrolled into view."). Used by mobile devices only.
    ...
    *   To learn about this declaration in Firefox for Mobile, see [this article](https://developer.mozilla.org/en-US/docs/Mobile/Viewport_meta_tag "Mobile/Viewport meta tag").`,
      ...
      },
      {
        ...
        attributes: [
          { name: "onafterprint", description: { kind: "markdown", value: "Function to call after the user has printed the document." } },
          { name: "onbeforeprint", description: { kind: "markdown", value: "Function to call when the user requests printing of the document." } },
          { name: "onbeforeunload", description: { kind: "markdown", value: "Function to call when the document is about to be unloaded." } },
          {
            name: "onhashchange",
            description: {
              kind: "markdown",
          ...
          { name: "onlanguagechange", description: { kind: "markdown", value: "Function to call when the preferred languages changed." } },
          { name: "onmessage", description: { kind: "markdown", value: "Function to call when the document has received a message." } },
          { name: "onoffline", description: { kind: "markdown", value: "Function to call when network communication has failed." } },
          { name: "ononline", description: { kind: "markdown", value: "Function to call when network communication has been restored." } },
          { name: "onpagehide" },
          { name: "onpageshow" },
          { name: "onpopstate", description: { kind: "markdown", value: "Function to call when the user has navigated session history." } },
          { name: "onstorage", description: { kind: "markdown", value: "Function to call when the storage area has changed." } },
          { name: "onunload", description: { kind: "markdown", value: "Function to call when the document is going away." } },
          {
            name: "alink",
            description:
      ...
      },
      {
        ...
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/Heading_Elements" }],
      },
      {
        name: "h2",
      ...
      },
      {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/blockquote" }],
      },
      {
        name: "ol",
        description: {
        ...
        attributes: [
          {
            name: "reversed",
            valueSet: "v",
            description: { kind: "markdown", value: "This Boolean attribute specifies that the items of the list are specified in reversed order." },
          },
          {
            name: "start",
            description: {
      ...
      },
      {
        ...
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/figcaption" }],
      },
      {
        name: "main",
        description: {
      ...
      {
        name: "strong",
        description: { kind: "markdown", value: "The strong element represents strong importance, seriousness, or urgency for its contents." },
        attributes: [],
      ...
      {
        name: "s",
        description: { kind: "markdown", value: "The s element represents contents that are no longer accurate or no longer relevant." },
        attributes: [],
      ...
      {
        name: "q",
        description: { kind: "markdown", value: "The q element represents some phrasing content quoted from another source." },
        attributes: [
          {
            name: "cite",
            description: {
      ...
      {
        name: "samp",
        description: { kind: "markdown", value: "The samp element represents sample or quoted output from another program or computing system." },
        attributes: [],
      ...
      },
      {
        ...
        attributes: [
          { name: "cite", description: { kind: "markdown", value: "A URI for a resource that explains the change (for example, meeting minutes)." } },
          {
            name: "datetime",
            description: {
              kind: "markdown",
      ...
      },
      {
        ...
        attributes: [
          ...
          { name: "width", description: { kind: "markdown", value: "The intrinsic width of the image in pixels." } },
          { name: "height", description: { kind: "markdown", value: "The intrinsic height of the image in pixels." } },
          {
            name: "decoding",
            valueSet: "decoding",
            description: {
...
Default mode, which indicates no preference for the decoding mode. The browser decides what is best for the user.`,
          ...
          { name: "loading", valueSet: "loading", description: { kind: "markdown", value: "Indicates how the browser should load the image." } },
          {
            name: "referrerpolicy",
      ...
      },
      {
        ...
        attributes: [
          ...
          { name: "width", description: { kind: "markdown", value: "The width of the frame in CSS pixels. Default is `300`." } },
          { name: "height", description: { kind: "markdown", value: "The height of the frame in CSS pixels. Default is `150`." } },
          {
            name: "allow",
...
The resource should be downloaded after other higher-priority page resources.`,
      ...
      },
      {
        ...
        void: !0,
        attributes: [
          { name: "src", description: { kind: "markdown", value: "The URL of the resource being embedded." } },
          { name: "type", description: { kind: "markdown", value: "The MIME type to use to select the plug-in to instantiate." } },
          {
            name: "width",
            description: {
              kind: "markdown",
      ...
      },
      {
        ...
        attributes: [
          ...
          {
            name: "name",
            description: { kind: "markdown", value: "The name of valid browsing context (HTML5), or the name of the control (HTML 4)." },
          },
          {
            name: "usemap",
            description: {
...
*   object: An ID of another [\`<object>\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/object "The HTML <object> element represents an external resource, which can be treated as an image, a nested browsing context, or a resource to be handled by a plugin.") in the same document.`,
      ...
      {
        name: "video",
        description: { kind: "markdown", value: "A video element is used for playing videos or movies, and audio files with captions." },
        attributes: [
          { name: "src" },
...
**Note**: Sites that automatically play audio (or videos with an audio track) can be an unpleasant experience for users, so should be avoided when possible. If you must offer autoplay functionality, you should make it opt-in (requiring a user to specifically enable it). However, this can be useful when creating media elements whose source will be set at a later time, under user control.`,
      ...
      {
        name: "table",
        description: { kind: "markdown", value: "The table element represents data with more than one dimension, in the form of a table." },
        attributes: [
          { name: "border" },
          {
            name: "align",
...
**Usage note:** Do not use this attribute, as it has been deprecated. The [\`<caption>\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/caption "The HTML Table Caption element (<caption>) specifies the caption (or title) of a table, and if used is always the first child of a <table>.") element should be styled using the [CSS](https://developer.mozilla.org/en-US/docs/CSS) properties [\`caption-side\`](https://developer.mozilla.org/en-US/docs/Web/CSS/caption-side "The caption-side CSS property puts the content of a table's <caption> on the specified side. The values are relative to the writing-mode of the table.") and [\`text-align\`](https://developer.mozilla.org/en-US/docs/Web/CSS/text-align "The text-align CSS property sets the horizontal alignment of an inline or table-cell box. This means it works like vertical-align but in the horizontal direction.").`,
      ...
      },
      {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/colgroup" }],
      },
      {
        name: "col",
        description: {
...
**Note:** Do not use this attribute, as it is non-standard and only implemented in some versions of Microsoft Internet Explorer: The [\`<th>\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/th "The HTML <th> element defines a cell as header of a group of table cells. The exact nature of this group is defined by the scope and headers attributes.") element should be styled using [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS). To create a similar effect use the [\`background-color\`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-color "The background-color CSS property sets the background color of an element.") property in [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS) instead.`,
      ...
      },
      {
        ...
        attributes: [
          ...
          { name: "name", description: { kind: "markdown", value: "The name of the button, which is submitted with the form data." } },
          {
            name: "type",
            valueSet: "bt",
            description: {
      ...
      {
        name: "select",
        description: { kind: "markdown", value: "The select element represents a control for selecting amongst a set of options." },
        attributes: [
          {
            name: "autocomplete",
          ...
          { name: "name", description: { kind: "markdown", value: "This attribute is used to specify the name of the control." } },
          {
            name: "required",
            valueSet: "v",
            description: { kind: "markdown", value: "A Boolean attribute indicating that an option with a non-empty string value must be selected." },
          },
          {
            name: "size",
            description: {
      ...
      },
      {
        ...
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/datalist" }],
      },
      {
        name: "optgroup",
        description: { kind: "markdown", value: "The optgroup element represents a group of option elements with a common label." },
        attributes: [
          {
            name: "disabled",
            valueSet: "v",
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/optgroup" }],
      },
      {
        name: "option",
        description: {
      ...
      },
      {
        ...
        attributes: [
          ...
          {
            name: "minlength",
            description: { kind: "markdown", value: "The minimum number of characters (unicode code points) required that the user should enter." },
          },
          ...
          },
          {
            name: "required",
            valueSet: "v",
            description: { kind: "markdown", value: "This attribute specifies that the user must fill in a value before submitting a form." },
          },
          { name: "rows", description: { kind: "markdown", value: "The number of visible text lines for the control." } },
          {
            name: "wrap",
            valueSet: "w",
            description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/textarea" }],
      },
      {
        name: "output",
        description: {
      ...
      },
      {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/progress" }],
      },
      {
        name: "meter",
        description: {
      ...
      {
        name: "fieldset",
        description: { kind: "markdown", value: "The fieldset element represents a set of form controls optionally grouped under a common name." },
        attributes: [
          {
            name: "disabled",
            valueSet: "v",
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/fieldset" }],
      },
      {
        name: "legend",
        description: {
...
See [Browser compatibility](#Browser_compatibility) for notes on browser support. See also [Async scripts for asm.js](https://developer.mozilla.org/en-US/docs/Games/Techniques/Async_scripts).`,
      ...
      },
      {
        ...
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/noscript" }],
      },
      {
        name: "template",
        description: {
        ...
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/template" }],
      },
      {
        name: "canvas",
        description: {
        ...
        attributes: [
          { name: "width", description: { kind: "markdown", value: "The width of the coordinate space in CSS pixels. Defaults to 300." } },
          { name: "height", description: { kind: "markdown", value: "The height of the coordinate space in CSS pixels. Defaults to 150." } },
          {
            name: "moz-opaque",
            description:
      ...
      },
      {
        ...
        attributes: [
          {
            name: "name",
            description: { kind: "markdown", value: "The slot's name.\nA **named slot** is a `<slot>` element with a `name` attribute." },
          },
        ],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/slot" }],
      },
      {
        name: "data",
        description: { kind: "markdown", value: "The data element links a given piece of content with a machine-readable translation." },
        attributes: [
          {
            name: "value",
            description: { kind: "markdown", value: "This attribute specifies the machine-readable translation of the content of the element." },
          },
        ],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/data" }],
      },
      {
        name: "hgroup",
        description: {
        ...
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/hgroup" }],
      },
      {
        name: "menu",
        description: { kind: "markdown", value: "The menu element represents an unordered list of interactive items." },
        attributes: [],
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Element/menu" }],
      },
    ],
    globalAttributes: [
      {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/accesskey" }],
      },
      {
        name: "autocapitalize",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/autocapitalize" }],
      },
      {
        name: "class",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/class" }],
      },
      {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/contenteditable" }],
      },
      {
        name: "contextmenu",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/contextmenu" }],
      },
      {
        name: "dir",
        description: {
        ...
        valueSet: "d",
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/dir" }],
      },
      {
        name: "draggable",
        description: {
        ...
        valueSet: "b",
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/draggable" }],
      },
      {
        name: "dropzone",
        description: {
      ...
      {
        name: "exportparts",
        description: { kind: "markdown", value: "Used to transitively export shadow parts from a nested shadow tree into a containing light tree." },
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/exportparts" }],
      },
      {
        name: "hidden",
        description: {
        ...
        valueSet: "v",
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/hidden" }],
      },
      {
        name: "id",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/id" }],
      },
      {
        name: "inputmode",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/inputmode" }],
      },
      {
        name: "is",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/is" }],
      },
      {
        name: "itemid",
        description: { kind: "markdown", value: "The unique, global identifier of an item." },
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/itemid" }],
      },
      {
        name: "itemprop",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/itemprop" }],
      },
      {
        name: "itemref",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/itemref" }],
      },
      {
        name: "itemscope",
        description: {
        ...
        valueSet: "v",
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/itemscope" }],
      },
      {
        name: "itemtype",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/itemtype" }],
      },
      {
        name: "lang",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/lang" }],
      },
      {
        name: "part",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/part" }],
      },
      { name: "role", valueSet: "roles" },
      {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/slot" }],
      },
      {
        name: "spellcheck",
        description: {
        ...
        valueSet: "b",
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/spellcheck" }],
      },
      {
        name: "style",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/style" }],
      },
      {
        name: "tabindex",
        description: {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/tabindex" }],
      },
      {
        name: "title",
        description: {
        ...
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/title" }],
      },
      {
        name: "translate",
        description: {
        ...
        valueSet: "y",
        references: [{ name: "MDN Reference", url: "https://developer.mozilla.org/docs/Web/HTML/Global_attributes/translate" }],
      },
      ...
      { name: "onclick", description: { kind: "markdown", value: "A pointing device button has been pressed and released on an element." } },
      {
        name: "oncontextmenu",
        description: { kind: "markdown", value: "The right button of the mouse is clicked (before the context menu is displayed)." },
      },
      { name: "ondblclick", description: { kind: "markdown", value: "A pointing device button is clicked twice on an element." } },
      { name: "ondrag", description: { kind: "markdown", value: "An element or text selection is being dragged (every 350ms)." } },
      {
        name: "ondragend",
        description: { kind: "markdown", value: "A drag operation is being ended (by releasing a mouse button or hitting the escape key)." },
      },
      { name: "ondragenter", description: { kind: "markdown", value: "A dragged element or text selection enters a valid drop target." } },
      { name: "ondragleave", description: { kind: "markdown", value: "A dragged element or text selection leaves a valid drop target." } },
      {
        name: "ondragover",
        description: { kind: "markdown", value: "An element or text selection is being dragged over a valid drop target (every 350ms)." },
      },
      { name: "ondragstart", description: { kind: "markdown", value: "The user starts dragging an element or text selection." } },
      { name: "ondrop", description: { kind: "markdown", value: "An element is dropped on a valid drop target." } },
      { name: "ondurationchange", description: { kind: "markdown", value: "The duration attribute has been updated." } },
      {
        name: "onemptied",
        description: {
          kind: "markdown",
      ...
      { name: "onended", description: { kind: "markdown", value: "Playback has stopped because the end of the media was reached." } },
      { name: "onerror", description: { kind: "markdown", value: "A resource failed to load." } },
      { name: "onfocus", description: { kind: "markdown", value: "An element has received focus (does not bubble)." } },
      { name: "onformchange" },
      { name: "onforminput" },
      {
        name: "oninput",
      ...
      { name: "oninvalid", description: { kind: "markdown", value: "A submittable element has been checked and doesn't satisfy its constraints." } },
      { name: "onkeydown", description: { kind: "markdown", value: "A key is pressed down." } },
      {
        name: "onkeypress",
        description: { kind: "markdown", value: "A key is pressed down and that key normally produces a character value (use input instead)." },
      },
      { name: "onkeyup", description: { kind: "markdown", value: "A key is released." } },
      { name: "onload", description: { kind: "markdown", value: "A resource and its dependent resources have finished loading." } },
      { name: "onloadeddata", description: { kind: "markdown", value: "The first frame of the media has finished loading." } },
      ...
      { name: "onmousedown", description: { kind: "markdown", value: "A pointing device button (usually a mouse) is pressed on an element." } },
      { name: "onmousemove", description: { kind: "markdown", value: "A pointing device is moved over an element." } },
      {
        name: "onmouseout",
        description: {
          kind: "markdown",
      ...
      { name: "onmouseup", description: { kind: "markdown", value: "A pointing device button is released over an element." } },
      { name: "onmousewheel" },
      {
        name: "onmouseenter",
        description: { kind: "markdown", value: "A pointing device is moved onto the element that has the listener attached." },
      },
      {
        name: "onmouseleave",
      ...
      {
        name: "onplaying",
        description: { kind: "markdown", value: "Playback is ready to start after having been paused or delayed due to lack of data." },
      },
      ...
      { name: "onreadystatechange", description: { kind: "markdown", value: "The readyState attribute of a document has changed." } },
      { name: "onscroll", description: { kind: "markdown", value: "The document view or an element has been scrolled." } },
      ...
      {
        name: "onshow",
        description: { kind: "markdown", value: "A contextmenu event was fired on/bubbled to an element that has a contextmenu attribute" },
      },
      {
        name: "onstalled",
        description: { kind: "markdown", value: "The user agent is trying to fetch media data, but data is unexpectedly not forthcoming." },
      },
      ...
      { name: "ontimeupdate", description: { kind: "markdown", value: "The time indicated by the currentTime attribute has been updated." } },
      { name: "onvolumechange", description: { kind: "markdown", value: "The volume has changed." } },
      { name: "onwaiting", description: { kind: "markdown", value: "Playback has stopped because of a temporary lack of data." } },
      { name: "onpointercancel", description: { kind: "markdown", value: "The pointer is unlikely to produce any more events." } },
      { name: "onpointerdown", description: { kind: "markdown", value: "The pointer enters the active buttons state." } },
      { name: "onpointerenter", description: { kind: "markdown", value: "Pointing device is moved inside the hit-testing boundary." } },
      { name: "onpointerleave", description: { kind: "markdown", value: "Pointing device is moved out of the hit-testing boundary." } },
      { name: "onpointerlockchange", description: { kind: "markdown", value: "The pointer was locked or released." } },
      {
        name: "onpointerlockerror",
        description: { kind: "markdown", value: "It was impossible to lock the pointer for technical reasons or because the permission was denied." },
      },
      { name: "onpointermove", description: { kind: "markdown", value: "The pointer changed coordinates." } },
      {
        name: "onpointerout",
        description: { kind: "markdown", value: "The pointing device moved out of hit-testing boundary or leaves detectable hover range." },
      },
      { name: "onpointerover", description: { kind: "markdown", value: "The pointing device is moved into the hit-testing boundary." } },
      { name: "onpointerup", description: { kind: "markdown", value: "The pointer leaves the active buttons state." } },
      {
        name: "aria-activedescendant",
        references: [{ name: "WAI-ARIA Reference", url: "https://www.w3.org/TR/wai-aria-1.1/#aria-activedescendant" }],
        description: {
          kind: "markdown",
          value:
      ...
      },
      {
        ...
        description: { kind: "markdown", value: "Indicates whether a text box accepts multiple lines of input or only a single line." },
      },
      {
        name: "aria-multiselectable",
        valueSet: "b",
        references: [{ name: "WAI-ARIA Reference", url: "https://www.w3.org/TR/wai-aria-1.1/#aria-multiselectable" }],
        description: { kind: "markdown", value: "Indicates that the user may select more than one item from the current selectable descendants." },
      },
      {
        name: "aria-orientation",
        valueSet: "orientation",
        references: [{ name: "WAI-ARIA Reference", url: "https://www.w3.org/TR/wai-aria-1.1/#aria-orientation" }],
        description: { kind: "markdown", value: "Indicates whether the element's orientation is horizontal, vertical, or unknown/ambiguous." },
      },
      {
        name: "aria-owns",
      ...
      },
      {
        ...
        description: { kind: "markdown", value: "Indicates if items in a table or grid are sorted in ascending or descending order." },
      },
      {
        name: "aria-valuemax",
    ...
    valueSets: [
      ...
      { name: "target", values: [{ name: "_self" }, { name: "_blank" }, { name: "_parent" }, { name: "_top" }] },
      {
        name: "sb",
        values: [
          { name: "allow-forms" },
      ...
      {
        name: "current",
        values: [{ name: "page" }, { name: "step" }, { name: "location" }, { name: "date" }, { name: "time" }, { name: "true" }, { name: "false" }],
      },
      {
        name: "dropeffect",
      ...
      },
      {
        name: "haspopup",
        values: [
          { name: "false", description: { kind: "markdown", value: "(default) Indicates the element does not have a popup." } },
          { name: "true", description: { kind: "markdown", value: "Indicates the popup is a menu." } },
          { name: "menu", description: { kind: "markdown", value: "Indicates the popup is a menu." } },
          { name: "listbox", description: { kind: "markdown", value: "Indicates the popup is a listbox." } },
          { name: "tree", description: { kind: "markdown", value: "Indicates the popup is a tree." } },
          { name: "grid", description: { kind: "markdown", value: "Indicates the popup is a grid." } },
          { name: "dialog", description: { kind: "markdown", value: "Indicates the popup is a dialog." } },
        ],
      },
      { name: "decoding", values: [{ name: "sync" }, { name: "async" }, { name: "auto" }] },
      {
        name: "loading",
        values: [
          {
  ...
  class ih {
    ...
    setDataProviders(t, n) {
      ((this.dataProviders = []), t && this.dataProviders.push(new Ga("html5", nh)), this.dataProviders.push(...n));
    }
    getDataProviders() {
      return this.dataProviders;
    }
    isVoidElement(t, n) {
      return !!t && hc(n, t.toLowerCase(), (i, r) => i.localeCompare(r)) >= 0;
    }
    getVoidElements(t) {
      const n = Array.isArray(t) ? t : this.getDataProviders().filter((r) => r.isApplicable(t)),
        i = [];
      return (
        n.forEach((r) => {
          r.provideTags()
            .filter((s) => s.void)
            .forEach((s) => i.push(s.name));
        }),
        i.sort()
      );
    }
    isPathAttribute(t, n) {
      if (n === "src" || n === "href") return !0;
      const i = rh[t];
      return i ? (typeof i == "string" ? i === n : i.indexOf(n) !== -1) : !1;
    }
  }
  const rh = {
      a: "href",
  ...
  function ah(e = sh) {
    ...
    return {
      ...
      format: Uc,
      findDocumentHighlights: Xc,
      findDocumentLinks: l.findDocumentLinks.bind(l),
      findDocumentSymbols: Jc,
      findDocumentSymbols2: io,
      ...
      doRename: Yc,
      findMatchingTagPosition: Kc,
      findOnTypeRenameRanges: so,
      findLinkedEditingRanges: so,
    };
  }
  function oh(e, t) {
    return new Ga(e, t);
  ...
  class lh {
    constructor(t, n) {
      ((this._ctx = t), (this._languageSettings = n.languageSettings), (this._languageId = n.languageId));
      const i = this._languageSettings.data,
        r = i == null ? void 0 : i.useDefaultDataProvider,
        s = [];
      if (i != null && i.dataProviders) for (const a in i.dataProviders) s.push(oh(a, i.dataProviders[a]));
      this._languageService = ah({ useDefaultDataProvider: r, customDataProviders: s });
    }
    async doComplete(t, n) {
      let i = this._getTextDocument(t);
      if (!i) return null;
      let r = this._languageService.parseHTMLDocument(i);
      return Promise.resolve(this._languageService.doComplete(i, n, r, this._languageSettings && this._languageSettings.suggest));
    }
    async format(t, n, i) {
      let r = this._getTextDocument(t);
      if (!r) return [];
      let s = { ...this._languageSettings.format, ...i },
        a = this._languageService.format(r, n, s);
    ...
    async doHover(t, n) {
      ...
      if (!i) return null;
      let r = this._languageService.parseHTMLDocument(i),
        s = this._languageService.doHover(i, n, r);
      return Promise.resolve(s);
    }
    async findDocumentHighlights(t, n) {
      let i = this._getTextDocument(t);
      if (!i) return [];
      let r = this._languageService.parseHTMLDocument(i),
        s = this._languageService.findDocumentHighlights(i, n, r);
      return Promise.resolve(s);
    }
    async findDocumentLinks(t) {
      let n = this._getTextDocument(t);
      if (!n) return [];
      let i = this._languageService.findDocumentLinks(n, null);
    ...
    async findDocumentSymbols(t) {
      ...
      let i = this._languageService.parseHTMLDocument(n),
        r = this._languageService.findDocumentSymbols(n, i);
      return Promise.resolve(r);
    }
    async getFoldingRanges(t, n) {
      let i = this._getTextDocument(t);
      if (!i) return [];
      let r = this._languageService.getFoldingRanges(i, n);
      return Promise.resolve(r);
    }
    async getSelectionRanges(t, n) {
      let i = this._getTextDocument(t);
      if (!i) return [];
      let r = this._languageService.getSelectionRanges(i, n);
      return Promise.resolve(r);
    }
    async doRename(t, n, i) {
      let r = this._getTextDocument(t);
      if (!r) return null;
      let s = this._languageService.parseHTMLDocument(r),
        a = this._languageService.doRename(r, n, i, s);
      return Promise.resolve(a);
    }
    _getTextDocument(t) {
      let n = this._ctx.getMirrorModels();
      for (let i of n) if (i.uri.toString() === t) return Ei.create(t, this._languageId, i.version, i.getValue());
      return null;
    }
  }
  self.onmessage = () => {
