...
| 近景 | 场景细部 | 材质/设备特写 | close shot、近景 |
| 特写 | 极局部细节 | 材质纹理/关键设备 | extreme closeup、特写 |
...
| 日间 → 夜间 | 建筑/布局/材质 | 整体变暗、增加灯光/星空氛围 |
| 室内日间 → 室内夜间 | 空间结构、家具 | 整体色调暖化、增加台灯/屏幕光 |
