...
| 森林/密林 | 天光经枝叶过滤，斑驳散射 | 林间光斑与树荫形成明暗对比 |
| 室内（窗光） | 窗口单向自然光，室内渐暗 | 光线侧射，自然形成明暗过渡 |
| 地窖/暗室 | 烛火/油灯/魔法灯局部暖光，整体暗调 | 光源单一，光域有限，阴影深重 |
| 城堡/宫殿 | 高窗斜射光，彩色玻璃光斑 | 彩色光斑投射，庄严神秘 |
| 水边/湖畔 | 天光 + 水面反射光 | 波光粼粼，倒影补光，氤氲感 |
...
| 顶光压迫 | 制造面部阴影，增强压迫感 | 审讯、对峙、威严场景 | 须有场景光源合理性 |
...
2. **色温一致性**：器材光色温须与环境光协调（如夜间冷蓝环境不可叠加暖黄补光，除非有壁炉等场景内合理暖光源）。
3. **方向合理性**：器材光方向须有场景内光源支撑（窗光方向、魔法光源位置、月光角度），不可凭空出现。
...
| 场景类型 | 必加约束词 |
|----------|-----------|
| 城堡宫殿 | 石砌纹理清晰，挂毯质感，彩色玻璃斑斓，烛台/壁灯点缀，空气深邃 |
| 森林/密林 | 古木纹理，藤蔓缠绕，苔藓斑驳，光线穿隙，地面腐叶质感，空气感 |
| 法师塔 | 书架纹理，卷轴泛黄，魔法微光，水晶球光泽，药剂瓶通透 |
| 湖畔/水边 | 水面波光，倒影层叠，薄雾氤氲，水草质感 |
| 地窖/暗室 | 光源单一，石壁纹理，烛火/魔法灯质感，阴影深重 |
| 村庄/酒馆 | 木质建筑纹理，麦秆屋顶，地面泥泞，炊烟袅袅 |
...
模式A（中文）——画内文字场景（画面描述中含书卷/符文/石碑等道具文字时）：
```
超清4K画质，高细节，自然锐度，写实清晰感，画面无字幕、无水印、无标题叠字，书本/符文/石碑等场景道具上的文字清晰可辨
```
...
模式B（英文）——画内文字场景：
```
ultra-sharp 4K, high detail, crisp textures, naturalistic sharpness, photorealistic clarity, no subtitles, no captions, no watermark, no title overlay, legible text on in-scene props such as scrolls and runestones
```
...
> 💡 **例外**：故事世界内的道具文字（书卷字迹、符文刻印、石碑铭文、药方等场景中自然存在的文字）**不属于禁止范围**。当分镜画面描述中包含此类内容时，应如实描写其存在并要求文字清晰。
...
|------|---------|------|-------------|------|------|------|---------|------|----------|
| 1 | 艾琳娜独立城堡塔楼之上，远眺神秘森林 | 城堡塔楼 | 艾琳娜 | 4s | 全景 | 静止 | 负手而立，斗篷随风飘扬 | 坚定 / 决绝 | 黄昏冷调侧逆光 |

### 示例输出A（模式A · Seedream）

```
[Prompt]
真人写实摄影，电影级画质，超现实主义纪实，强对比度，极致细节，纹理超清晰，全景构图，人物全身入镜，皮肤细腻，面容细腻渲染，五官立体，发丝根根分明，发丝细腻渲染，女主角立于城堡塔楼之上，双臂自然垂于身侧，斗篷初被风拂动，微微扬起，衣物布料质感清晰，布料折痕真实，衣物随动态飘逸，神情沉毅，目光即将投向远方，眼神坚定清冽，城堡石砌纹理清晰，风化质感，远景森林层叠，大气透视，黄昏冷调侧逆光，轮廓光勾勒人物边缘，魔幻写实美学，西方古典气韵，电影级分镜构图，超清4K画质，自然锐度，写实清晰感，画面无字幕、无水印、无标题叠字。
Based on the reference image of 艾琳娜, maintain consistent: face features, hairstyle, costume details. Generate a new scene: standing on the ancient castle tower at dusk, overlooking the mysterious forest. Keep character appearance identical to reference.
```
...
<character_reference>
Image [1]: 艾琳娜 — long silver hair flowing, calm sharp eyes, dark purple mage robe, tall slim body shape
</character_reference>
<continuity_rules>
...
<shot>
Full shot, character standing atop an ancient castle tower, arms resting naturally at her sides, cloak just beginning to catch the wind with a slight lift, gaze about to turn toward the mysterious forest, resolute and composed expression, cold dusk backlight, rim light silhouette, vast forest below, atmospheric perspective, fantasy cinematic realism, ultra-sharp 4K, high detail, crisp textures, photorealistic clarity, no subtitles, no captions, no watermark, no title overlay.
</shot>
<negative>
no plastic skin, no beauty filter, no studio lighting, no centered composition, no oversaturation, no AI generated look, no motion blur, no noise, no blurry, no out of focus, no subtitles, no captions, no watermark, no title overlay, no UI text
</negative>
