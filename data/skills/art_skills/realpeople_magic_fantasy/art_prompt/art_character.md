...
2. **角色为本** — 基础着装由角色描述（身份/职业/种族/性别/场景）决定其常规着装；后续特定服化为叠加层
3. **四视图一致** — 面容/体型/发型/基础服装跨视图高度统一
4. **神秘含情** — 无妆状态仍需体现角色气质（清冷/高贵/神秘/野性）

---

## 二、面容约束

> 不再固定五官特征参数，由角色描述（种族/性别/年龄/性格/气质）驱动 AI 自由生成五官，保证人物间外观差异化。
...
| 风格底色 | 魔幻真人写实摄影、毛孔级精细渲染、自然光照、物理光影 |
| 气质 | 必须从角色描述提炼整体气质关键词（如清冷高贵/神秘野性/温润儒雅/英武威严），并写入提示词 |
| 表情 | 中性微表情，符合角色气质 |
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 肤色 | 冷白皮/精灵瓷白、全身均匀 | 冷白皮、瓷白肌肤、porcelain white skin |
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 肤色 | 白皙透亮或健康麦色、全身均匀 | 肤色白皙透亮 / 健康麦色肌肤 |
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 身高 | 由角色设定指定，默认范围 165-178cm，身高通过头身比换算体现 | {身高}cm tall、{身高描述如：tall slender woman} |
| 头身比 | 七头身至八头身，头身比 = 身高 ÷ 头长，严格约束全身比例 | 7-8 heads tall proportion、身材修长 |
| 身高换算 | 头长 = 身高 ÷ 头身比（如170cm ÷ 7.5 = 22.7cm头长），据此约束头部与身体各段比例 | 比例匀称、头身比协调 |
| 肩颈 | 天鹅颈、肩颈线优美 | 天鹅颈、肩颈优美 |
| 手部 | 纤长白皙、指节分明、五指正常 | 纤纤玉手、指节分明 |
| 体态 | 高贵优雅 / 灵动轻盈（按种族） | 体态优雅、身姿轻盈 |

### 男性

| 项目 | 约束 | 提示词 |
|---|---|---|
| 身高 | 由角色设定指定，默认范围 178-190cm，身高通过头身比换算体现 | {身高}cm tall、{身高描述如：tall imposing man} |
| 头身比 | 七头半身至八头半身，头身比 = 身高 ÷ 头长，严格约束全身比例 | 7.5-8.5 heads tall proportion、身材高挑 |
| 身高换算 | 头长 = 身高 ÷ 头身比（如185cm ÷ 8 = 23.1cm头长），据此约束头部与身体各段比例 | 比例匀称、头身比协调、宽肩窄腰 |
| 肩颈 | 肩部宽阔、颈部有力 | 宽肩窄腰 |
| 手部 | 骨节分明、手掌宽大、五指正常 | 手指骨节分明 |
| 体态 | 骑士/法师/游侠体态（按角色） | 身姿挺拔、体态从容 |
...
| 165-170 | 7.5 | ~22cm | 高挑优雅 |
| 170-175 | 7.5-8.0 | ~22cm | 修长挺拔（女性默认） |
...
> 仅定义自然散发/简单束发，发饰在服化衍生环节叠加。奇幻种族可在此基础上做合理偏移。

### 女性

| 项目 | 约束 | 提示词 |
|---|---|---|
| 发色 | 默认纯黑/深棕/深金/银白（按种族设定），禁挑染 | 长发如瀑、丝缎般亮泽 |
| 发长 | 及腰或更长 | 及腰长发 |
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 发色 | 默认纯黑/深棕/金棕/银灰（按种族设定） | 墨发、金发如阳 |
| 发长 | 中长至长发 | 长发、及肩长发 |
...
> 基础服装由角色描述（身份/种族/职业/场景）决定其最自然的常规着装，作为该角色「日常默认态」；正式礼服/特殊衍生在服化衍生环节叠加。**禁止内衣打底**。
...
| 贵族/王室 | 素色华服（丝绒/绸缎） |
| 平民/旅者 | 朴素麻布衣 / 粗布衫裙 |
| 角色描述未明确 | 素色魔幻常服（按性别匹配长袍/劲装） |

### 着装统一规则

- 服装风格须与魔幻真人写实美学一致（西方古典色调、写实材质）
...
```
{性别}角色四视图设定图，真人写实摄影，魔幻写实纪实，强对比度，极致细节，
...
{角色身份对应的常规魔幻着装，如：素色长袍/锁甲便装/皮革混搭}，西方古典色调低饱和色，无复杂花纹，
...
|---|---|
| R1 | 必须为「素颜无妆」状态 |
| R2 | 必须根据角色描述声明合适的常规魔幻着装作为基础服装（如法师→素色长袍、骑士→轻便锁甲、游侠→皮革混搭）；禁止内衣打底 |
| R3 | 必须声明「无发饰、无配饰」 |
| R4 | 必须指定「纯净中性灰背景」 |
| R5 | 必须指定「四视图一致性」 |
| R6 | 全身立像必须从头顶到脚底完整展示，严禁裁切 |
| R7 | 必须声明角色身高并通过头身比换算约束全身比例（女性默认165-178cm/7-8头身，男性默认178-190cm/7.5-8.5头身） |
